...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/archive">archive</a>/<a href="http://localhost:8080/src/archive/tar">tar</a>/<span class="text-muted">stat_unix.go</span>
  </h1>
...
<span id="L26" class="ln">    26&nbsp;&nbsp;</span>func statUnix(fi fs.FileInfo, h *Header) error {
