...
<a href="register.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/archive">archive</a>/<a href="http://localhost:8080/src/archive/zip">zip</a>/<span class="text-muted">register.go</span>
  </h1>
...
<span id="L26" class="ln">    26&nbsp;&nbsp;</span>type Decompressor func(r io.Reader) io.ReadCloser
...
</pre><p><a href="register.go?m=text">View as plain text</a></p>
