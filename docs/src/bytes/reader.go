...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/bytes">bytes</a>/<span class="text-muted">reader.go</span>
  </h1>
...
<span id="L155" class="ln">   155&nbsp;&nbsp;</span><span class="comment">// Reset resets the [Reader.Reader] to be reading from b.</span>
<span id="L156" class="ln">   156&nbsp;&nbsp;</span>func (r *Reader) Reset(b []byte) { *r = Reader{b, 0, -1} }
<span id="L157" class="ln">   157&nbsp;&nbsp;</span>
<span id="L158" class="ln">   158&nbsp;&nbsp;</span><span class="comment">// NewReader returns a new [Reader.Reader] reading from b.</span>
