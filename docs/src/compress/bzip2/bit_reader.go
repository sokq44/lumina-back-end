...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/compress/bzip2/bit_reader.go - Go Documentation Server</title>
...
<a href="bit_reader.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/compress">compress</a>/<a href="http://localhost:8080/src/compress/bzip2">bzip2</a>/<span class="text-muted">bit_reader.go</span>
  </h1>
...
<span id="L35" class="ln">    35&nbsp;&nbsp;</span><span class="comment">// and the error can be obtained by calling bitReader.Err().</span>
...
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	<span class="comment">// The next line right shifts the desired bits into the</span>
...
<span id="L80" class="ln">    80&nbsp;&nbsp;</span>func (br *bitReader) Err() error {
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>	return br.err
<span id="L82" class="ln">    82&nbsp;&nbsp;</span>}
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>
</pre><p><a href="bit_reader.go?m=text">View as plain text</a></p>
