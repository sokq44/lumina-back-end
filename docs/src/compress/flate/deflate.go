...
<a href="deflate.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L679" class="ln">   679&nbsp;&nbsp;</span>func NewWriterDict(w io.Writer, level int, dict []byte) (*Writer, error) {
