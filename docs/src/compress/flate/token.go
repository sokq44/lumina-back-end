...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/compress/flate/token.go - Go Documentation Server</title>
...
<a href="token.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/compress">compress</a>/<a href="http://localhost:8080/src/compress/flate">flate</a>/<span class="text-muted">token.go</span>
  </h1>
...
<span id="L78" class="ln">    78&nbsp;&nbsp;</span><span class="comment">// Returns the literal of a literal token.</span>
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>func (t token) literal() uint32 { return uint32(t - literalType) }
<span id="L80" class="ln">    80&nbsp;&nbsp;</span>
<span id="L81" class="ln">    81&nbsp;&nbsp;</span><span class="comment">// Returns the extra offset of a match token.</span>
<span id="L82" class="ln">    82&nbsp;&nbsp;</span>func (t token) offset() uint32 { return uint32(t) &amp; offsetMask }
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>
<span id="L84" class="ln">    84&nbsp;&nbsp;</span>func (t token) length() uint32 { return uint32((t - matchType) &gt;&gt; lengthShift) }
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>func lengthCode(len uint32) uint32 { return lengthCodes[len] }
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>
<span id="L88" class="ln">    88&nbsp;&nbsp;</span><span class="comment">// Returns the offset code corresponding to a specific offset.</span>
<span id="L89" class="ln">    89&nbsp;&nbsp;</span>func offsetCode(off uint32) uint32 {
<span id="L90" class="ln">    90&nbsp;&nbsp;</span>	if off &lt; uint32(len(offsetCodes)) {
<span id="L91" class="ln">    91&nbsp;&nbsp;</span>		return offsetCodes[off]
<span id="L92" class="ln">    92&nbsp;&nbsp;</span>	}
<span id="L93" class="ln">    93&nbsp;&nbsp;</span>	if off&gt;&gt;7 &lt; uint32(len(offsetCodes)) {
<span id="L94" class="ln">    94&nbsp;&nbsp;</span>		return offsetCodes[off&gt;&gt;7] + 14
<span id="L95" class="ln">    95&nbsp;&nbsp;</span>	}
<span id="L96" class="ln">    96&nbsp;&nbsp;</span>	return offsetCodes[off&gt;&gt;14] + 28
<span id="L97" class="ln">    97&nbsp;&nbsp;</span>}
<span id="L98" class="ln">    98&nbsp;&nbsp;</span>
</pre><p><a href="token.go?m=text">View as plain text</a></p>
