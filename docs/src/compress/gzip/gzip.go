...
<a href="gzip.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/compress">compress</a>/<a href="http://localhost:8080/src/compress/gzip">gzip</a>/<span class="text-muted">gzip.go</span>
  </h1>
...
<span id="L33" class="ln">    33&nbsp;&nbsp;</span>	compressor  *flate.Writer
<span id="L34" class="ln">    34&nbsp;&nbsp;</span>	digest      uint32 <span class="comment">// CRC-32, IEEE polynomial (section 8)</span>
<span id="L35" class="ln">    35&nbsp;&nbsp;</span>	size        uint32 <span class="comment">// Uncompressed size (section 2.3.1)</span>
<span id="L36" class="ln">    36&nbsp;&nbsp;</span>	closed      bool
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>	buf         [10]byte
...
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>func NewWriter(w io.Writer) *Writer {
...
</pre><p><a href="gzip.go?m=text">View as plain text</a></p>
