...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/compress">compress</a>/<a href="http://localhost:8080/src/compress/lzw">lzw</a>/<span class="text-muted">reader.go</span>
  </h1>
...
<span id="L254" class="ln">   254&nbsp;&nbsp;</span>func NewReader(r io.Reader, order Order, litWidth int) io.ReadCloser {
