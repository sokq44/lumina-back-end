...
<a href="heap.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/container">container</a>/<a href="http://localhost:8080/src/container/heap">heap</a>/<span class="text-muted">heap.go</span>
  </h1>
  ...
  <h2>
    Documentation: <a href="http://localhost:8080/pkg/container/heap">container/heap</a>
  </h2>
...
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>func Fix(h Interface, i int) {
...
</pre><p><a href="heap.go?m=text">View as plain text</a></p>
