...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/aes">aes</a>/<span class="text-muted">cipher.go</span>
  </h1>
...
<span id="L19" class="ln">    19&nbsp;&nbsp;</span>	enc []uint32
<span id="L20" class="ln">    20&nbsp;&nbsp;</span>	dec []uint32
...
<span id="L26" class="ln">    26&nbsp;&nbsp;</span>	return &#34;crypto/aes: invalid key size &#34; + strconv.Itoa(int(k))
<span id="L27" class="ln">    27&nbsp;&nbsp;</span>}
<span id="L28" class="ln">    28&nbsp;&nbsp;</span>
<span id="L29" class="ln">    29&nbsp;&nbsp;</span><span class="comment">// NewCipher creates and returns a new [cipher.Block].</span>
<span id="L30" class="ln">    30&nbsp;&nbsp;</span><span class="comment">// The key argument should be the AES key,</span>
<span id="L31" class="ln">    31&nbsp;&nbsp;</span><span class="comment">// either 16, 24, or 32 bytes to select</span>
<span id="L32" class="ln">    32&nbsp;&nbsp;</span><span class="comment">// AES-128, AES-192, or AES-256.</span>
<span id="L33" class="ln">    33&nbsp;&nbsp;</span>func NewCipher(key []byte) (cipher.Block, error) {
<span id="L34" class="ln">    34&nbsp;&nbsp;</span>	k := len(key)
<span id="L35" class="ln">    35&nbsp;&nbsp;</span>	switch k {
<span id="L36" class="ln">    36&nbsp;&nbsp;</span>	default:
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>		return nil, KeySizeError(k)
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>	case 16, 24, 32:
<span id="L39" class="ln">    39&nbsp;&nbsp;</span>		break
<span id="L40" class="ln">    40&nbsp;&nbsp;</span>	}
<span id="L41" class="ln">    41&nbsp;&nbsp;</span>	if boring.Enabled {
<span id="L42" class="ln">    42&nbsp;&nbsp;</span>		return boring.NewAESCipher(key)
<span id="L43" class="ln">    43&nbsp;&nbsp;</span>	}
<span id="L44" class="ln">    44&nbsp;&nbsp;</span>	return newCipher(key)
<span id="L45" class="ln">    45&nbsp;&nbsp;</span>}
<span id="L46" class="ln">    46&nbsp;&nbsp;</span>
<span id="L47" class="ln">    47&nbsp;&nbsp;</span><span class="comment">// newCipherGeneric creates and returns a new cipher.Block</span>
<span id="L48" class="ln">    48&nbsp;&nbsp;</span><span class="comment">// implemented in pure Go.</span>
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>func newCipherGeneric(key []byte) (cipher.Block, error) {
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>	n := len(key) + 28
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>	c := aesCipher{make([]uint32, n), make([]uint32, n)}
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	expandKeyGo(key, c.enc, c.dec)
...
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>	encryptBlockGo(c.enc, dst, src)
...
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>	decryptBlockGo(c.dec, dst, src)
