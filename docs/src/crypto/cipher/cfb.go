...
<a href="cfb.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/cipher">cipher</a>/<span class="text-muted">cfb.go</span>
  </h1>
...
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>func NewCFBDecrypter(block Block, iv []byte) Stream {
...
</pre><p><a href="cfb.go?m=text">View as plain text</a></p>
