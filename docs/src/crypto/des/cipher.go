...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/des">des</a>/<span class="text-muted">cipher.go</span>
  </h1>
...
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>func NewTripleDESCipher(key []byte) (cipher.Block, error) {
...
<span id="L98" class="ln">    98&nbsp;&nbsp;</span>	b := binary.BigEndian.Uint64(src)
...
<span id="L119" class="ln">   119&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(dst, permuteFinalBlock(preOutput))
...
<span id="L133" class="ln">   133&nbsp;&nbsp;</span>	b := binary.BigEndian.Uint64(src)
...
<span id="L154" class="ln">   154&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(dst, permuteFinalBlock(preOutput))
