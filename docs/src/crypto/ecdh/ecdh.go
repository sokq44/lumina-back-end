...
<a href="ecdh.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/ecdh">ecdh</a>/<span class="text-muted">ecdh.go</span>
  </h1>
...
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>func (k *PublicKey) Bytes() []byte {
...
</pre><p><a href="ecdh.go?m=text">View as plain text</a></p>
