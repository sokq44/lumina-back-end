...
<a href="ecdsa.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L256" class="ln">   256&nbsp;&nbsp;</span>func SignASN1(rand io.Reader, priv *PrivateKey, hash []byte) ([]byte, error) {
