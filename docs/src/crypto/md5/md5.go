...
<a href="md5.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/md5">md5</a>/<span class="text-muted">md5.go</span>
  </h1>
...
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint32(b, d.s[0])
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint32(b, d.s[1])
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint32(b, d.s[2])
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint32(b, d.s[3])
...
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.len)
...
<span id="L91" class="ln">    91&nbsp;&nbsp;</span>	return b[8:], binary.BigEndian.Uint64(b[0:8])
<span id="L92" class="ln">    92&nbsp;&nbsp;</span>}
<span id="L93" class="ln">    93&nbsp;&nbsp;</span>
<span id="L94" class="ln">    94&nbsp;&nbsp;</span>func consumeUint32(b []byte) ([]byte, uint32) {
<span id="L95" class="ln">    95&nbsp;&nbsp;</span>	return b[4:], binary.BigEndian.Uint32(b[0:4])
...
<span id="L160" class="ln">   160&nbsp;&nbsp;</span>	binary.LittleEndian.PutUint64(tmp[1+pad:], d.len&lt;&lt;3) <span class="comment">// append length in bits</span>
...
<span id="L170" class="ln">   170&nbsp;&nbsp;</span>	binary.LittleEndian.PutUint32(digest[0:], d.s[0])
<span id="L171" class="ln">   171&nbsp;&nbsp;</span>	binary.LittleEndian.PutUint32(digest[4:], d.s[1])
<span id="L172" class="ln">   172&nbsp;&nbsp;</span>	binary.LittleEndian.PutUint32(digest[8:], d.s[2])
<span id="L173" class="ln">   173&nbsp;&nbsp;</span>	binary.LittleEndian.PutUint32(digest[12:], d.s[3])
...
</pre><p><a href="md5.go?m=text">View as plain text</a></p>
