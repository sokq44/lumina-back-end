...
<a href="pkcs1v15.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L324" class="ln">   324&nbsp;&nbsp;</span>func VerifyPKCS1v15(pub *PublicKey, hash crypto.Hash, hashed []byte, sig []byte) error {
