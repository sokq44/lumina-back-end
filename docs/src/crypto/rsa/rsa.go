...
<a href="rsa.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L275" class="ln">   275&nbsp;&nbsp;</span>func GenerateKey(random io.Reader, bits int) (*PrivateKey, error) {
