...
<a href="sha512.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/sha512">sha512</a>/<span class="text-muted">sha512.go</span>
  </h1>
...
<span id="L156" class="ln">   156&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.h[0])
<span id="L157" class="ln">   157&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.h[1])
<span id="L158" class="ln">   158&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.h[2])
<span id="L159" class="ln">   159&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.h[3])
<span id="L160" class="ln">   160&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.h[4])
<span id="L161" class="ln">   161&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.h[5])
<span id="L162" class="ln">   162&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.h[6])
<span id="L163" class="ln">   163&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.h[7])
...
<span id="L166" class="ln">   166&nbsp;&nbsp;</span>	b = binary.BigEndian.AppendUint64(b, d.len)
...
<span id="L201" class="ln">   201&nbsp;&nbsp;</span>	_ = b[7]
<span id="L202" class="ln">   202&nbsp;&nbsp;</span>	x := uint64(b[7]) | uint64(b[6])&lt;&lt;8 | uint64(b[5])&lt;&lt;16 | uint64(b[4])&lt;&lt;24 |
<span id="L203" class="ln">   203&nbsp;&nbsp;</span>		uint64(b[3])&lt;&lt;32 | uint64(b[2])&lt;&lt;40 | uint64(b[1])&lt;&lt;48 | uint64(b[0])&lt;&lt;56
<span id="L204" class="ln">   204&nbsp;&nbsp;</span>	return b[8:], x
<span id="L205" class="ln">   205&nbsp;&nbsp;</span>}
<span id="L206" class="ln">   206&nbsp;&nbsp;</span>
<span id="L207" class="ln">   207&nbsp;&nbsp;</span><span class="comment">// New returns a new hash.Hash computing the SHA-512 checksum.</span>
<span id="L208" class="ln">   208&nbsp;&nbsp;</span>func New() hash.Hash {
<span id="L209" class="ln">   209&nbsp;&nbsp;</span>	if boring.Enabled {
<span id="L210" class="ln">   210&nbsp;&nbsp;</span>		return boring.NewSHA512()
<span id="L211" class="ln">   211&nbsp;&nbsp;</span>	}
<span id="L212" class="ln">   212&nbsp;&nbsp;</span>	d := &amp;digest{function: crypto.SHA512}
<span id="L213" class="ln">   213&nbsp;&nbsp;</span>	d.Reset()
<span id="L214" class="ln">   214&nbsp;&nbsp;</span>	return d
<span id="L215" class="ln">   215&nbsp;&nbsp;</span>}
<span id="L216" class="ln">   216&nbsp;&nbsp;</span>
<span id="L217" class="ln">   217&nbsp;&nbsp;</span><span class="comment">// New512_224 returns a new hash.Hash computing the SHA-512/224 checksum.</span>
<span id="L218" class="ln">   218&nbsp;&nbsp;</span>func New512_224() hash.Hash {
<span id="L219" class="ln">   219&nbsp;&nbsp;</span>	d := &amp;digest{function: crypto.SHA512_224}
<span id="L220" class="ln">   220&nbsp;&nbsp;</span>	d.Reset()
<span id="L221" class="ln">   221&nbsp;&nbsp;</span>	return d
<span id="L222" class="ln">   222&nbsp;&nbsp;</span>}
<span id="L223" class="ln">   223&nbsp;&nbsp;</span>
<span id="L224" class="ln">   224&nbsp;&nbsp;</span><span class="comment">// New512_256 returns a new hash.Hash computing the SHA-512/256 checksum.</span>
<span id="L225" class="ln">   225&nbsp;&nbsp;</span>func New512_256() hash.Hash {
<span id="L226" class="ln">   226&nbsp;&nbsp;</span>	d := &amp;digest{function: crypto.SHA512_256}
<span id="L227" class="ln">   227&nbsp;&nbsp;</span>	d.Reset()
<span id="L228" class="ln">   228&nbsp;&nbsp;</span>	return d
<span id="L229" class="ln">   229&nbsp;&nbsp;</span>}
<span id="L230" class="ln">   230&nbsp;&nbsp;</span>
<span id="L231" class="ln">   231&nbsp;&nbsp;</span><span class="comment">// New384 returns a new hash.Hash computing the SHA-384 checksum.</span>
<span id="L232" class="ln">   232&nbsp;&nbsp;</span>func New384() hash.Hash {
<span id="L233" class="ln">   233&nbsp;&nbsp;</span>	if boring.Enabled {
<span id="L234" class="ln">   234&nbsp;&nbsp;</span>		return boring.NewSHA384()
<span id="L235" class="ln">   235&nbsp;&nbsp;</span>	}
<span id="L236" class="ln">   236&nbsp;&nbsp;</span>	d := &amp;digest{function: crypto.SHA384}
<span id="L237" class="ln">   237&nbsp;&nbsp;</span>	d.Reset()
<span id="L238" class="ln">   238&nbsp;&nbsp;</span>	return d
<span id="L239" class="ln">   239&nbsp;&nbsp;</span>}
<span id="L240" class="ln">   240&nbsp;&nbsp;</span>
<span id="L241" class="ln">   241&nbsp;&nbsp;</span>func (d *digest) Size() int {
<span id="L242" class="ln">   242&nbsp;&nbsp;</span>	switch d.function {
<span id="L243" class="ln">   243&nbsp;&nbsp;</span>	case crypto.SHA512_224:
<span id="L244" class="ln">   244&nbsp;&nbsp;</span>		return Size224
<span id="L245" class="ln">   245&nbsp;&nbsp;</span>	case crypto.SHA512_256:
<span id="L246" class="ln">   246&nbsp;&nbsp;</span>		return Size256
<span id="L247" class="ln">   247&nbsp;&nbsp;</span>	case crypto.SHA384:
<span id="L248" class="ln">   248&nbsp;&nbsp;</span>		return Size384
<span id="L249" class="ln">   249&nbsp;&nbsp;</span>	default:
<span id="L250" class="ln">   250&nbsp;&nbsp;</span>		return Size
<span id="L251" class="ln">   251&nbsp;&nbsp;</span>	}
<span id="L252" class="ln">   252&nbsp;&nbsp;</span>}
<span id="L253" class="ln">   253&nbsp;&nbsp;</span>
<span id="L254" class="ln">   254&nbsp;&nbsp;</span>func (d *digest) BlockSize() int { return BlockSize }
<span id="L255" class="ln">   255&nbsp;&nbsp;</span>
<span id="L256" class="ln">   256&nbsp;&nbsp;</span>func (d *digest) Write(p []byte) (nn int, err error) {
<span id="L257" class="ln">   257&nbsp;&nbsp;</span>	if d.function != crypto.SHA512_224 &amp;&amp; d.function != crypto.SHA512_256 {
<span id="L258" class="ln">   258&nbsp;&nbsp;</span>		boring.Unreachable()
<span id="L259" class="ln">   259&nbsp;&nbsp;</span>	}
<span id="L260" class="ln">   260&nbsp;&nbsp;</span>	nn = len(p)
<span id="L261" class="ln">   261&nbsp;&nbsp;</span>	d.len += uint64(nn)
<span id="L262" class="ln">   262&nbsp;&nbsp;</span>	if d.nx &gt; 0 {
<span id="L263" class="ln">   263&nbsp;&nbsp;</span>		n := copy(d.x[d.nx:], p)
<span id="L264" class="ln">   264&nbsp;&nbsp;</span>		d.nx += n
<span id="L265" class="ln">   265&nbsp;&nbsp;</span>		if d.nx == chunk {
<span id="L266" class="ln">   266&nbsp;&nbsp;</span>			block(d, d.x[:])
<span id="L267" class="ln">   267&nbsp;&nbsp;</span>			d.nx = 0
<span id="L268" class="ln">   268&nbsp;&nbsp;</span>		}
<span id="L269" class="ln">   269&nbsp;&nbsp;</span>		p = p[n:]
<span id="L270" class="ln">   270&nbsp;&nbsp;</span>	}
<span id="L271" class="ln">   271&nbsp;&nbsp;</span>	if len(p) &gt;= chunk {
<span id="L272" class="ln">   272&nbsp;&nbsp;</span>		n := len(p) &amp;^ (chunk - 1)
<span id="L273" class="ln">   273&nbsp;&nbsp;</span>		block(d, p[:n])
<span id="L274" class="ln">   274&nbsp;&nbsp;</span>		p = p[n:]
<span id="L275" class="ln">   275&nbsp;&nbsp;</span>	}
<span id="L276" class="ln">   276&nbsp;&nbsp;</span>	if len(p) &gt; 0 {
<span id="L277" class="ln">   277&nbsp;&nbsp;</span>		d.nx = copy(d.x[:], p)
<span id="L278" class="ln">   278&nbsp;&nbsp;</span>	}
<span id="L279" class="ln">   279&nbsp;&nbsp;</span>	return
<span id="L280" class="ln">   280&nbsp;&nbsp;</span>}
<span id="L281" class="ln">   281&nbsp;&nbsp;</span>
<span id="L282" class="ln">   282&nbsp;&nbsp;</span>func (d *digest) Sum(in []byte) []byte {
<span id="L283" class="ln">   283&nbsp;&nbsp;</span>	if d.function != crypto.SHA512_224 &amp;&amp; d.function != crypto.SHA512_256 {
<span id="L284" class="ln">   284&nbsp;&nbsp;</span>		boring.Unreachable()
<span id="L285" class="ln">   285&nbsp;&nbsp;</span>	}
<span id="L286" class="ln">   286&nbsp;&nbsp;</span>	<span class="comment">// Make a copy of d so that caller can keep writing and summing.</span>
<span id="L287" class="ln">   287&nbsp;&nbsp;</span>	d0 := new(digest)
<span id="L288" class="ln">   288&nbsp;&nbsp;</span>	*d0 = *d
<span id="L289" class="ln">   289&nbsp;&nbsp;</span>	hash := d0.checkSum()
<span id="L290" class="ln">   290&nbsp;&nbsp;</span>	switch d0.function {
<span id="L291" class="ln">   291&nbsp;&nbsp;</span>	case crypto.SHA384:
<span id="L292" class="ln">   292&nbsp;&nbsp;</span>		return append(in, hash[:Size384]...)
<span id="L293" class="ln">   293&nbsp;&nbsp;</span>	case crypto.SHA512_224:
<span id="L294" class="ln">   294&nbsp;&nbsp;</span>		return append(in, hash[:Size224]...)
<span id="L295" class="ln">   295&nbsp;&nbsp;</span>	case crypto.SHA512_256:
<span id="L296" class="ln">   296&nbsp;&nbsp;</span>		return append(in, hash[:Size256]...)
<span id="L297" class="ln">   297&nbsp;&nbsp;</span>	default:
<span id="L298" class="ln">   298&nbsp;&nbsp;</span>		return append(in, hash[:]...)
<span id="L299" class="ln">   299&nbsp;&nbsp;</span>	}
<span id="L300" class="ln">   300&nbsp;&nbsp;</span>}
<span id="L301" class="ln">   301&nbsp;&nbsp;</span>
<span id="L302" class="ln">   302&nbsp;&nbsp;</span>func (d *digest) checkSum() [Size]byte {
<span id="L303" class="ln">   303&nbsp;&nbsp;</span>	<span class="comment">// Padding. Add a 1 bit and 0 bits until 112 bytes mod 128.</span>
<span id="L304" class="ln">   304&nbsp;&nbsp;</span>	len := d.len
<span id="L305" class="ln">   305&nbsp;&nbsp;</span>	var tmp [128 + 16]byte <span class="comment">// padding + length buffer</span>
<span id="L306" class="ln">   306&nbsp;&nbsp;</span>	tmp[0] = 0x80
<span id="L307" class="ln">   307&nbsp;&nbsp;</span>	var t uint64
<span id="L308" class="ln">   308&nbsp;&nbsp;</span>	if len%128 &lt; 112 {
<span id="L309" class="ln">   309&nbsp;&nbsp;</span>		t = 112 - len%128
<span id="L310" class="ln">   310&nbsp;&nbsp;</span>	} else {
<span id="L311" class="ln">   311&nbsp;&nbsp;</span>		t = 128 + 112 - len%128
<span id="L312" class="ln">   312&nbsp;&nbsp;</span>	}
<span id="L313" class="ln">   313&nbsp;&nbsp;</span>
<span id="L314" class="ln">   314&nbsp;&nbsp;</span>	<span class="comment">// Length in bits.</span>
<span id="L315" class="ln">   315&nbsp;&nbsp;</span>	len &lt;&lt;= 3
<span id="L316" class="ln">   316&nbsp;&nbsp;</span>	padlen := tmp[:t+16]
<span id="L317" class="ln">   317&nbsp;&nbsp;</span>	<span class="comment">// Upper 64 bits are always zero, because len variable has type uint64,</span>
<span id="L318" class="ln">   318&nbsp;&nbsp;</span>	<span class="comment">// and tmp is already zeroed at that index, so we can skip updating it.</span>
<span id="L319" class="ln">   319&nbsp;&nbsp;</span>	<span class="comment">// binary.BigEndian.PutUint64(padlen[t+0:], 0)</span>
<span id="L320" class="ln">   320&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(padlen[t+8:], len)
<span id="L321" class="ln">   321&nbsp;&nbsp;</span>	d.Write(padlen)
<span id="L322" class="ln">   322&nbsp;&nbsp;</span>
<span id="L323" class="ln">   323&nbsp;&nbsp;</span>	if d.nx != 0 {
<span id="L324" class="ln">   324&nbsp;&nbsp;</span>		panic(&#34;d.nx != 0&#34;)
<span id="L325" class="ln">   325&nbsp;&nbsp;</span>	}
<span id="L326" class="ln">   326&nbsp;&nbsp;</span>
<span id="L327" class="ln">   327&nbsp;&nbsp;</span>	var digest [Size]byte
<span id="L328" class="ln">   328&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(digest[0:], d.h[0])
<span id="L329" class="ln">   329&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(digest[8:], d.h[1])
<span id="L330" class="ln">   330&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(digest[16:], d.h[2])
<span id="L331" class="ln">   331&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(digest[24:], d.h[3])
<span id="L332" class="ln">   332&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(digest[32:], d.h[4])
<span id="L333" class="ln">   333&nbsp;&nbsp;</span>	binary.BigEndian.PutUint64(digest[40:], d.h[5])
<span id="L334" class="ln">   334&nbsp;&nbsp;</span>	if d.function != crypto.SHA384 {
<span id="L335" class="ln">   335&nbsp;&nbsp;</span>		binary.BigEndian.PutUint64(digest[48:], d.h[6])
<span id="L336" class="ln">   336&nbsp;&nbsp;</span>		binary.BigEndian.PutUint64(digest[56:], d.h[7])
<span id="L337" class="ln">   337&nbsp;&nbsp;</span>	}
<span id="L338" class="ln">   338&nbsp;&nbsp;</span>
<span id="L339" class="ln">   339&nbsp;&nbsp;</span>	return digest
<span id="L340" class="ln">   340&nbsp;&nbsp;</span>}
<span id="L341" class="ln">   341&nbsp;&nbsp;</span>
<span id="L342" class="ln">   342&nbsp;&nbsp;</span><span class="comment">// Sum512 returns the SHA512 checksum of the data.</span>
<span id="L343" class="ln">   343&nbsp;&nbsp;</span>func Sum512(data []byte) [Size]byte {
<span id="L344" class="ln">   344&nbsp;&nbsp;</span>	if boring.Enabled {
<span id="L345" class="ln">   345&nbsp;&nbsp;</span>		return boring.SHA512(data)
<span id="L346" class="ln">   346&nbsp;&nbsp;</span>	}
<span id="L347" class="ln">   347&nbsp;&nbsp;</span>	d := digest{function: crypto.SHA512}
<span id="L348" class="ln">   348&nbsp;&nbsp;</span>	d.Reset()
<span id="L349" class="ln">   349&nbsp;&nbsp;</span>	d.Write(data)
<span id="L350" class="ln">   350&nbsp;&nbsp;</span>	return d.checkSum()
<span id="L351" class="ln">   351&nbsp;&nbsp;</span>}
<span id="L352" class="ln">   352&nbsp;&nbsp;</span>
<span id="L353" class="ln">   353&nbsp;&nbsp;</span><span class="comment">// Sum384 returns the SHA384 checksum of the data.</span>
<span id="L354" class="ln">   354&nbsp;&nbsp;</span>func Sum384(data []byte) [Size384]byte {
<span id="L355" class="ln">   355&nbsp;&nbsp;</span>	if boring.Enabled {
<span id="L356" class="ln">   356&nbsp;&nbsp;</span>		return boring.SHA384(data)
<span id="L357" class="ln">   357&nbsp;&nbsp;</span>	}
<span id="L358" class="ln">   358&nbsp;&nbsp;</span>	d := digest{function: crypto.SHA384}
<span id="L359" class="ln">   359&nbsp;&nbsp;</span>	d.Reset()
<span id="L360" class="ln">   360&nbsp;&nbsp;</span>	d.Write(data)
<span id="L361" class="ln">   361&nbsp;&nbsp;</span>	sum := d.checkSum()
<span id="L362" class="ln">   362&nbsp;&nbsp;</span>	ap := (*[Size384]byte)(sum[:])
<span id="L363" class="ln">   363&nbsp;&nbsp;</span>	return *ap
<span id="L364" class="ln">   364&nbsp;&nbsp;</span>}
<span id="L365" class="ln">   365&nbsp;&nbsp;</span>
<span id="L366" class="ln">   366&nbsp;&nbsp;</span><span class="comment">// Sum512_224 returns the Sum512/224 checksum of the data.</span>
<span id="L367" class="ln">   367&nbsp;&nbsp;</span>func Sum512_224(data []byte) [Size224]byte {
<span id="L368" class="ln">   368&nbsp;&nbsp;</span>	d := digest{function: crypto.SHA512_224}
<span id="L369" class="ln">   369&nbsp;&nbsp;</span>	d.Reset()
<span id="L370" class="ln">   370&nbsp;&nbsp;</span>	d.Write(data)
<span id="L371" class="ln">   371&nbsp;&nbsp;</span>	sum := d.checkSum()
<span id="L372" class="ln">   372&nbsp;&nbsp;</span>	ap := (*[Size224]byte)(sum[:])
<span id="L373" class="ln">   373&nbsp;&nbsp;</span>	return *ap
<span id="L374" class="ln">   374&nbsp;&nbsp;</span>}
<span id="L375" class="ln">   375&nbsp;&nbsp;</span>
<span id="L376" class="ln">   376&nbsp;&nbsp;</span><span class="comment">// Sum512_256 returns the Sum512/256 checksum of the data.</span>
<span id="L377" class="ln">   377&nbsp;&nbsp;</span>func Sum512_256(data []byte) [Size256]byte {
<span id="L378" class="ln">   378&nbsp;&nbsp;</span>	d := digest{function: crypto.SHA512_256}
<span id="L379" class="ln">   379&nbsp;&nbsp;</span>	d.Reset()
<span id="L380" class="ln">   380&nbsp;&nbsp;</span>	d.Write(data)
<span id="L381" class="ln">   381&nbsp;&nbsp;</span>	sum := d.checkSum()
<span id="L382" class="ln">   382&nbsp;&nbsp;</span>	ap := (*[Size256]byte)(sum[:])
<span id="L383" class="ln">   383&nbsp;&nbsp;</span>	return *ap
<span id="L384" class="ln">   384&nbsp;&nbsp;</span>}
<span id="L385" class="ln">   385&nbsp;&nbsp;</span>
</pre><p><a href="sha512.go?m=text">View as plain text</a></p>
