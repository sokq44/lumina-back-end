...
<a href="ticket.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L21" class="ln">    21&nbsp;&nbsp;</span>type SessionState struct {
<span id="L22" class="ln">    22&nbsp;&nbsp;</span>	<span class="comment">// Encoded as a SessionState (in the language of RFC 8446, Section 3).</span>
<span id="L23" class="ln">    23&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L24" class="ln">    24&nbsp;&nbsp;</span>	<span class="comment">//   enum { server(1), client(2) } SessionStateType;</span>
<span id="L25" class="ln">    25&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L26" class="ln">    26&nbsp;&nbsp;</span>	<span class="comment">//   opaque Certificate&lt;1..2^24-1&gt;;</span>
<span id="L27" class="ln">    27&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L28" class="ln">    28&nbsp;&nbsp;</span>	<span class="comment">//   Certificate CertificateChain&lt;0..2^24-1&gt;;</span>
<span id="L29" class="ln">    29&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L30" class="ln">    30&nbsp;&nbsp;</span>	<span class="comment">//   opaque Extra&lt;0..2^24-1&gt;;</span>
<span id="L31" class="ln">    31&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L32" class="ln">    32&nbsp;&nbsp;</span>	<span class="comment">//   struct {</span>
<span id="L33" class="ln">    33&nbsp;&nbsp;</span>	<span class="comment">//       uint16 version;</span>
<span id="L34" class="ln">    34&nbsp;&nbsp;</span>	<span class="comment">//       SessionStateType type;</span>
<span id="L35" class="ln">    35&nbsp;&nbsp;</span>	<span class="comment">//       uint16 cipher_suite;</span>
<span id="L36" class="ln">    36&nbsp;&nbsp;</span>	<span class="comment">//       uint64 created_at;</span>
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>	<span class="comment">//       opaque secret&lt;1..2^8-1&gt;;</span>
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>	<span class="comment">//       Extra extra&lt;0..2^24-1&gt;;</span>
<span id="L39" class="ln">    39&nbsp;&nbsp;</span>	<span class="comment">//       uint8 ext_master_secret = { 0, 1 };</span>
<span id="L40" class="ln">    40&nbsp;&nbsp;</span>	<span class="comment">//       uint8 early_data = { 0, 1 };</span>
<span id="L41" class="ln">    41&nbsp;&nbsp;</span>	<span class="comment">//       CertificateEntry certificate_list&lt;0..2^24-1&gt;;</span>
<span id="L42" class="ln">    42&nbsp;&nbsp;</span>	<span class="comment">//       CertificateChain verified_chains&lt;0..2^24-1&gt;; /* excluding leaf */</span>
<span id="L43" class="ln">    43&nbsp;&nbsp;</span>	<span class="comment">//       select (SessionState.early_data) {</span>
<span id="L44" class="ln">    44&nbsp;&nbsp;</span>	<span class="comment">//           case 0: Empty;</span>
<span id="L45" class="ln">    45&nbsp;&nbsp;</span>	<span class="comment">//           case 1: opaque alpn&lt;1..2^8-1&gt;;</span>
<span id="L46" class="ln">    46&nbsp;&nbsp;</span>	<span class="comment">//       };</span>
<span id="L47" class="ln">    47&nbsp;&nbsp;</span>	<span class="comment">//       select (SessionState.type) {</span>
<span id="L48" class="ln">    48&nbsp;&nbsp;</span>	<span class="comment">//           case server: Empty;</span>
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>	<span class="comment">//           case client: struct {</span>
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>	<span class="comment">//               select (SessionState.version) {</span>
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>	<span class="comment">//                   case VersionTLS10..VersionTLS12: Empty;</span>
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	<span class="comment">//                   case VersionTLS13: struct {</span>
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>	<span class="comment">//                       uint64 use_by;</span>
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>	<span class="comment">//                       uint32 age_add;</span>
...
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>	<span class="comment">//   } SessionState;</span>
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>	<span class="comment">// Extra is ignored by crypto/tls, but is encoded by [SessionState.Bytes]</span>
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	<span class="comment">// and parsed by [ParseSessionState].</span>
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>	<span class="comment">// This allows [Config.UnwrapSession]/[Config.WrapSession] and</span>
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>	<span class="comment">// [ClientSessionCache] implementations to store and retrieve additional</span>
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>	<span class="comment">// data alongside this session.</span>
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L69" class="ln">    69&nbsp;&nbsp;</span>	<span class="comment">// To allow different layers in a protocol stack to share this field,</span>
<span id="L70" class="ln">    70&nbsp;&nbsp;</span>	<span class="comment">// applications must only append to it, not replace it, and must use entries</span>
<span id="L71" class="ln">    71&nbsp;&nbsp;</span>	<span class="comment">// that can be recognized even if out of order (for example, by starting</span>
<span id="L72" class="ln">    72&nbsp;&nbsp;</span>	<span class="comment">// with an id and version prefix).</span>
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>	Extra [][]byte
<span id="L74" class="ln">    74&nbsp;&nbsp;</span>
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	<span class="comment">// EarlyData indicates whether the ticket can be used for 0-RTT in a QUIC</span>
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>	<span class="comment">// connection. The application may set this to false if it is true to</span>
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>	<span class="comment">// decline to offer 0-RTT even if supported.</span>
...
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>	<span class="comment">// createdAt is the generation time of the secret on the sever (which for</span>
<span id="L84" class="ln">    84&nbsp;&nbsp;</span>	<span class="comment">// TLS 1.0–1.2 might be earlier than the current session) and the time at</span>
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>	<span class="comment">// which the ticket was received on the client.</span>
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>	createdAt         uint64 <span class="comment">// seconds since UNIX epoch</span>
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>	secret            []byte <span class="comment">// master secret for TLS 1.2, or the PSK for TLS 1.3</span>
...
<span id="L94" class="ln">    94&nbsp;&nbsp;</span>	alpnProtocol      string <span class="comment">// only set if EarlyData is true</span>
<span id="L95" class="ln">    95&nbsp;&nbsp;</span>
<span id="L96" class="ln">    96&nbsp;&nbsp;</span>	<span class="comment">// Client-side TLS 1.3-only fields.</span>
<span id="L97" class="ln">    97&nbsp;&nbsp;</span>	useBy  uint64 <span class="comment">// seconds since UNIX epoch</span>
