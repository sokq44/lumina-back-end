...
<a href="cert_pool.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/x509">x509</a>/<span class="text-muted">cert_pool.go</span>
  </h1>
...
<span id="L180" class="ln">   180&nbsp;&nbsp;</span>func (s *CertPool) AddCert(cert *Certificate) {
...
</pre><p><a href="cert_pool.go?m=text">View as plain text</a></p>
