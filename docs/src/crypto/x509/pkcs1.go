...
<a href="pkcs1.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/x509">x509</a>/<span class="text-muted">pkcs1.go</span>
  </h1>
...
<span id="L104" class="ln">   104&nbsp;&nbsp;</span>func MarshalPKCS1PrivateKey(key *rsa.PrivateKey) []byte {
...
</pre><p><a href="pkcs1.go?m=text">View as plain text</a></p>
