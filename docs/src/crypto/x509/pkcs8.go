...
<a href="pkcs8.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/x509">x509</a>/<span class="text-muted">pkcs8.go</span>
  </h1>
...
<span id="L35" class="ln">    35&nbsp;&nbsp;</span>func ParsePKCS8PrivateKey(der []byte) (key any, err error) {
...
</pre><p><a href="pkcs8.go?m=text">View as plain text</a></p>
