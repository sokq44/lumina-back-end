...
<a href="sec1.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/crypto">crypto</a>/<a href="http://localhost:8080/src/crypto/x509">x509</a>/<span class="text-muted">sec1.go</span>
  </h1>
...
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>func ParseECPrivateKey(der []byte) (*ecdsa.PrivateKey, error) {
...
</pre><p><a href="sec1.go?m=text">View as plain text</a></p>
