...
<a href="x509.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L2202" class="ln">  2202&nbsp;&nbsp;</span>type RevocationListEntry struct {
<span id="L2203" class="ln">  2203&nbsp;&nbsp;</span>	<span class="comment">// Raw contains the raw bytes of the revokedCertificates entry. It is set when</span>
<span id="L2204" class="ln">  2204&nbsp;&nbsp;</span>	<span class="comment">// parsing a CRL; it is ignored when generating a CRL.</span>
<span id="L2205" class="ln">  2205&nbsp;&nbsp;</span>	Raw []byte
<span id="L2206" class="ln">  2206&nbsp;&nbsp;</span>
<span id="L2207" class="ln">  2207&nbsp;&nbsp;</span>	<span class="comment">// SerialNumber represents the serial number of a revoked certificate. It is</span>
<span id="L2208" class="ln">  2208&nbsp;&nbsp;</span>	<span class="comment">// both used when creating a CRL and populated when parsing a CRL. It must not</span>
<span id="L2209" class="ln">  2209&nbsp;&nbsp;</span>	<span class="comment">// be nil.</span>
<span id="L2210" class="ln">  2210&nbsp;&nbsp;</span>	SerialNumber *big.Int
<span id="L2211" class="ln">  2211&nbsp;&nbsp;</span>	<span class="comment">// RevocationTime represents the time at which the certificate was revoked. It</span>
<span id="L2212" class="ln">  2212&nbsp;&nbsp;</span>	<span class="comment">// is both used when creating a CRL and populated when parsing a CRL. It must</span>
<span id="L2213" class="ln">  2213&nbsp;&nbsp;</span>	<span class="comment">// not be the zero time.</span>
<span id="L2214" class="ln">  2214&nbsp;&nbsp;</span>	RevocationTime time.Time
<span id="L2215" class="ln">  2215&nbsp;&nbsp;</span>	<span class="comment">// ReasonCode represents the reason for revocation, using the integer enum</span>
<span id="L2216" class="ln">  2216&nbsp;&nbsp;</span>	<span class="comment">// values specified in RFC 5280 Section 5.3.1. When creating a CRL, the zero</span>
<span id="L2217" class="ln">  2217&nbsp;&nbsp;</span>	<span class="comment">// value will result in the reasonCode extension being omitted. When parsing a</span>
<span id="L2218" class="ln">  2218&nbsp;&nbsp;</span>	<span class="comment">// CRL, the zero value may represent either the reasonCode extension being</span>
<span id="L2219" class="ln">  2219&nbsp;&nbsp;</span>	<span class="comment">// absent (which implies the default revocation reason of 0/Unspecified), or</span>
<span id="L2220" class="ln">  2220&nbsp;&nbsp;</span>	<span class="comment">// it may represent the reasonCode extension being present and explicitly</span>
<span id="L2221" class="ln">  2221&nbsp;&nbsp;</span>	<span class="comment">// containing a value of 0/Unspecified (which should not happen according to</span>
<span id="L2222" class="ln">  2222&nbsp;&nbsp;</span>	<span class="comment">// the DER encoding rules, but can and does happen anyway).</span>
<span id="L2223" class="ln">  2223&nbsp;&nbsp;</span>	ReasonCode int
<span id="L2224" class="ln">  2224&nbsp;&nbsp;</span>
<span id="L2225" class="ln">  2225&nbsp;&nbsp;</span>	<span class="comment">// Extensions contains raw X.509 extensions. When parsing CRL entries,</span>
<span id="L2226" class="ln">  2226&nbsp;&nbsp;</span>	<span class="comment">// this can be used to extract non-critical extensions that are not</span>
<span id="L2227" class="ln">  2227&nbsp;&nbsp;</span>	<span class="comment">// parsed by this package. When marshaling CRL entries, the Extensions</span>
<span id="L2228" class="ln">  2228&nbsp;&nbsp;</span>	<span class="comment">// field is ignored, see ExtraExtensions.</span>
<span id="L2229" class="ln">  2229&nbsp;&nbsp;</span>	Extensions []pkix.Extension
<span id="L2230" class="ln">  2230&nbsp;&nbsp;</span>	<span class="comment">// ExtraExtensions contains extensions to be copied, raw, into any</span>
<span id="L2231" class="ln">  2231&nbsp;&nbsp;</span>	<span class="comment">// marshaled CRL entries. Values override any extensions that would</span>
<span id="L2232" class="ln">  2232&nbsp;&nbsp;</span>	<span class="comment">// otherwise be produced based on the other fields. The ExtraExtensions</span>
<span id="L2233" class="ln">  2233&nbsp;&nbsp;</span>	<span class="comment">// field is not populated when parsing CRL entries, see Extensions.</span>
