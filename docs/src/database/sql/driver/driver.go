...
<span id="L365" class="ln">   365&nbsp;&nbsp;</span>type StmtExecContext interface {
<span id="L366" class="ln">   366&nbsp;&nbsp;</span>	<span class="comment">// ExecContext executes a query that doesn&#39;t return rows, such</span>
<span id="L367" class="ln">   367&nbsp;&nbsp;</span>	<span class="comment">// as an INSERT or UPDATE.</span>
<span id="L368" class="ln">   368&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L369" class="ln">   369&nbsp;&nbsp;</span>	<span class="comment">// ExecContext must honor the context timeout and return when it is canceled.</span>
