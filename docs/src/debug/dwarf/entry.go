...
<a href="entry.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L799" class="ln">   799&nbsp;&nbsp;</span>type Reader struct {
...
<span id="L804" class="ln">   804&nbsp;&nbsp;</span>	lastUnit     bool   <span class="comment">// set if last entry returned by Next is TagCompileUnit/TagPartialUnit</span>
<span id="L805" class="ln">   805&nbsp;&nbsp;</span>	lastChildren bool   <span class="comment">// .Children of last entry returned by Next</span>
<span id="L806" class="ln">   806&nbsp;&nbsp;</span>	lastSibling  Offset <span class="comment">// .Val(AttrSibling) of last entry returned by Next</span>
<span id="L807" class="ln">   807&nbsp;&nbsp;</span>	cu           *Entry <span class="comment">// current compilation unit</span>
