...
<a href="line.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L133" class="ln">   133&nbsp;&nbsp;</span>type LineFile struct {
<span id="L134" class="ln">   134&nbsp;&nbsp;</span>	Name   string
<span id="L135" class="ln">   135&nbsp;&nbsp;</span>	Mtime  uint64 <span class="comment">// Implementation defined modification time, or 0 if unknown</span>
<span id="L136" class="ln">   136&nbsp;&nbsp;</span>	Length int    <span class="comment">// File length, or 0 if unknown</span>
