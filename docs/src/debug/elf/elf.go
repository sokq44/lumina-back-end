...
<span id="L15" class="ln">    15&nbsp;&nbsp;</span> * &#34;ELF for the ARM® 64-bit Architecture (AArch64)&#34; (ARM IHI 0056B)
...
<span id="L386" class="ln">   386&nbsp;&nbsp;</span>	EM_BPF           Machine = 247 <span class="comment">/* Linux BPF – in-kernel virtual machine */</span>
...
<span id="L1109" class="ln">  1109&nbsp;&nbsp;</span>func (i DynFlag) String() string   { return flagName(uint32(i), dflagStrings, false) }
