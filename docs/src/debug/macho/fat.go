...
<a href="fat.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/debug">debug</a>/<a href="http://localhost:8080/src/debug/macho">macho</a>/<span class="text-muted">fat.go</span>
  </h1>
...
<span id="L16" class="ln">    16&nbsp;&nbsp;</span>type FatFile struct {
...
</pre><p><a href="fat.go?m=text">View as plain text</a></p>
