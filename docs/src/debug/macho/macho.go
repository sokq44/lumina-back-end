...
<a href="macho.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/debug">debug</a>/<a href="http://localhost:8080/src/debug/macho">macho</a>/<span class="text-muted">macho.go</span>
  </h1>
...
<span id="L195" class="ln">   195&nbsp;&nbsp;</span>	Thread struct {
...
</pre><p><a href="macho.go?m=text">View as plain text</a></p>
