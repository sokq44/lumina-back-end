...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/debug/pe/pe.go - Go Documentation Server</title>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/debug">debug</a>/<a href="http://localhost:8080/src/debug/pe">pe</a>/<span class="text-muted">pe.go</span>
  </h1>
