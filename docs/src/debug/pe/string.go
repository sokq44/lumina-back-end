...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/debug">debug</a>/<a href="http://localhost:8080/src/debug/pe">pe</a>/<span class="text-muted">string.go</span>
  </h1>
...
<span id="L26" class="ln">    26&nbsp;&nbsp;</span>type StringTable []byte
