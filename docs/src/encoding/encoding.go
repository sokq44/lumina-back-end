...
<a href="encoding.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/encoding">encoding</a>/<span class="text-muted">encoding.go</span>
  </h1>
  ...
  <h2>
    Documentation: <a href="http://localhost:8080/pkg/encoding">encoding</a>
  </h2>
...
</pre><p><a href="encoding.go?m=text">View as plain text</a></p>
