...
<a href="indent.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/encoding">encoding</a>/<a href="http://localhost:8080/src/encoding/json">json</a>/<span class="text-muted">indent.go</span>
  </h1>
...
<span id="L118" class="ln">   118&nbsp;&nbsp;</span>func Indent(dst *bytes.Buffer, src []byte, prefix, indent string) error {
...
</pre><p><a href="indent.go?m=text">View as plain text</a></p>
