...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/encoding/json/tables.go - Go Documentation Server</title>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/encoding">encoding</a>/<a href="http://localhost:8080/src/encoding/json">json</a>/<span class="text-muted">tables.go</span>
  </h1>
