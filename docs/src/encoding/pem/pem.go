...
<a href="pem.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/encoding">encoding</a>/<a href="http://localhost:8080/src/encoding/pem">pem</a>/<span class="text-muted">pem.go</span>
  </h1>
  ...
  <h2>
    Documentation: <a href="http://localhost:8080/pkg/encoding/pem">encoding/pem</a>
  </h2>
...
<span id="L277" class="ln">   277&nbsp;&nbsp;</span>		sort.Strings(h)
...
</pre><p><a href="pem.go?m=text">View as plain text</a></p>
