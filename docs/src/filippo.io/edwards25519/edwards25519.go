...
<a href="edwards25519.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L29" class="ln">    29&nbsp;&nbsp;</span>type Point struct {
<span id="L30" class="ln">    30&nbsp;&nbsp;</span>	<span class="comment">// Make the type not comparable (i.e. used with == or as a map key), as</span>
<span id="L31" class="ln">    31&nbsp;&nbsp;</span>	<span class="comment">// equivalent points can be represented by different Go values.</span>
<span id="L32" class="ln">    32&nbsp;&nbsp;</span>	_ incomparable
<span id="L33" class="ln">    33&nbsp;&nbsp;</span>
<span id="L34" class="ln">    34&nbsp;&nbsp;</span>	<span class="comment">// The point is internally represented in extended coordinates (X, Y, Z, T)</span>
<span id="L35" class="ln">    35&nbsp;&nbsp;</span>	<span class="comment">// where x = X/Z, y = Y/Z, and xy = T/Z per https://eprint.iacr.org/2008/522.</span>
