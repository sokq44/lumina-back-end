...
<a href="extra.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L297" class="ln">   297&nbsp;&nbsp;</span>func (v *Point) VarTimeMultiScalarMult(scalars []*Scalar, points []*Point) *Point {
