...
<a href="scalarmult.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L143" class="ln">   143&nbsp;&nbsp;</span>func (v *Point) VarTimeDoubleScalarBaseMult(a *Scalar, A *Point, b *Scalar) *Point {
