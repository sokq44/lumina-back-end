...
<a href="flag.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L878" class="ln">   878&nbsp;&nbsp;</span>func (f *FlagSet) StringVar(p *string, name string, value string, usage string) {
