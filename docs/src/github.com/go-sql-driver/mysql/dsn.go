...
<a href="dsn.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>type Config struct {
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>	<span class="comment">// non boolean fields</span>
<span id="L39" class="ln">    39&nbsp;&nbsp;</span>
<span id="L40" class="ln">    40&nbsp;&nbsp;</span>	User                 string            <span class="comment">// Username</span>
<span id="L41" class="ln">    41&nbsp;&nbsp;</span>	Passwd               string            <span class="comment">// Password (requires User)</span>
<span id="L42" class="ln">    42&nbsp;&nbsp;</span>	Net                  string            <span class="comment">// Network (e.g. &#34;tcp&#34;, &#34;tcp6&#34;, &#34;unix&#34;. default: &#34;tcp&#34;)</span>
<span id="L43" class="ln">    43&nbsp;&nbsp;</span>	Addr                 string            <span class="comment">// Address (default: &#34;127.0.0.1:3306&#34; for &#34;tcp&#34; and &#34;/tmp/mysql.sock&#34; for &#34;unix&#34;)</span>
<span id="L44" class="ln">    44&nbsp;&nbsp;</span>	DBName               string            <span class="comment">// Database name</span>
<span id="L45" class="ln">    45&nbsp;&nbsp;</span>	Params               map[string]string <span class="comment">// Connection parameters</span>
<span id="L46" class="ln">    46&nbsp;&nbsp;</span>	ConnectionAttributes string            <span class="comment">// Connection Attributes, comma-delimited string of user-defined &#34;key:value&#34; pairs</span>
<span id="L47" class="ln">    47&nbsp;&nbsp;</span>	Collation            string            <span class="comment">// Connection collation</span>
<span id="L48" class="ln">    48&nbsp;&nbsp;</span>	Loc                  *time.Location    <span class="comment">// Location for time.Time values</span>
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>	MaxAllowedPacket     int               <span class="comment">// Max packet size allowed</span>
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>	ServerPubKey         string            <span class="comment">// Server public key name</span>
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>	TLSConfig            string            <span class="comment">// TLS configuration name</span>
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	TLS                  *tls.Config       <span class="comment">// TLS configuration, its priority is higher than TLSConfig</span>
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>	Timeout              time.Duration     <span class="comment">// Dial timeout</span>
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>	ReadTimeout          time.Duration     <span class="comment">// I/O read timeout</span>
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>	WriteTimeout         time.Duration     <span class="comment">// I/O write timeout</span>
<span id="L56" class="ln">    56&nbsp;&nbsp;</span>	Logger               Logger            <span class="comment">// Logger</span>
<span id="L57" class="ln">    57&nbsp;&nbsp;</span>
<span id="L58" class="ln">    58&nbsp;&nbsp;</span>	<span class="comment">// boolean fields</span>
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>	AllowAllFiles            bool <span class="comment">// Allow all files to be used with LOAD DATA LOCAL INFILE</span>
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>	AllowCleartextPasswords  bool <span class="comment">// Allows the cleartext client side plugin</span>
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>	AllowFallbackToPlaintext bool <span class="comment">// Allows fallback to unencrypted connection if server does not support TLS</span>
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	AllowNativePasswords     bool <span class="comment">// Allows the native password authentication method</span>
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	AllowOldPasswords        bool <span class="comment">// Allows the old insecure password method</span>
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>	CheckConnLiveness        bool <span class="comment">// Check connections for liveness before using them</span>
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>	ClientFoundRows          bool <span class="comment">// Return number of matching rows instead of rows changed</span>
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>	ColumnsWithAlias         bool <span class="comment">// Prepend table alias to column names</span>
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>	InterpolateParams        bool <span class="comment">// Interpolate placeholders into query string</span>
<span id="L69" class="ln">    69&nbsp;&nbsp;</span>	MultiStatements          bool <span class="comment">// Allow multiple statements in one query</span>
<span id="L70" class="ln">    70&nbsp;&nbsp;</span>	ParseTime                bool <span class="comment">// Parse time values to time.Time</span>
<span id="L71" class="ln">    71&nbsp;&nbsp;</span>	RejectReadOnly           bool <span class="comment">// Reject read-only connections</span>
<span id="L72" class="ln">    72&nbsp;&nbsp;</span>
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>	<span class="comment">// unexported fields. new options should be come here</span>
<span id="L74" class="ln">    74&nbsp;&nbsp;</span>
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	beforeConnect func(context.Context, *Config) error <span class="comment">// Invoked before a connection is established</span>
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>	pubKey        *rsa.PublicKey                       <span class="comment">// Server public key</span>
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>	timeTruncate  time.Duration                        <span class="comment">// Truncate time.Time values to the specified duration</span>
