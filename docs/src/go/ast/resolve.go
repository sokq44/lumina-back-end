...
<a href="resolve.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/ast">ast</a>/<span class="text-muted">resolve.go</span>
  </h1>
...
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>type Importer func(imports map[string]*Object, path string) (pkg *Object, err error)
...
</pre><p><a href="resolve.go?m=text">View as plain text</a></p>
