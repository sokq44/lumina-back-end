...
<a href="vers.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/build">build</a>/<a href="http://localhost:8080/src/go/build/constraint">constraint</a>/<span class="text-muted">vers.go</span>
  </h1>
...
<span id="L30" class="ln">    30&nbsp;&nbsp;</span>func GoVersion(x Expr) string {
...
</pre><p><a href="vers.go?m=text">View as plain text</a></p>
