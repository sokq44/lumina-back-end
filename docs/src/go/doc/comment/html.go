...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/doc">doc</a>/<a href="http://localhost:8080/src/go/doc/comment">comment</a>/<span class="text-muted">html.go</span>
  </h1>
...
<span id="L21" class="ln">    21&nbsp;&nbsp;</span>func (p *Printer) HTML(d *Doc) []byte {
