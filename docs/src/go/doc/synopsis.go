...
<a href="synopsis.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/doc">doc</a>/<span class="text-muted">synopsis.go</span>
  </h1>
...
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>func Synopsis(text string) string {
...
</pre><p><a href="synopsis.go?m=text">View as plain text</a></p>
