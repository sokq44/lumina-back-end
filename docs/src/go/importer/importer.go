...
<a href="importer.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/importer">importer</a>/<span class="text-muted">importer.go</span>
  </h1>
  ...
  <h2>
    Documentation: <a href="http://localhost:8080/pkg/go/importer">go/importer</a>
  </h2>
...
</pre><p><a href="importer.go?m=text">View as plain text</a></p>
