...
<a href="printer.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L1423" class="ln">  1423&nbsp;&nbsp;</span>func (cfg *Config) Fprint(output io.Writer, fset *token.FileSet, node any) error {
