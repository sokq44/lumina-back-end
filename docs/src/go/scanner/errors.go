...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/scanner">scanner</a>/<span class="text-muted">errors.go</span>
  </h1>
...
<span id="L46" class="ln">    46&nbsp;&nbsp;</span>func (p ErrorList) Len() int      { return len(p) }
