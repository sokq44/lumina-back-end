...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/token">token</a>/<span class="text-muted">token.go</span>
  </h1>
...
<span id="L316" class="ln">   316&nbsp;&nbsp;</span>func IsExported(name string) bool {
