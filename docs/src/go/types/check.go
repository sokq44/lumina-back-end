...
<a href="check.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L372" class="ln">   372&nbsp;&nbsp;</span>func (check *Checker) Files(files []*ast.File) error { return check.checkFiles(files) }
