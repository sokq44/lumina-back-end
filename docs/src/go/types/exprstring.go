...
<a href="exprstring.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/types">types</a>/<span class="text-muted">exprstring.go</span>
  </h1>
...
<span id="L108" class="ln">   108&nbsp;&nbsp;</span>		if x.Ellipsis.IsValid() {
...
</pre><p><a href="exprstring.go?m=text">View as plain text</a></p>
