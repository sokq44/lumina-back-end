...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/go">go</a>/<a href="http://localhost:8080/src/go/version">version</a>/<span class="text-muted">version.go</span>
  </h1>
  ...
  <h2>
    Documentation: <a href="http://localhost:8080/pkg/go/version">go/version</a>
  </h2>
...
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>func Lang(x string) string {
