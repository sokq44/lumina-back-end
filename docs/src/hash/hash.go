...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/hash">hash</a>/<span class="text-muted">hash.go</span>
  </h1>
  ...
  <h2>
    Documentation: <a href="http://localhost:8080/pkg/hash">hash</a>
  </h2>
...
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>type Hash64 interface {
