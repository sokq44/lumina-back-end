...
<a href="color.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/image">image</a>/<a href="http://localhost:8080/src/image/color">color</a>/<span class="text-muted">color.go</span>
  </h1>
...
<span id="L114" class="ln">   114&nbsp;&nbsp;</span>func (c Alpha16) RGBA() (r, g, b, a uint32) {
...
</pre><p><a href="color.go?m=text">View as plain text</a></p>
