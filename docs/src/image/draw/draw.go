...
<a href="draw.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>type Drawer interface {
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>	<span class="comment">// Draw aligns r.Min in dst with sp in src and then replaces the</span>
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>	<span class="comment">// rectangle r in dst with the result of drawing src on dst.</span>
