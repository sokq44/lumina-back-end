...
<span id="L574" class="ln">   574&nbsp;&nbsp;</span>type GIF struct {
<span id="L575" class="ln">   575&nbsp;&nbsp;</span>	Image []*image.Paletted <span class="comment">// The successive images.</span>
<span id="L576" class="ln">   576&nbsp;&nbsp;</span>	Delay []int             <span class="comment">// The successive delay times, one per frame, in 100ths of a second.</span>
<span id="L577" class="ln">   577&nbsp;&nbsp;</span>	<span class="comment">// LoopCount controls the number of times an animation will be</span>
<span id="L578" class="ln">   578&nbsp;&nbsp;</span>	<span class="comment">// restarted during display.</span>
<span id="L579" class="ln">   579&nbsp;&nbsp;</span>	<span class="comment">// A LoopCount of 0 means to loop forever.</span>
<span id="L580" class="ln">   580&nbsp;&nbsp;</span>	<span class="comment">// A LoopCount of -1 means to show each frame only once.</span>
<span id="L581" class="ln">   581&nbsp;&nbsp;</span>	<span class="comment">// Otherwise, the animation is looped LoopCount+1 times.</span>
<span id="L582" class="ln">   582&nbsp;&nbsp;</span>	LoopCount int
<span id="L583" class="ln">   583&nbsp;&nbsp;</span>	<span class="comment">// Disposal is the successive disposal methods, one per frame. For</span>
<span id="L584" class="ln">   584&nbsp;&nbsp;</span>	<span class="comment">// backwards compatibility, a nil Disposal is valid to pass to EncodeAll,</span>
<span id="L585" class="ln">   585&nbsp;&nbsp;</span>	<span class="comment">// and implies that each frame&#39;s disposal method is 0 (no disposal</span>
<span id="L586" class="ln">   586&nbsp;&nbsp;</span>	<span class="comment">// specified).</span>
<span id="L587" class="ln">   587&nbsp;&nbsp;</span>	Disposal []byte
<span id="L588" class="ln">   588&nbsp;&nbsp;</span>	<span class="comment">// Config is the global color table (palette), width and height. A nil or</span>
<span id="L589" class="ln">   589&nbsp;&nbsp;</span>	<span class="comment">// empty-color.Palette Config.ColorModel means that each frame has its own</span>
<span id="L590" class="ln">   590&nbsp;&nbsp;</span>	<span class="comment">// color table and there is no global color table. Each frame&#39;s bounds must</span>
<span id="L591" class="ln">   591&nbsp;&nbsp;</span>	<span class="comment">// be within the rectangle defined by the two points (0, 0) and</span>
<span id="L592" class="ln">   592&nbsp;&nbsp;</span>	<span class="comment">// (Config.Width, Config.Height).</span>
<span id="L593" class="ln">   593&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L594" class="ln">   594&nbsp;&nbsp;</span>	<span class="comment">// For backwards compatibility, a zero-valued Config is valid to pass to</span>
<span id="L595" class="ln">   595&nbsp;&nbsp;</span>	<span class="comment">// EncodeAll, and implies that the overall GIF&#39;s width and height equals</span>
<span id="L596" class="ln">   596&nbsp;&nbsp;</span>	<span class="comment">// the first frame&#39;s bounds&#39; Rectangle.Max point.</span>
<span id="L597" class="ln">   597&nbsp;&nbsp;</span>	Config image.Config
<span id="L598" class="ln">   598&nbsp;&nbsp;</span>	<span class="comment">// BackgroundIndex is the background index in the global color table, for</span>
<span id="L599" class="ln">   599&nbsp;&nbsp;</span>	<span class="comment">// use with the DisposalBackground disposal method.</span>
