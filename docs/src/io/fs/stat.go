...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/io">io</a>/<a href="http://localhost:8080/src/io/fs">fs</a>/<span class="text-muted">stat.go</span>
  </h1>
...
<span id="L20" class="ln">    20&nbsp;&nbsp;</span>func Stat(fsys FS, name string) (FileInfo, error) {
