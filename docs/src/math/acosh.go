...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/math/acosh.go - Go Documentation Server</title>
...
<a href="acosh.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">acosh.go</span>
  </h1>
...
<span id="L40" class="ln">    40&nbsp;&nbsp;</span><span class="comment">//	Acosh(+Inf) = +Inf</span>
<span id="L41" class="ln">    41&nbsp;&nbsp;</span><span class="comment">//	Acosh(x) = NaN if x &lt; 1</span>
<span id="L42" class="ln">    42&nbsp;&nbsp;</span><span class="comment">//	Acosh(NaN) = NaN</span>
<span id="L43" class="ln">    43&nbsp;&nbsp;</span>func Acosh(x float64) float64 {
<span id="L44" class="ln">    44&nbsp;&nbsp;</span>	if haveArchAcosh {
<span id="L45" class="ln">    45&nbsp;&nbsp;</span>		return archAcosh(x)
<span id="L46" class="ln">    46&nbsp;&nbsp;</span>	}
<span id="L47" class="ln">    47&nbsp;&nbsp;</span>	return acosh(x)
<span id="L48" class="ln">    48&nbsp;&nbsp;</span>}
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>func acosh(x float64) float64 {
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>	const Large = 1 &lt;&lt; 28 <span class="comment">// 2**28</span>
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	<span class="comment">// first case is special case</span>
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>	switch {
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>	case x &lt; 1 || IsNaN(x):
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>		return NaN()
<span id="L56" class="ln">    56&nbsp;&nbsp;</span>	case x == 1:
<span id="L57" class="ln">    57&nbsp;&nbsp;</span>		return 0
<span id="L58" class="ln">    58&nbsp;&nbsp;</span>	case x &gt;= Large:
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>		return Log(x) + Ln2 <span class="comment">// x &gt; 2**28</span>
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>	case x &gt; 2:
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>		return Log(2*x - 1/(x+Sqrt(x*x-1))) <span class="comment">// 2**28 &gt; x &gt; 2</span>
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>	}
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	t := x - 1
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	return Log1p(t + Sqrt(2*t+t*t)) <span class="comment">// 2 &gt;= x &gt; 1</span>
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>}
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>
</pre><p><a href="acosh.go?m=text">View as plain text</a></p>
