...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/math/atanh.go - Go Documentation Server</title>
...
<a href="atanh.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">atanh.go</span>
  </h1>
...
<span id="L43" class="ln">    43&nbsp;&nbsp;</span><span class="comment">//	Atanh(1) = +Inf</span>
<span id="L44" class="ln">    44&nbsp;&nbsp;</span><span class="comment">//	Atanh(±0) = ±0</span>
<span id="L45" class="ln">    45&nbsp;&nbsp;</span><span class="comment">//	Atanh(-1) = -Inf</span>
<span id="L46" class="ln">    46&nbsp;&nbsp;</span><span class="comment">//	Atanh(x) = NaN if x &lt; -1 or x &gt; 1</span>
<span id="L47" class="ln">    47&nbsp;&nbsp;</span><span class="comment">//	Atanh(NaN) = NaN</span>
<span id="L48" class="ln">    48&nbsp;&nbsp;</span>func Atanh(x float64) float64 {
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>	if haveArchAtanh {
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>		return archAtanh(x)
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>	}
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	return atanh(x)
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>}
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>func atanh(x float64) float64 {
<span id="L56" class="ln">    56&nbsp;&nbsp;</span>	const NearZero = 1.0 / (1 &lt;&lt; 28) <span class="comment">// 2**-28</span>
<span id="L57" class="ln">    57&nbsp;&nbsp;</span>	<span class="comment">// special cases</span>
<span id="L58" class="ln">    58&nbsp;&nbsp;</span>	switch {
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>	case x &lt; -1 || x &gt; 1 || IsNaN(x):
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>		return NaN()
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>	case x == 1:
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>		return Inf(1)
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	case x == -1:
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>		return Inf(-1)
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>	}
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>	sign := false
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>	if x &lt; 0 {
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>		x = -x
<span id="L69" class="ln">    69&nbsp;&nbsp;</span>		sign = true
<span id="L70" class="ln">    70&nbsp;&nbsp;</span>	}
<span id="L71" class="ln">    71&nbsp;&nbsp;</span>	var temp float64
<span id="L72" class="ln">    72&nbsp;&nbsp;</span>	switch {
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>	case x &lt; NearZero:
<span id="L74" class="ln">    74&nbsp;&nbsp;</span>		temp = x
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	case x &lt; 0.5:
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>		temp = x + x
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>		temp = 0.5 * Log1p(temp+temp*x/(1-x))
<span id="L78" class="ln">    78&nbsp;&nbsp;</span>	default:
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>		temp = 0.5 * Log1p((x+x)/(1-x))
<span id="L80" class="ln">    80&nbsp;&nbsp;</span>	}
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>	if sign {
<span id="L82" class="ln">    82&nbsp;&nbsp;</span>		temp = -temp
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>	}
<span id="L84" class="ln">    84&nbsp;&nbsp;</span>	return temp
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>}
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>
</pre><p><a href="atanh.go?m=text">View as plain text</a></p>
