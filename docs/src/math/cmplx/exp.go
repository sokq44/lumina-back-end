...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/math/cmplx/exp.go - Go Documentation Server</title>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<a href="http://localhost:8080/src/math/cmplx">cmplx</a>/<span class="text-muted">exp.go</span>
  </h1>
...
<span id="L31" class="ln">    31&nbsp;&nbsp;</span><span class="comment">// Complex exponential function</span>
...
<span id="L35" class="ln">    35&nbsp;&nbsp;</span><span class="comment">// Returns the complex exponential of the complex argument z.</span>
<span id="L36" class="ln">    36&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L37" class="ln">    37&nbsp;&nbsp;</span><span class="comment">// If</span>
<span id="L38" class="ln">    38&nbsp;&nbsp;</span><span class="comment">//     z = x + iy,</span>
<span id="L39" class="ln">    39&nbsp;&nbsp;</span><span class="comment">//     r = exp(x),</span>
<span id="L40" class="ln">    40&nbsp;&nbsp;</span><span class="comment">// then</span>
<span id="L41" class="ln">    41&nbsp;&nbsp;</span><span class="comment">//     w = r cos y + i r sin y.</span>
<span id="L42" class="ln">    42&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L43" class="ln">    43&nbsp;&nbsp;</span><span class="comment">// ACCURACY:</span>
<span id="L44" class="ln">    44&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L45" class="ln">    45&nbsp;&nbsp;</span><span class="comment">//                      Relative error:</span>
<span id="L46" class="ln">    46&nbsp;&nbsp;</span><span class="comment">// arithmetic   domain     # trials      peak         rms</span>
<span id="L47" class="ln">    47&nbsp;&nbsp;</span><span class="comment">//    DEC       -10,+10      8700       3.7e-17     1.1e-17</span>
<span id="L48" class="ln">    48&nbsp;&nbsp;</span><span class="comment">//    IEEE      -10,+10     30000       3.0e-16     8.7e-17</span>
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>
<span id="L50" class="ln">    50&nbsp;&nbsp;</span><span class="comment">// Exp returns e**x, the base-e exponential of x.</span>
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>func Exp(x complex128) complex128 {
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	switch re, im := real(x), imag(x); {
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>	case math.IsInf(re, 0):
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>		switch {
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>		case re &gt; 0 &amp;&amp; im == 0:
<span id="L56" class="ln">    56&nbsp;&nbsp;</span>			return x
<span id="L57" class="ln">    57&nbsp;&nbsp;</span>		case math.IsInf(im, 0) || math.IsNaN(im):
<span id="L58" class="ln">    58&nbsp;&nbsp;</span>			if re &lt; 0 {
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>				return complex(0, math.Copysign(0, im))
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>			} else {
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>				return complex(math.Inf(1.0), math.NaN())
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>			}
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>		}
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	case math.IsNaN(re):
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>		if im == 0 {
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>			return complex(math.NaN(), im)
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>		}
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>	}
<span id="L69" class="ln">    69&nbsp;&nbsp;</span>	r := math.Exp(real(x))
<span id="L70" class="ln">    70&nbsp;&nbsp;</span>	s, c := math.Sincos(imag(x))
<span id="L71" class="ln">    71&nbsp;&nbsp;</span>	return complex(r*c, r*s)
