...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/math/cmplx/log.go - Go Documentation Server</title>
...
<a href="log.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<a href="http://localhost:8080/src/math/cmplx">cmplx</a>/<span class="text-muted">log.go</span>
  </h1>
...
<span id="L31" class="ln">    31&nbsp;&nbsp;</span><span class="comment">// Complex natural logarithm</span>
...
<span id="L35" class="ln">    35&nbsp;&nbsp;</span><span class="comment">// Returns complex logarithm to the base e (2.718...) of</span>
<span id="L36" class="ln">    36&nbsp;&nbsp;</span><span class="comment">// the complex argument z.</span>
<span id="L37" class="ln">    37&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L38" class="ln">    38&nbsp;&nbsp;</span><span class="comment">// If</span>
<span id="L39" class="ln">    39&nbsp;&nbsp;</span><span class="comment">//       z = x + iy, r = sqrt( x**2 + y**2 ),</span>
<span id="L40" class="ln">    40&nbsp;&nbsp;</span><span class="comment">// then</span>
<span id="L41" class="ln">    41&nbsp;&nbsp;</span><span class="comment">//       w = log(r) + i arctan(y/x).</span>
<span id="L42" class="ln">    42&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L43" class="ln">    43&nbsp;&nbsp;</span><span class="comment">// The arctangent ranges from -PI to +PI.</span>
<span id="L44" class="ln">    44&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L45" class="ln">    45&nbsp;&nbsp;</span><span class="comment">// ACCURACY:</span>
<span id="L46" class="ln">    46&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L47" class="ln">    47&nbsp;&nbsp;</span><span class="comment">//                      Relative error:</span>
<span id="L48" class="ln">    48&nbsp;&nbsp;</span><span class="comment">// arithmetic   domain     # trials      peak         rms</span>
<span id="L49" class="ln">    49&nbsp;&nbsp;</span><span class="comment">//    DEC       -10,+10      7000       8.5e-17     1.9e-17</span>
<span id="L50" class="ln">    50&nbsp;&nbsp;</span><span class="comment">//    IEEE      -10,+10     30000       5.0e-15     1.1e-16</span>
<span id="L51" class="ln">    51&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L52" class="ln">    52&nbsp;&nbsp;</span><span class="comment">// Larger relative error can be observed for z near 1 +i0.</span>
<span id="L53" class="ln">    53&nbsp;&nbsp;</span><span class="comment">// In IEEE arithmetic the peak absolute error is 5.2e-16, rms</span>
<span id="L54" class="ln">    54&nbsp;&nbsp;</span><span class="comment">// absolute error 1.0e-16.</span>
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>
<span id="L56" class="ln">    56&nbsp;&nbsp;</span><span class="comment">// Log returns the natural logarithm of x.</span>
<span id="L57" class="ln">    57&nbsp;&nbsp;</span>func Log(x complex128) complex128 {
<span id="L58" class="ln">    58&nbsp;&nbsp;</span>	return complex(math.Log(Abs(x)), Phase(x))
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>}
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>
<span id="L61" class="ln">    61&nbsp;&nbsp;</span><span class="comment">// Log10 returns the decimal logarithm of x.</span>
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>func Log10(x complex128) complex128 {
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	z := Log(x)
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	return complex(math.Log10E*real(z), math.Log10E*imag(z))
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>}
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>
</pre><p><a href="log.go?m=text">View as plain text</a></p>
