...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/math/cmplx/pow.go - Go Documentation Server</title>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<a href="http://localhost:8080/src/math/cmplx">cmplx</a>/<span class="text-muted">pow.go</span>
  </h1>
...
<span id="L31" class="ln">    31&nbsp;&nbsp;</span><span class="comment">// Complex power function</span>
...
<span id="L35" class="ln">    35&nbsp;&nbsp;</span><span class="comment">// Raises complex A to the complex Zth power.</span>
<span id="L36" class="ln">    36&nbsp;&nbsp;</span><span class="comment">// Definition is per AMS55 # 4.2.8,</span>
<span id="L37" class="ln">    37&nbsp;&nbsp;</span><span class="comment">// analytically equivalent to cpow(a,z) = cexp(z clog(a)).</span>
<span id="L38" class="ln">    38&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L39" class="ln">    39&nbsp;&nbsp;</span><span class="comment">// ACCURACY:</span>
<span id="L40" class="ln">    40&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L41" class="ln">    41&nbsp;&nbsp;</span><span class="comment">//                      Relative error:</span>
<span id="L42" class="ln">    42&nbsp;&nbsp;</span><span class="comment">// arithmetic   domain     # trials      peak         rms</span>
<span id="L43" class="ln">    43&nbsp;&nbsp;</span><span class="comment">//    IEEE      -10,+10     30000       9.4e-15     1.5e-15</span>
<span id="L44" class="ln">    44&nbsp;&nbsp;</span>
<span id="L45" class="ln">    45&nbsp;&nbsp;</span><span class="comment">// Pow returns x**y, the base-x exponential of y.</span>
<span id="L46" class="ln">    46&nbsp;&nbsp;</span><span class="comment">// For generalized compatibility with [math.Pow]:</span>
<span id="L47" class="ln">    47&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L48" class="ln">    48&nbsp;&nbsp;</span><span class="comment">//	Pow(0, ±0) returns 1+0i</span>
<span id="L49" class="ln">    49&nbsp;&nbsp;</span><span class="comment">//	Pow(0, c) for real(c)&lt;0 returns Inf+0i if imag(c) is zero, otherwise Inf+Inf i.</span>
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>func Pow(x, y complex128) complex128 {
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>	if x == 0 { <span class="comment">// Guaranteed also true for x == -0.</span>
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>		if IsNaN(y) {
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>			return NaN()
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>		}
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>		r, i := real(y), imag(y)
<span id="L56" class="ln">    56&nbsp;&nbsp;</span>		switch {
<span id="L57" class="ln">    57&nbsp;&nbsp;</span>		case r == 0:
<span id="L58" class="ln">    58&nbsp;&nbsp;</span>			return 1
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>		case r &lt; 0:
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>			if i == 0 {
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>				return complex(math.Inf(1), 0)
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>			}
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>			return Inf()
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>		case r &gt; 0:
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>			return 0
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>		}
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>		panic(&#34;not reached&#34;)
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>	}
<span id="L69" class="ln">    69&nbsp;&nbsp;</span>	modulus := Abs(x)
<span id="L70" class="ln">    70&nbsp;&nbsp;</span>	if modulus == 0 {
<span id="L71" class="ln">    71&nbsp;&nbsp;</span>		return complex(0, 0)
<span id="L72" class="ln">    72&nbsp;&nbsp;</span>	}
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>	r := math.Pow(modulus, real(y))
<span id="L74" class="ln">    74&nbsp;&nbsp;</span>	arg := Phase(x)
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	theta := real(y) * arg
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>	if imag(y) != 0 {
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>		r *= math.Exp(-imag(y) * arg)
<span id="L78" class="ln">    78&nbsp;&nbsp;</span>		theta += imag(y) * math.Log(modulus)
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>	}
<span id="L80" class="ln">    80&nbsp;&nbsp;</span>	s, c := math.Sincos(theta)
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>	return complex(r*c, r*s)
