...
<a href="floor.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">floor.go</span>
  </h1>
...
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>func Round(x float64) float64 {
...
</pre><p><a href="floor.go?m=text">View as plain text</a></p>
