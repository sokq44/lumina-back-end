...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">log.go</span>
  </h1>
...
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>func Log(x float64) float64 {
