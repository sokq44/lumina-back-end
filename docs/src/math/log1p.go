...
<a href="log1p.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">log1p.go</span>
  </h1>
...
<span id="L96" class="ln">    96&nbsp;&nbsp;</span>func Log1p(x float64) float64 {
...
</pre><p><a href="log1p.go?m=text">View as plain text</a></p>
