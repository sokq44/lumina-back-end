...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/math/rand/v2/zipf.go - Go Documentation Server</title>
...
<a href="zipf.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<a href="http://localhost:8080/src/math/rand">rand</a>/<a href="http://localhost:8080/src/math/rand/v2">v2</a>/<span class="text-muted">zipf.go</span>
  </h1>
...
</pre><p><a href="zipf.go?m=text">View as plain text</a></p>
