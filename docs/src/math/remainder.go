...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/math/remainder.go - Go Documentation Server</title>
...
<a href="remainder.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">remainder.go</span>
  </h1>
...
<span id="L33" class="ln">    33&nbsp;&nbsp;</span><span class="comment">//	Remainder(±Inf, y) = NaN</span>
<span id="L34" class="ln">    34&nbsp;&nbsp;</span><span class="comment">//	Remainder(NaN, y) = NaN</span>
<span id="L35" class="ln">    35&nbsp;&nbsp;</span><span class="comment">//	Remainder(x, 0) = NaN</span>
<span id="L36" class="ln">    36&nbsp;&nbsp;</span><span class="comment">//	Remainder(x, ±Inf) = x</span>
<span id="L37" class="ln">    37&nbsp;&nbsp;</span><span class="comment">//	Remainder(x, NaN) = NaN</span>
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>func Remainder(x, y float64) float64 {
<span id="L39" class="ln">    39&nbsp;&nbsp;</span>	if haveArchRemainder {
<span id="L40" class="ln">    40&nbsp;&nbsp;</span>		return archRemainder(x, y)
<span id="L41" class="ln">    41&nbsp;&nbsp;</span>	}
<span id="L42" class="ln">    42&nbsp;&nbsp;</span>	return remainder(x, y)
<span id="L43" class="ln">    43&nbsp;&nbsp;</span>}
<span id="L44" class="ln">    44&nbsp;&nbsp;</span>
<span id="L45" class="ln">    45&nbsp;&nbsp;</span>func remainder(x, y float64) float64 {
<span id="L46" class="ln">    46&nbsp;&nbsp;</span>	const (
<span id="L47" class="ln">    47&nbsp;&nbsp;</span>		Tiny    = 4.45014771701440276618e-308 <span class="comment">// 0x0020000000000000</span>
<span id="L48" class="ln">    48&nbsp;&nbsp;</span>		HalfMax = MaxFloat64 / 2
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>	)
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>	<span class="comment">// special cases</span>
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>	switch {
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	case IsNaN(x) || IsNaN(y) || IsInf(x, 0) || y == 0:
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>		return NaN()
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>	case IsInf(y, 0):
...
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>	if y &lt; 0 {
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>		y = -y
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	}
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>	if x == y {
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>		if sign {
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>			zero := 0.0
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>			return -zero
<span id="L69" class="ln">    69&nbsp;&nbsp;</span>		}
<span id="L70" class="ln">    70&nbsp;&nbsp;</span>		return 0
<span id="L71" class="ln">    71&nbsp;&nbsp;</span>	}
<span id="L72" class="ln">    72&nbsp;&nbsp;</span>	if y &lt;= HalfMax {
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>		x = Mod(x, y+y) <span class="comment">// now x &lt; 2y</span>
<span id="L74" class="ln">    74&nbsp;&nbsp;</span>	}
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	if y &lt; Tiny {
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>		if x+x &gt; y {
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>			x -= y
<span id="L78" class="ln">    78&nbsp;&nbsp;</span>			if x+x &gt;= y {
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>				x -= y
<span id="L80" class="ln">    80&nbsp;&nbsp;</span>			}
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>		}
<span id="L82" class="ln">    82&nbsp;&nbsp;</span>	} else {
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>		yHalf := 0.5 * y
<span id="L84" class="ln">    84&nbsp;&nbsp;</span>		if x &gt; yHalf {
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>			x -= y
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>			if x &gt;= yHalf {
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>				x -= y
<span id="L88" class="ln">    88&nbsp;&nbsp;</span>			}
<span id="L89" class="ln">    89&nbsp;&nbsp;</span>		}
<span id="L90" class="ln">    90&nbsp;&nbsp;</span>	}
<span id="L91" class="ln">    91&nbsp;&nbsp;</span>	if sign {
<span id="L92" class="ln">    92&nbsp;&nbsp;</span>		x = -x
<span id="L93" class="ln">    93&nbsp;&nbsp;</span>	}
<span id="L94" class="ln">    94&nbsp;&nbsp;</span>	return x
<span id="L95" class="ln">    95&nbsp;&nbsp;</span>}
<span id="L96" class="ln">    96&nbsp;&nbsp;</span>
</pre><p><a href="remainder.go?m=text">View as plain text</a></p>
