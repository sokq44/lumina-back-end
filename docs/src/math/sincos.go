...
<a href="sincos.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">sincos.go</span>
  </h1>
...
<span id="L16" class="ln">    16&nbsp;&nbsp;</span>func Sincos(x float64) (sin, cos float64) {
...
</pre><p><a href="sincos.go?m=text">View as plain text</a></p>
