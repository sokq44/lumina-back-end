...
<a href="sinh.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">sinh.go</span>
  </h1>
...
</pre><p><a href="sinh.go?m=text">View as plain text</a></p>
