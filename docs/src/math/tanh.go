...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/math/tanh.go - Go Documentation Server</title>
...
<a href="tanh.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/math">math</a>/<span class="text-muted">tanh.go</span>
  </h1>
...
<span id="L72" class="ln">    72&nbsp;&nbsp;</span><span class="comment">//	Tanh(±0) = ±0</span>
<span id="L73" class="ln">    73&nbsp;&nbsp;</span><span class="comment">//	Tanh(±Inf) = ±1</span>
<span id="L74" class="ln">    74&nbsp;&nbsp;</span><span class="comment">//	Tanh(NaN) = NaN</span>
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>func Tanh(x float64) float64 {
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>	if haveArchTanh {
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>		return archTanh(x)
<span id="L78" class="ln">    78&nbsp;&nbsp;</span>	}
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>	return tanh(x)
<span id="L80" class="ln">    80&nbsp;&nbsp;</span>}
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>
<span id="L82" class="ln">    82&nbsp;&nbsp;</span>func tanh(x float64) float64 {
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>	const MAXLOG = 8.8029691931113054295988e+01 <span class="comment">// log(2**127)</span>
<span id="L84" class="ln">    84&nbsp;&nbsp;</span>	z := Abs(x)
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>	switch {
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>	case z &gt; 0.5*MAXLOG:
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>		if x &lt; 0 {
<span id="L88" class="ln">    88&nbsp;&nbsp;</span>			return -1
<span id="L89" class="ln">    89&nbsp;&nbsp;</span>		}
<span id="L90" class="ln">    90&nbsp;&nbsp;</span>		return 1
<span id="L91" class="ln">    91&nbsp;&nbsp;</span>	case z &gt;= 0.625:
<span id="L92" class="ln">    92&nbsp;&nbsp;</span>		s := Exp(2 * z)
<span id="L93" class="ln">    93&nbsp;&nbsp;</span>		z = 1 - 2/(s+1)
<span id="L94" class="ln">    94&nbsp;&nbsp;</span>		if x &lt; 0 {
<span id="L95" class="ln">    95&nbsp;&nbsp;</span>			z = -z
<span id="L96" class="ln">    96&nbsp;&nbsp;</span>		}
<span id="L97" class="ln">    97&nbsp;&nbsp;</span>	default:
<span id="L98" class="ln">    98&nbsp;&nbsp;</span>		if x == 0 {
<span id="L99" class="ln">    99&nbsp;&nbsp;</span>			return x
<span id="L100" class="ln">   100&nbsp;&nbsp;</span>		}
<span id="L101" class="ln">   101&nbsp;&nbsp;</span>		s := x * x
<span id="L102" class="ln">   102&nbsp;&nbsp;</span>		z = x + x*s*((tanhP[0]*s+tanhP[1])*s+tanhP[2])/(((s+tanhQ[0])*s+tanhQ[1])*s+tanhQ[2])
<span id="L103" class="ln">   103&nbsp;&nbsp;</span>	}
<span id="L104" class="ln">   104&nbsp;&nbsp;</span>	return z
<span id="L105" class="ln">   105&nbsp;&nbsp;</span>}
<span id="L106" class="ln">   106&nbsp;&nbsp;</span>
</pre><p><a href="tanh.go?m=text">View as plain text</a></p>
