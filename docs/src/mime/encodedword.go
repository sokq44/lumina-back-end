...
<a href="encodedword.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/mime">mime</a>/<span class="text-muted">encodedword.go</span>
  </h1>
...
<span id="L229" class="ln">   229&nbsp;&nbsp;</span><span class="comment">// error if and only if CharsetReader of d returns an error.</span>
...
</pre><p><a href="encodedword.go?m=text">View as plain text</a></p>
