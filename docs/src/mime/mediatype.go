...
<a href="mediatype.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/mime">mime</a>/<span class="text-muted">mediatype.go</span>
  </h1>
...
<span id="L20" class="ln">    20&nbsp;&nbsp;</span>func FormatMediaType(t string, param map[string]string) string {
...
<span id="L40" class="ln">    40&nbsp;&nbsp;</span>	sort.Strings(attrs)
...
</pre><p><a href="mediatype.go?m=text">View as plain text</a></p>
