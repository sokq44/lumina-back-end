...
<a href="multipart.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>type Part struct {
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>	<span class="comment">// The headers of the body, if any, with the keys canonicalized</span>
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>	<span class="comment">// in the same fashion that the Go http.Request headers are.</span>
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>	<span class="comment">// For example, &#34;foo-bar&#34; changes case to &#34;Foo-Bar&#34;</span>
...
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	<span class="comment">// r is either a reader directly reading from mr, or it&#39;s a</span>
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	<span class="comment">// wrapper around such a reader, decoding the</span>
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>	<span class="comment">// Content-Transfer-Encoding</span>
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>	r io.Reader
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>	n       int   <span class="comment">// known data bytes waiting in mr.bufReader</span>
<span id="L69" class="ln">    69&nbsp;&nbsp;</span>	total   int64 <span class="comment">// total data bytes read already</span>
<span id="L70" class="ln">    70&nbsp;&nbsp;</span>	err     error <span class="comment">// error to return when n == 0</span>
<span id="L71" class="ln">    71&nbsp;&nbsp;</span>	readErr error <span class="comment">// read error observed from mr.bufReader</span>
