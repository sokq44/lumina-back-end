...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/mime">mime</a>/<a href="http://localhost:8080/src/mime/quotedprintable">quotedprintable</a>/<span class="text-muted">writer.go</span>
  </h1>
...
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>func (w *Writer) Close() error {
