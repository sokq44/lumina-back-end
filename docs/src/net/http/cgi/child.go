...
<a href="child.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<a href="http://localhost:8080/src/net/http">http</a>/<a href="http://localhost:8080/src/net/http/cgi">cgi</a>/<span class="text-muted">child.go</span>
  </h1>
...
<span id="L145" class="ln">   145&nbsp;&nbsp;</span>func Serve(handler http.Handler) error {
