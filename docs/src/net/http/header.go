...
<a href="header.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<a href="http://localhost:8080/src/net/http">http</a>/<span class="text-muted">header.go</span>
  </h1>
...
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>func (h Header) Write(w io.Writer) error {
...
<span id="L155" class="ln">   155&nbsp;&nbsp;</span><span class="comment">// A headerSorter implements sort.Interface by sorting a []keyValues</span>
<span id="L156" class="ln">   156&nbsp;&nbsp;</span><span class="comment">// by key. It&#39;s used as a pointer, so it can fit in a sort.Interface</span>
<span id="L157" class="ln">   157&nbsp;&nbsp;</span><span class="comment">// interface value without allocation.</span>
<span id="L158" class="ln">   158&nbsp;&nbsp;</span>type headerSorter struct {
<span id="L159" class="ln">   159&nbsp;&nbsp;</span>	kvs []keyValues
<span id="L160" class="ln">   160&nbsp;&nbsp;</span>}
<span id="L161" class="ln">   161&nbsp;&nbsp;</span>
<span id="L162" class="ln">   162&nbsp;&nbsp;</span>func (s *headerSorter) Len() int           { return len(s.kvs) }
<span id="L163" class="ln">   163&nbsp;&nbsp;</span>func (s *headerSorter) Swap(i, j int)      { s.kvs[i], s.kvs[j] = s.kvs[j], s.kvs[i] }
<span id="L164" class="ln">   164&nbsp;&nbsp;</span>func (s *headerSorter) Less(i, j int) bool { return s.kvs[i].key &lt; s.kvs[j].key }
<span id="L165" class="ln">   165&nbsp;&nbsp;</span>
<span id="L166" class="ln">   166&nbsp;&nbsp;</span>var headerSorterPool = sync.Pool{
<span id="L167" class="ln">   167&nbsp;&nbsp;</span>	New: func() any { return new(headerSorter) },
<span id="L168" class="ln">   168&nbsp;&nbsp;</span>}
<span id="L169" class="ln">   169&nbsp;&nbsp;</span>
<span id="L170" class="ln">   170&nbsp;&nbsp;</span><span class="comment">// sortedKeyValues returns h&#39;s keys sorted in the returned kvs</span>
<span id="L171" class="ln">   171&nbsp;&nbsp;</span><span class="comment">// slice. The headerSorter used to sort is also returned, for possible</span>
<span id="L172" class="ln">   172&nbsp;&nbsp;</span><span class="comment">// return to headerSorterCache.</span>
<span id="L173" class="ln">   173&nbsp;&nbsp;</span>func (h Header) sortedKeyValues(exclude map[string]bool) (kvs []keyValues, hs *headerSorter) {
<span id="L174" class="ln">   174&nbsp;&nbsp;</span>	hs = headerSorterPool.Get().(*headerSorter)
<span id="L175" class="ln">   175&nbsp;&nbsp;</span>	if cap(hs.kvs) &lt; len(h) {
<span id="L176" class="ln">   176&nbsp;&nbsp;</span>		hs.kvs = make([]keyValues, 0, len(h))
<span id="L177" class="ln">   177&nbsp;&nbsp;</span>	}
<span id="L178" class="ln">   178&nbsp;&nbsp;</span>	kvs = hs.kvs[:0]
<span id="L179" class="ln">   179&nbsp;&nbsp;</span>	for k, vv := range h {
<span id="L180" class="ln">   180&nbsp;&nbsp;</span>		if !exclude[k] {
<span id="L181" class="ln">   181&nbsp;&nbsp;</span>			kvs = append(kvs, keyValues{k, vv})
<span id="L182" class="ln">   182&nbsp;&nbsp;</span>		}
<span id="L183" class="ln">   183&nbsp;&nbsp;</span>	}
<span id="L184" class="ln">   184&nbsp;&nbsp;</span>	hs.kvs = kvs
<span id="L185" class="ln">   185&nbsp;&nbsp;</span>	sort.Sort(hs)
<span id="L186" class="ln">   186&nbsp;&nbsp;</span>	return kvs, hs
<span id="L187" class="ln">   187&nbsp;&nbsp;</span>}
<span id="L188" class="ln">   188&nbsp;&nbsp;</span>
<span id="L189" class="ln">   189&nbsp;&nbsp;</span><span class="comment">// WriteSubset writes a header in wire format.</span>
<span id="L190" class="ln">   190&nbsp;&nbsp;</span><span class="comment">// If exclude is not nil, keys where exclude[key] == true are not written.</span>
<span id="L191" class="ln">   191&nbsp;&nbsp;</span><span class="comment">// Keys are not canonicalized before checking the exclude map.</span>
<span id="L192" class="ln">   192&nbsp;&nbsp;</span>func (h Header) WriteSubset(w io.Writer, exclude map[string]bool) error {
<span id="L193" class="ln">   193&nbsp;&nbsp;</span>	return h.writeSubset(w, exclude, nil)
<span id="L194" class="ln">   194&nbsp;&nbsp;</span>}
<span id="L195" class="ln">   195&nbsp;&nbsp;</span>
<span id="L196" class="ln">   196&nbsp;&nbsp;</span>func (h Header) writeSubset(w io.Writer, exclude map[string]bool, trace *httptrace.ClientTrace) error {
<span id="L197" class="ln">   197&nbsp;&nbsp;</span>	ws, ok := w.(io.StringWriter)
<span id="L198" class="ln">   198&nbsp;&nbsp;</span>	if !ok {
<span id="L199" class="ln">   199&nbsp;&nbsp;</span>		ws = stringWriter{w}
<span id="L200" class="ln">   200&nbsp;&nbsp;</span>	}
<span id="L201" class="ln">   201&nbsp;&nbsp;</span>	kvs, sorter := h.sortedKeyValues(exclude)
<span id="L202" class="ln">   202&nbsp;&nbsp;</span>	var formattedVals []string
<span id="L203" class="ln">   203&nbsp;&nbsp;</span>	for _, kv := range kvs {
<span id="L204" class="ln">   204&nbsp;&nbsp;</span>		if !httpguts.ValidHeaderFieldName(kv.key) {
<span id="L205" class="ln">   205&nbsp;&nbsp;</span>			<span class="comment">// This could be an error. In the common case of</span>
<span id="L206" class="ln">   206&nbsp;&nbsp;</span>			<span class="comment">// writing response headers, however, we have no good</span>
<span id="L207" class="ln">   207&nbsp;&nbsp;</span>			<span class="comment">// way to provide the error back to the server</span>
<span id="L208" class="ln">   208&nbsp;&nbsp;</span>			<span class="comment">// handler, so just drop invalid headers instead.</span>
<span id="L209" class="ln">   209&nbsp;&nbsp;</span>			continue
<span id="L210" class="ln">   210&nbsp;&nbsp;</span>		}
<span id="L211" class="ln">   211&nbsp;&nbsp;</span>		for _, v := range kv.values {
<span id="L212" class="ln">   212&nbsp;&nbsp;</span>			v = headerNewlineToSpace.Replace(v)
<span id="L213" class="ln">   213&nbsp;&nbsp;</span>			v = textproto.TrimString(v)
<span id="L214" class="ln">   214&nbsp;&nbsp;</span>			for _, s := range []string{kv.key, &#34;: &#34;, v, &#34;\r\n&#34;} {
<span id="L215" class="ln">   215&nbsp;&nbsp;</span>				if _, err := ws.WriteString(s); err != nil {
<span id="L216" class="ln">   216&nbsp;&nbsp;</span>					headerSorterPool.Put(sorter)
<span id="L217" class="ln">   217&nbsp;&nbsp;</span>					return err
<span id="L218" class="ln">   218&nbsp;&nbsp;</span>				}
<span id="L219" class="ln">   219&nbsp;&nbsp;</span>			}
<span id="L220" class="ln">   220&nbsp;&nbsp;</span>			if trace != nil &amp;&amp; trace.WroteHeaderField != nil {
<span id="L221" class="ln">   221&nbsp;&nbsp;</span>				formattedVals = append(formattedVals, v)
<span id="L222" class="ln">   222&nbsp;&nbsp;</span>			}
<span id="L223" class="ln">   223&nbsp;&nbsp;</span>		}
<span id="L224" class="ln">   224&nbsp;&nbsp;</span>		if trace != nil &amp;&amp; trace.WroteHeaderField != nil {
<span id="L225" class="ln">   225&nbsp;&nbsp;</span>			trace.WroteHeaderField(kv.key, formattedVals)
<span id="L226" class="ln">   226&nbsp;&nbsp;</span>			formattedVals = nil
<span id="L227" class="ln">   227&nbsp;&nbsp;</span>		}
<span id="L228" class="ln">   228&nbsp;&nbsp;</span>	}
<span id="L229" class="ln">   229&nbsp;&nbsp;</span>	headerSorterPool.Put(sorter)
<span id="L230" class="ln">   230&nbsp;&nbsp;</span>	return nil
<span id="L231" class="ln">   231&nbsp;&nbsp;</span>}
<span id="L232" class="ln">   232&nbsp;&nbsp;</span>
<span id="L233" class="ln">   233&nbsp;&nbsp;</span><span class="comment">// CanonicalHeaderKey returns the canonical format of the</span>
<span id="L234" class="ln">   234&nbsp;&nbsp;</span><span class="comment">// header key s. The canonicalization converts the first</span>
<span id="L235" class="ln">   235&nbsp;&nbsp;</span><span class="comment">// letter and any letter following a hyphen to upper case;</span>
<span id="L236" class="ln">   236&nbsp;&nbsp;</span><span class="comment">// the rest are converted to lowercase. For example, the</span>
<span id="L237" class="ln">   237&nbsp;&nbsp;</span><span class="comment">// canonical key for &#34;accept-encoding&#34; is &#34;Accept-Encoding&#34;.</span>
<span id="L238" class="ln">   238&nbsp;&nbsp;</span><span class="comment">// If s contains a space or invalid header field bytes, it is</span>
<span id="L239" class="ln">   239&nbsp;&nbsp;</span><span class="comment">// returned without modifications.</span>
<span id="L240" class="ln">   240&nbsp;&nbsp;</span>func CanonicalHeaderKey(s string) string { return textproto.CanonicalMIMEHeaderKey(s) }
<span id="L241" class="ln">   241&nbsp;&nbsp;</span>
<span id="L242" class="ln">   242&nbsp;&nbsp;</span><span class="comment">// hasToken reports whether token appears with v, ASCII</span>
<span id="L243" class="ln">   243&nbsp;&nbsp;</span><span class="comment">// case-insensitive, with space or comma boundaries.</span>
<span id="L244" class="ln">   244&nbsp;&nbsp;</span><span class="comment">// token must be all lowercase.</span>
<span id="L245" class="ln">   245&nbsp;&nbsp;</span><span class="comment">// v may contain mixed cased.</span>
<span id="L246" class="ln">   246&nbsp;&nbsp;</span>func hasToken(v, token string) bool {
<span id="L247" class="ln">   247&nbsp;&nbsp;</span>	if len(token) &gt; len(v) || token == &#34;&#34; {
<span id="L248" class="ln">   248&nbsp;&nbsp;</span>		return false
<span id="L249" class="ln">   249&nbsp;&nbsp;</span>	}
<span id="L250" class="ln">   250&nbsp;&nbsp;</span>	if v == token {
<span id="L251" class="ln">   251&nbsp;&nbsp;</span>		return true
<span id="L252" class="ln">   252&nbsp;&nbsp;</span>	}
<span id="L253" class="ln">   253&nbsp;&nbsp;</span>	for sp := 0; sp &lt;= len(v)-len(token); sp++ {
<span id="L254" class="ln">   254&nbsp;&nbsp;</span>		<span class="comment">// Check that first character is good.</span>
<span id="L255" class="ln">   255&nbsp;&nbsp;</span>		<span class="comment">// The token is ASCII, so checking only a single byte</span>
<span id="L256" class="ln">   256&nbsp;&nbsp;</span>		<span class="comment">// is sufficient. We skip this potential starting</span>
<span id="L257" class="ln">   257&nbsp;&nbsp;</span>		<span class="comment">// position if both the first byte and its potential</span>
<span id="L258" class="ln">   258&nbsp;&nbsp;</span>		<span class="comment">// ASCII uppercase equivalent (b|0x20) don&#39;t match.</span>
<span id="L259" class="ln">   259&nbsp;&nbsp;</span>		<span class="comment">// False positives (&#39;^&#39; =&gt; &#39;~&#39;) are caught by EqualFold.</span>
<span id="L260" class="ln">   260&nbsp;&nbsp;</span>		if b := v[sp]; b != token[0] &amp;&amp; b|0x20 != token[0] {
<span id="L261" class="ln">   261&nbsp;&nbsp;</span>			continue
<span id="L262" class="ln">   262&nbsp;&nbsp;</span>		}
<span id="L263" class="ln">   263&nbsp;&nbsp;</span>		<span class="comment">// Check that start pos is on a valid token boundary.</span>
<span id="L264" class="ln">   264&nbsp;&nbsp;</span>		if sp &gt; 0 &amp;&amp; !isTokenBoundary(v[sp-1]) {
<span id="L265" class="ln">   265&nbsp;&nbsp;</span>			continue
<span id="L266" class="ln">   266&nbsp;&nbsp;</span>		}
<span id="L267" class="ln">   267&nbsp;&nbsp;</span>		<span class="comment">// Check that end pos is on a valid token boundary.</span>
<span id="L268" class="ln">   268&nbsp;&nbsp;</span>		if endPos := sp + len(token); endPos != len(v) &amp;&amp; !isTokenBoundary(v[endPos]) {
<span id="L269" class="ln">   269&nbsp;&nbsp;</span>			continue
<span id="L270" class="ln">   270&nbsp;&nbsp;</span>		}
<span id="L271" class="ln">   271&nbsp;&nbsp;</span>		if ascii.EqualFold(v[sp:sp+len(token)], token) {
<span id="L272" class="ln">   272&nbsp;&nbsp;</span>			return true
<span id="L273" class="ln">   273&nbsp;&nbsp;</span>		}
<span id="L274" class="ln">   274&nbsp;&nbsp;</span>	}
<span id="L275" class="ln">   275&nbsp;&nbsp;</span>	return false
<span id="L276" class="ln">   276&nbsp;&nbsp;</span>}
<span id="L277" class="ln">   277&nbsp;&nbsp;</span>
<span id="L278" class="ln">   278&nbsp;&nbsp;</span>func isTokenBoundary(b byte) bool {
<span id="L279" class="ln">   279&nbsp;&nbsp;</span>	return b == &#39; &#39; || b == &#39;,&#39; || b == &#39;\t&#39;
<span id="L280" class="ln">   280&nbsp;&nbsp;</span>}
<span id="L281" class="ln">   281&nbsp;&nbsp;</span>
</pre><p><a href="header.go?m=text">View as plain text</a></p>
