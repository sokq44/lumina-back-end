...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/net/http/httputil/persist.go - Go Documentation Server</title>
...
<a href="persist.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<a href="http://localhost:8080/src/net/http">http</a>/<a href="http://localhost:8080/src/net/http/httputil">httputil</a>/<span class="text-muted">persist.go</span>
  </h1>
...
<span id="L64" class="ln">    64&nbsp;&nbsp;</span><span class="comment">// should not call Hijack while [ServerConn.Read] or [ServerConn.Write] is in progress.</span>
...
<span id="L75" class="ln">    75&nbsp;&nbsp;</span><span class="comment">// Close calls [ServerConn.Hijack] and then also closes the underlying connection.</span>
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>func (sc *ServerConn) Close() error {
...
<span id="L174" class="ln">   174&nbsp;&nbsp;</span><span class="comment">// it returns an error, regardless of any errors returned on the [ServerConn.Read] side.</span>
...
<span id="L274" class="ln">   274&nbsp;&nbsp;</span><span class="comment">// logic. The user should not call Hijack while [ClientConn.Read] or ClientConn.Write is in progress.</span>
...
<span id="L285" class="ln">   285&nbsp;&nbsp;</span><span class="comment">// Close calls [ClientConn.Hijack] and then also closes the underlying connection.</span>
...
<span id="L295" class="ln">   295&nbsp;&nbsp;</span><span class="comment">// has been closed in an HTTP keep-alive sense. If req.Close equals true, the</span>
<span id="L296" class="ln">   296&nbsp;&nbsp;</span><span class="comment">// keep-alive connection is logically closed after this request and the opposing</span>
...
<span id="L362" class="ln">   362&nbsp;&nbsp;</span><span class="comment">// concurrently with [ClientConn.Write], but not with another Read.</span>
...
</pre><p><a href="persist.go?m=text">View as plain text</a></p>
