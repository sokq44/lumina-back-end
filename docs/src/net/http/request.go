...
<a href="request.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L1005" class="ln">  1005&nbsp;&nbsp;</span>func (r *Request) SetBasicAuth(username, password string) {
