...
<a href="routing_index.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<a href="http://localhost:8080/src/net/http">http</a>/<span class="text-muted">routing_index.go</span>
  </h1>
...
</pre><p><a href="routing_index.go?m=text">View as plain text</a></p>
