...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/net/iprawsock_posix.go - Go Documentation Server</title>
...
<a href="iprawsock_posix.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<span class="text-muted">iprawsock_posix.go</span>
  </h1>
...
<span id="L19" class="ln">    19&nbsp;&nbsp;</span>		return &amp;IPAddr{IP: sa.Addr[0:], Zone: zoneCache.name(int(sa.ZoneId))}
...
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>		addr = &amp;IPAddr{IP: sa.Addr[0:], Zone: zoneCache.name(int(sa.ZoneId))}
...
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>	n, oobn, flags, sa, err = c.fd.readMsg(b, oob, 0)
...
<span id="L82" class="ln">    82&nbsp;&nbsp;</span>		addr = &amp;IPAddr{IP: sa.Addr[0:], Zone: zoneCache.name(int(sa.ZoneId))}
...
<span id="L115" class="ln">   115&nbsp;&nbsp;</span>func (sd *sysDialer) dialIP(ctx context.Context, laddr, raddr *IPAddr) (*IPConn, error) {
<span id="L116" class="ln">   116&nbsp;&nbsp;</span>	network, proto, err := parseNetwork(ctx, sd.network, true)
...
<span id="L123" class="ln">   123&nbsp;&nbsp;</span>		return nil, UnknownNetworkError(sd.network)
<span id="L124" class="ln">   124&nbsp;&nbsp;</span>	}
<span id="L125" class="ln">   125&nbsp;&nbsp;</span>	ctrlCtxFn := sd.Dialer.ControlContext
<span id="L126" class="ln">   126&nbsp;&nbsp;</span>	if ctrlCtxFn == nil &amp;&amp; sd.Dialer.Control != nil {
<span id="L127" class="ln">   127&nbsp;&nbsp;</span>		ctrlCtxFn = func(cxt context.Context, network, address string, c syscall.RawConn) error {
<span id="L128" class="ln">   128&nbsp;&nbsp;</span>			return sd.Dialer.Control(network, address, c)
<span id="L129" class="ln">   129&nbsp;&nbsp;</span>		}
<span id="L130" class="ln">   130&nbsp;&nbsp;</span>	}
<span id="L131" class="ln">   131&nbsp;&nbsp;</span>	fd, err := internetSocket(ctx, network, laddr, raddr, syscall.SOCK_RAW, proto, &#34;dial&#34;, ctrlCtxFn)
<span id="L132" class="ln">   132&nbsp;&nbsp;</span>	if err != nil {
<span id="L133" class="ln">   133&nbsp;&nbsp;</span>		return nil, err
<span id="L134" class="ln">   134&nbsp;&nbsp;</span>	}
<span id="L135" class="ln">   135&nbsp;&nbsp;</span>	return newIPConn(fd), nil
<span id="L136" class="ln">   136&nbsp;&nbsp;</span>}
<span id="L137" class="ln">   137&nbsp;&nbsp;</span>
<span id="L138" class="ln">   138&nbsp;&nbsp;</span>func (sl *sysListener) listenIP(ctx context.Context, laddr *IPAddr) (*IPConn, error) {
<span id="L139" class="ln">   139&nbsp;&nbsp;</span>	network, proto, err := parseNetwork(ctx, sl.network, true)
<span id="L140" class="ln">   140&nbsp;&nbsp;</span>	if err != nil {
<span id="L141" class="ln">   141&nbsp;&nbsp;</span>		return nil, err
<span id="L142" class="ln">   142&nbsp;&nbsp;</span>	}
<span id="L143" class="ln">   143&nbsp;&nbsp;</span>	switch network {
<span id="L144" class="ln">   144&nbsp;&nbsp;</span>	case &#34;ip&#34;, &#34;ip4&#34;, &#34;ip6&#34;:
<span id="L145" class="ln">   145&nbsp;&nbsp;</span>	default:
<span id="L146" class="ln">   146&nbsp;&nbsp;</span>		return nil, UnknownNetworkError(sl.network)
<span id="L147" class="ln">   147&nbsp;&nbsp;</span>	}
<span id="L148" class="ln">   148&nbsp;&nbsp;</span>	var ctrlCtxFn func(cxt context.Context, network, address string, c syscall.RawConn) error
<span id="L149" class="ln">   149&nbsp;&nbsp;</span>	if sl.ListenConfig.Control != nil {
<span id="L150" class="ln">   150&nbsp;&nbsp;</span>		ctrlCtxFn = func(cxt context.Context, network, address string, c syscall.RawConn) error {
<span id="L151" class="ln">   151&nbsp;&nbsp;</span>			return sl.ListenConfig.Control(network, address, c)
<span id="L152" class="ln">   152&nbsp;&nbsp;</span>		}
<span id="L153" class="ln">   153&nbsp;&nbsp;</span>	}
<span id="L154" class="ln">   154&nbsp;&nbsp;</span>	fd, err := internetSocket(ctx, network, laddr, nil, syscall.SOCK_RAW, proto, &#34;listen&#34;, ctrlCtxFn)
<span id="L155" class="ln">   155&nbsp;&nbsp;</span>	if err != nil {
<span id="L156" class="ln">   156&nbsp;&nbsp;</span>		return nil, err
<span id="L157" class="ln">   157&nbsp;&nbsp;</span>	}
<span id="L158" class="ln">   158&nbsp;&nbsp;</span>	return newIPConn(fd), nil
<span id="L159" class="ln">   159&nbsp;&nbsp;</span>}
<span id="L160" class="ln">   160&nbsp;&nbsp;</span>
</pre><p><a href="iprawsock_posix.go?m=text">View as plain text</a></p>
