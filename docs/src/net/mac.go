...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/net/mac.go - Go Documentation Server</title>
...
<a href="mac.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<span class="text-muted">mac.go</span>
  </h1>
...
<span id="L12" class="ln">    12&nbsp;&nbsp;</span>func (a HardwareAddr) String() string {
...
<span id="L30" class="ln">    30&nbsp;&nbsp;</span><span class="comment">//	00:00:5e:00:53:01</span>
<span id="L31" class="ln">    31&nbsp;&nbsp;</span><span class="comment">//	02:00:5e:10:00:00:00:01</span>
<span id="L32" class="ln">    32&nbsp;&nbsp;</span><span class="comment">//	00:00:00:00:fe:80:00:00:00:00:00:00:02:00:5e:10:00:00:00:01</span>
<span id="L33" class="ln">    33&nbsp;&nbsp;</span><span class="comment">//	00-00-5e-00-53-01</span>
<span id="L34" class="ln">    34&nbsp;&nbsp;</span><span class="comment">//	02-00-5e-10-00-00-00-01</span>
<span id="L35" class="ln">    35&nbsp;&nbsp;</span><span class="comment">//	00-00-00-00-fe-80-00-00-00-00-00-00-02-00-5e-10-00-00-00-01</span>
<span id="L36" class="ln">    36&nbsp;&nbsp;</span><span class="comment">//	0000.5e00.5301</span>
<span id="L37" class="ln">    37&nbsp;&nbsp;</span><span class="comment">//	0200.5e10.0000.0001</span>
<span id="L38" class="ln">    38&nbsp;&nbsp;</span><span class="comment">//	0000.0000.fe80.0000.0000.0000.0200.5e10.0000.0001</span>
...
<span id="L49" class="ln">    49&nbsp;&nbsp;</span>		if n != 6 &amp;&amp; n != 8 &amp;&amp; n != 20 {
...
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>		if n != 6 &amp;&amp; n != 8 &amp;&amp; n != 20 {
...
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>	return nil, &amp;AddrError{Err: &#34;invalid MAC address&#34;, Addr: s}
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>}
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>
</pre><p><a href="mac.go?m=text">View as plain text</a></p>
