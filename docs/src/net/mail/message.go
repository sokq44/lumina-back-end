...
<a href="message.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L261" class="ln">   261&nbsp;&nbsp;</span>func (p *AddressParser) ParseList(list string) ([]*Address, error) {
