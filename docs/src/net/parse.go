...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/net/parse.go - Go Documentation Server</title>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<span class="text-muted">parse.go</span>
  </h1>
...
<span id="L254" class="ln">   254&nbsp;&nbsp;</span><span class="comment">// stringsHasSuffix is strings.HasSuffix. It reports whether s ends in</span>
<span id="L255" class="ln">   255&nbsp;&nbsp;</span><span class="comment">// suffix.</span>
<span id="L256" class="ln">   256&nbsp;&nbsp;</span>func stringsHasSuffix(s, suffix string) bool {
<span id="L257" class="ln">   257&nbsp;&nbsp;</span>	return len(s) &gt;= len(suffix) &amp;&amp; s[len(s)-len(suffix):] == suffix
<span id="L258" class="ln">   258&nbsp;&nbsp;</span>}
<span id="L259" class="ln">   259&nbsp;&nbsp;</span>
<span id="L260" class="ln">   260&nbsp;&nbsp;</span><span class="comment">// stringsHasSuffixFold reports whether s ends in suffix,</span>
<span id="L261" class="ln">   261&nbsp;&nbsp;</span><span class="comment">// ASCII-case-insensitively.</span>
<span id="L262" class="ln">   262&nbsp;&nbsp;</span>func stringsHasSuffixFold(s, suffix string) bool {
<span id="L263" class="ln">   263&nbsp;&nbsp;</span>	return len(s) &gt;= len(suffix) &amp;&amp; stringsEqualFold(s[len(s)-len(suffix):], suffix)
<span id="L264" class="ln">   264&nbsp;&nbsp;</span>}
<span id="L265" class="ln">   265&nbsp;&nbsp;</span>
<span id="L266" class="ln">   266&nbsp;&nbsp;</span><span class="comment">// stringsHasPrefix is strings.HasPrefix. It reports whether s begins with prefix.</span>
<span id="L267" class="ln">   267&nbsp;&nbsp;</span>func stringsHasPrefix(s, prefix string) bool {
<span id="L268" class="ln">   268&nbsp;&nbsp;</span>	return len(s) &gt;= len(prefix) &amp;&amp; s[:len(prefix)] == prefix
<span id="L269" class="ln">   269&nbsp;&nbsp;</span>}
<span id="L270" class="ln">   270&nbsp;&nbsp;</span>
<span id="L271" class="ln">   271&nbsp;&nbsp;</span><span class="comment">// stringsEqualFold is strings.EqualFold, ASCII only. It reports whether s and t</span>
<span id="L272" class="ln">   272&nbsp;&nbsp;</span><span class="comment">// are equal, ASCII-case-insensitively.</span>
<span id="L273" class="ln">   273&nbsp;&nbsp;</span>func stringsEqualFold(s, t string) bool {
<span id="L274" class="ln">   274&nbsp;&nbsp;</span>	if len(s) != len(t) {
<span id="L275" class="ln">   275&nbsp;&nbsp;</span>		return false
<span id="L276" class="ln">   276&nbsp;&nbsp;</span>	}
<span id="L277" class="ln">   277&nbsp;&nbsp;</span>	for i := 0; i &lt; len(s); i++ {
<span id="L278" class="ln">   278&nbsp;&nbsp;</span>		if lowerASCII(s[i]) != lowerASCII(t[i]) {
