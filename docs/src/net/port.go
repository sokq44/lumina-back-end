...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/net/port.go - Go Documentation Server</title>
...
<a href="port.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<span class="text-muted">port.go</span>
  </h1>
...
<span id="L7" class="ln">     7&nbsp;&nbsp;</span><span class="comment">// parsePort parses service as a decimal integer and returns the</span>
...
<span id="L12" class="ln">    12&nbsp;&nbsp;</span><span class="comment">// over 65536 (see https://golang.org/issues/11715). Alas, the parser</span>
...
</pre><p><a href="port.go?m=text">View as plain text</a></p>
