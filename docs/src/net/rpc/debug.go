...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/net/rpc/debug.go - Go Documentation Server</title>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<a href="http://localhost:8080/src/net/rpc">rpc</a>/<span class="text-muted">debug.go</span>
  </h1>
...
<span id="L14" class="ln">    14&nbsp;&nbsp;</span>	&#34;html/template&#34;
...
<span id="L74" class="ln">    74&nbsp;&nbsp;</span>	var services serviceArray
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	server.serviceMap.Range(func(snamei, svci any) bool {
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>		svc := svci.(*service)
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>		ds := debugService{svc, snamei.(string), make(methodArray, 0, len(svc.method))}
<span id="L78" class="ln">    78&nbsp;&nbsp;</span>		for mname, method := range svc.method {
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>			ds.Method = append(ds.Method, debugMethod{method, mname})
<span id="L80" class="ln">    80&nbsp;&nbsp;</span>		}
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>		sort.Sort(ds.Method)
<span id="L82" class="ln">    82&nbsp;&nbsp;</span>		services = append(services, ds)
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>		return true
<span id="L84" class="ln">    84&nbsp;&nbsp;</span>	})
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>	sort.Sort(services)
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>	err := debug.Execute(w, services)
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>	if err != nil {
<span id="L88" class="ln">    88&nbsp;&nbsp;</span>		fmt.Fprintln(w, &#34;rpc: error executing template:&#34;, err.Error())
