...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<a href="http://localhost:8080/src/net/textproto">textproto</a>/<span class="text-muted">header.go</span>
  </h1>
...
<span id="L13" class="ln">    13&nbsp;&nbsp;</span>func (h MIMEHeader) Add(key, value string) {
