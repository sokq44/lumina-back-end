...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/net/textproto/pipeline.go - Go Documentation Server</title>
...
<a href="pipeline.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<a href="http://localhost:8080/src/net/textproto">textproto</a>/<span class="text-muted">pipeline.go</span>
  </h1>
...
<span id="L36" class="ln">    36&nbsp;&nbsp;</span>func (p *Pipeline) Next() uint {
...
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	wait map[uint]chan struct{}
...
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>	c := make(chan struct{})
<span id="L88" class="ln">    88&nbsp;&nbsp;</span>	if s.wait == nil {
<span id="L89" class="ln">    89&nbsp;&nbsp;</span>		s.wait = make(map[uint]chan struct{})
...
<span id="L102" class="ln">   102&nbsp;&nbsp;</span>		s.mu.Unlock()
<span id="L103" class="ln">   103&nbsp;&nbsp;</span>		panic(&#34;out of sync&#34;)
<span id="L104" class="ln">   104&nbsp;&nbsp;</span>	}
<span id="L105" class="ln">   105&nbsp;&nbsp;</span>	id++
<span id="L106" class="ln">   106&nbsp;&nbsp;</span>	s.id = id
<span id="L107" class="ln">   107&nbsp;&nbsp;</span>	if s.wait == nil {
<span id="L108" class="ln">   108&nbsp;&nbsp;</span>		s.wait = make(map[uint]chan struct{})
<span id="L109" class="ln">   109&nbsp;&nbsp;</span>	}
<span id="L110" class="ln">   110&nbsp;&nbsp;</span>	c, ok := s.wait[id]
<span id="L111" class="ln">   111&nbsp;&nbsp;</span>	if ok {
<span id="L112" class="ln">   112&nbsp;&nbsp;</span>		delete(s.wait, id)
<span id="L113" class="ln">   113&nbsp;&nbsp;</span>	}
<span id="L114" class="ln">   114&nbsp;&nbsp;</span>	s.mu.Unlock()
<span id="L115" class="ln">   115&nbsp;&nbsp;</span>	if ok {
<span id="L116" class="ln">   116&nbsp;&nbsp;</span>		close(c)
<span id="L117" class="ln">   117&nbsp;&nbsp;</span>	}
<span id="L118" class="ln">   118&nbsp;&nbsp;</span>}
<span id="L119" class="ln">   119&nbsp;&nbsp;</span>
</pre><p><a href="pipeline.go?m=text">View as plain text</a></p>
