...
<span id="L25" class="ln">    25&nbsp;&nbsp;</span>type Reader struct {
<span id="L26" class="ln">    26&nbsp;&nbsp;</span>	R   *bufio.Reader
<span id="L27" class="ln">    27&nbsp;&nbsp;</span>	dot *dotReader
<span id="L28" class="ln">    28&nbsp;&nbsp;</span>	buf []byte <span class="comment">// a re-usable buffer for readContinuedLineSlice</span>
