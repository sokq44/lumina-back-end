...
<a href="textproto.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<a href="http://localhost:8080/src/net/textproto">textproto</a>/<span class="text-muted">textproto.go</span>
  </h1>
...
<span id="L135" class="ln">   135&nbsp;&nbsp;</span>func TrimBytes(b []byte) []byte {
...
</pre><p><a href="textproto.go?m=text">View as plain text</a></p>
