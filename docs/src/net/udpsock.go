...
<a href="udpsock.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/net">net</a>/<span class="text-muted">udpsock.go</span>
  </h1>
...
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>func ResolveUDPAddr(network, address string) (*UDPAddr, error) {
...
</pre><p><a href="udpsock.go?m=text">View as plain text</a></p>
