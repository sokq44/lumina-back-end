...
<a href="env.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/os">os</a>/<span class="text-muted">env.go</span>
  </h1>
...
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>func ExpandEnv(s string) string {
...
</pre><p><a href="env.go?m=text">View as plain text</a></p>
