...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/os">os</a>/<span class="text-muted">error.go</span>
  </h1>
...
<span id="L74" class="ln">    74&nbsp;&nbsp;</span><span class="comment">// IsExist returns a boolean indicating whether the error is known to report</span>
...
<span id="L84" class="ln">    84&nbsp;&nbsp;</span><span class="comment">// IsNotExist returns a boolean indicating whether the error is known to</span>
...
<span id="L94" class="ln">    94&nbsp;&nbsp;</span><span class="comment">// IsPermission returns a boolean indicating whether the error is known to</span>
...
<span id="L104" class="ln">   104&nbsp;&nbsp;</span><span class="comment">// IsTimeout returns a boolean indicating whether the error is known</span>
...
<span id="L112" class="ln">   112&nbsp;&nbsp;</span>func IsTimeout(err error) bool {
