...
<a href="exec.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L21" class="ln">    21&nbsp;&nbsp;</span>type Process struct {
<span id="L22" class="ln">    22&nbsp;&nbsp;</span>	Pid    int
<span id="L23" class="ln">    23&nbsp;&nbsp;</span>	handle uintptr      <span class="comment">// handle is accessed atomically on Windows</span>
<span id="L24" class="ln">    24&nbsp;&nbsp;</span>	isdone atomic.Bool  <span class="comment">// process has been successfully waited on</span>
<span id="L25" class="ln">    25&nbsp;&nbsp;</span>	sigMu  sync.RWMutex <span class="comment">// avoid race between wait and signal</span>
