...
<a href="file_posix.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/os">os</a>/<span class="text-muted">file_posix.go</span>
  </h1>
...
<span id="L16" class="ln">    16&nbsp;&nbsp;</span><span class="comment">// On files that support SetDeadline, any pending I/O operations will</span>
...
<span id="L199" class="ln">   199&nbsp;&nbsp;</span>func (f *File) Chdir() error {
...
</pre><p><a href="file_posix.go?m=text">View as plain text</a></p>
