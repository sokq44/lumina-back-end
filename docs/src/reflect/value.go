...
<span id="L3071" class="ln">  3071&nbsp;&nbsp;</span>type SelectCase struct {
<span id="L3072" class="ln">  3072&nbsp;&nbsp;</span>	Dir  SelectDir <span class="comment">// direction of case</span>
<span id="L3073" class="ln">  3073&nbsp;&nbsp;</span>	Chan Value     <span class="comment">// channel to use (for send or receive)</span>
<span id="L3074" class="ln">  3074&nbsp;&nbsp;</span>	Send Value     <span class="comment">// value to send (for send)</span>
<span id="L3075" class="ln">  3075&nbsp;&nbsp;</span>}
