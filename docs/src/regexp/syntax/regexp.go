...
<a href="regexp.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L17" class="ln">    17&nbsp;&nbsp;</span>type Regexp struct {
<span id="L18" class="ln">    18&nbsp;&nbsp;</span>	Op       Op <span class="comment">// operator</span>
<span id="L19" class="ln">    19&nbsp;&nbsp;</span>	Flags    Flags
<span id="L20" class="ln">    20&nbsp;&nbsp;</span>	Sub      []*Regexp  <span class="comment">// subexpressions, if any</span>
<span id="L21" class="ln">    21&nbsp;&nbsp;</span>	Sub0     [1]*Regexp <span class="comment">// storage for short Sub</span>
<span id="L22" class="ln">    22&nbsp;&nbsp;</span>	Rune     []rune     <span class="comment">// matched runes, for OpLiteral, OpCharClass</span>
<span id="L23" class="ln">    23&nbsp;&nbsp;</span>	Rune0    [2]rune    <span class="comment">// storage for short Rune</span>
<span id="L24" class="ln">    24&nbsp;&nbsp;</span>	Min, Max int        <span class="comment">// min, max for OpRepeat</span>
<span id="L25" class="ln">    25&nbsp;&nbsp;</span>	Cap      int        <span class="comment">// capturing index, for OpCapture</span>
<span id="L26" class="ln">    26&nbsp;&nbsp;</span>	Name     string     <span class="comment">// capturing name, for OpCapture</span>
