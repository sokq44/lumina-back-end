...
<a href="extern.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L295" class="ln">   295&nbsp;&nbsp;</span>func Caller(skip int) (pc uintptr, file string, line int, ok bool) {
