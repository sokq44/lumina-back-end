...
<a href="mstats.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>type MemStats struct {
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>	<span class="comment">// General statistics.</span>
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>
<span id="L55" class="ln">    55&nbsp;&nbsp;</span>	<span class="comment">// Alloc is bytes of allocated heap objects.</span>
<span id="L56" class="ln">    56&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L57" class="ln">    57&nbsp;&nbsp;</span>	<span class="comment">// This is the same as HeapAlloc (see below).</span>
<span id="L58" class="ln">    58&nbsp;&nbsp;</span>	Alloc uint64
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>
<span id="L60" class="ln">    60&nbsp;&nbsp;</span>	<span class="comment">// TotalAlloc is cumulative bytes allocated for heap objects.</span>
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L62" class="ln">    62&nbsp;&nbsp;</span>	<span class="comment">// TotalAlloc increases as heap objects are allocated, but</span>
<span id="L63" class="ln">    63&nbsp;&nbsp;</span>	<span class="comment">// unlike Alloc and HeapAlloc, it does not decrease when</span>
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>	<span class="comment">// objects are freed.</span>
<span id="L65" class="ln">    65&nbsp;&nbsp;</span>	TotalAlloc uint64
<span id="L66" class="ln">    66&nbsp;&nbsp;</span>
<span id="L67" class="ln">    67&nbsp;&nbsp;</span>	<span class="comment">// Sys is the total bytes of memory obtained from the OS.</span>
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L69" class="ln">    69&nbsp;&nbsp;</span>	<span class="comment">// Sys is the sum of the XSys fields below. Sys measures the</span>
<span id="L70" class="ln">    70&nbsp;&nbsp;</span>	<span class="comment">// virtual address space reserved by the Go runtime for the</span>
<span id="L71" class="ln">    71&nbsp;&nbsp;</span>	<span class="comment">// heap, stacks, and other internal data structures. It&#39;s</span>
<span id="L72" class="ln">    72&nbsp;&nbsp;</span>	<span class="comment">// likely that not all of the virtual address space is backed</span>
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>	<span class="comment">// by physical memory at any given moment, though in general</span>
<span id="L74" class="ln">    74&nbsp;&nbsp;</span>	<span class="comment">// it all was at some point.</span>
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	Sys uint64
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>	<span class="comment">// Lookups is the number of pointer lookups performed by the</span>
<span id="L78" class="ln">    78&nbsp;&nbsp;</span>	<span class="comment">// runtime.</span>
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L80" class="ln">    80&nbsp;&nbsp;</span>	<span class="comment">// This is primarily useful for debugging runtime internals.</span>
<span id="L81" class="ln">    81&nbsp;&nbsp;</span>	Lookups uint64
<span id="L82" class="ln">    82&nbsp;&nbsp;</span>
<span id="L83" class="ln">    83&nbsp;&nbsp;</span>	<span class="comment">// Mallocs is the cumulative count of heap objects allocated.</span>
<span id="L84" class="ln">    84&nbsp;&nbsp;</span>	<span class="comment">// The number of live objects is Mallocs - Frees.</span>
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>	Mallocs uint64
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>	<span class="comment">// Frees is the cumulative count of heap objects freed.</span>
<span id="L88" class="ln">    88&nbsp;&nbsp;</span>	Frees uint64
<span id="L89" class="ln">    89&nbsp;&nbsp;</span>
<span id="L90" class="ln">    90&nbsp;&nbsp;</span>	<span class="comment">// Heap memory statistics.</span>
<span id="L91" class="ln">    91&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L92" class="ln">    92&nbsp;&nbsp;</span>	<span class="comment">// Interpreting the heap statistics requires some knowledge of</span>
<span id="L93" class="ln">    93&nbsp;&nbsp;</span>	<span class="comment">// how Go organizes memory. Go divides the virtual address</span>
<span id="L94" class="ln">    94&nbsp;&nbsp;</span>	<span class="comment">// space of the heap into &#34;spans&#34;, which are contiguous</span>
<span id="L95" class="ln">    95&nbsp;&nbsp;</span>	<span class="comment">// regions of memory 8K or larger. A span may be in one of</span>
<span id="L96" class="ln">    96&nbsp;&nbsp;</span>	<span class="comment">// three states:</span>
<span id="L97" class="ln">    97&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L98" class="ln">    98&nbsp;&nbsp;</span>	<span class="comment">// An &#34;idle&#34; span contains no objects or other data. The</span>
<span id="L99" class="ln">    99&nbsp;&nbsp;</span>	<span class="comment">// physical memory backing an idle span can be released back</span>
<span id="L100" class="ln">   100&nbsp;&nbsp;</span>	<span class="comment">// to the OS (but the virtual address space never is), or it</span>
<span id="L101" class="ln">   101&nbsp;&nbsp;</span>	<span class="comment">// can be converted into an &#34;in use&#34; or &#34;stack&#34; span.</span>
<span id="L102" class="ln">   102&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L103" class="ln">   103&nbsp;&nbsp;</span>	<span class="comment">// An &#34;in use&#34; span contains at least one heap object and may</span>
<span id="L104" class="ln">   104&nbsp;&nbsp;</span>	<span class="comment">// have free space available to allocate more heap objects.</span>
<span id="L105" class="ln">   105&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L106" class="ln">   106&nbsp;&nbsp;</span>	<span class="comment">// A &#34;stack&#34; span is used for goroutine stacks. Stack spans</span>
<span id="L107" class="ln">   107&nbsp;&nbsp;</span>	<span class="comment">// are not considered part of the heap. A span can change</span>
<span id="L108" class="ln">   108&nbsp;&nbsp;</span>	<span class="comment">// between heap and stack memory; it is never used for both</span>
<span id="L109" class="ln">   109&nbsp;&nbsp;</span>	<span class="comment">// simultaneously.</span>
<span id="L110" class="ln">   110&nbsp;&nbsp;</span>
<span id="L111" class="ln">   111&nbsp;&nbsp;</span>	<span class="comment">// HeapAlloc is bytes of allocated heap objects.</span>
<span id="L112" class="ln">   112&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L113" class="ln">   113&nbsp;&nbsp;</span>	<span class="comment">// &#34;Allocated&#34; heap objects include all reachable objects, as</span>
<span id="L114" class="ln">   114&nbsp;&nbsp;</span>	<span class="comment">// well as unreachable objects that the garbage collector has</span>
<span id="L115" class="ln">   115&nbsp;&nbsp;</span>	<span class="comment">// not yet freed. Specifically, HeapAlloc increases as heap</span>
<span id="L116" class="ln">   116&nbsp;&nbsp;</span>	<span class="comment">// objects are allocated and decreases as the heap is swept</span>
<span id="L117" class="ln">   117&nbsp;&nbsp;</span>	<span class="comment">// and unreachable objects are freed. Sweeping occurs</span>
<span id="L118" class="ln">   118&nbsp;&nbsp;</span>	<span class="comment">// incrementally between GC cycles, so these two processes</span>
<span id="L119" class="ln">   119&nbsp;&nbsp;</span>	<span class="comment">// occur simultaneously, and as a result HeapAlloc tends to</span>
<span id="L120" class="ln">   120&nbsp;&nbsp;</span>	<span class="comment">// change smoothly (in contrast with the sawtooth that is</span>
<span id="L121" class="ln">   121&nbsp;&nbsp;</span>	<span class="comment">// typical of stop-the-world garbage collectors).</span>
<span id="L122" class="ln">   122&nbsp;&nbsp;</span>	HeapAlloc uint64
<span id="L123" class="ln">   123&nbsp;&nbsp;</span>
<span id="L124" class="ln">   124&nbsp;&nbsp;</span>	<span class="comment">// HeapSys is bytes of heap memory obtained from the OS.</span>
<span id="L125" class="ln">   125&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L126" class="ln">   126&nbsp;&nbsp;</span>	<span class="comment">// HeapSys measures the amount of virtual address space</span>
<span id="L127" class="ln">   127&nbsp;&nbsp;</span>	<span class="comment">// reserved for the heap. This includes virtual address space</span>
<span id="L128" class="ln">   128&nbsp;&nbsp;</span>	<span class="comment">// that has been reserved but not yet used, which consumes no</span>
<span id="L129" class="ln">   129&nbsp;&nbsp;</span>	<span class="comment">// physical memory, but tends to be small, as well as virtual</span>
<span id="L130" class="ln">   130&nbsp;&nbsp;</span>	<span class="comment">// address space for which the physical memory has been</span>
<span id="L131" class="ln">   131&nbsp;&nbsp;</span>	<span class="comment">// returned to the OS after it became unused (see HeapReleased</span>
<span id="L132" class="ln">   132&nbsp;&nbsp;</span>	<span class="comment">// for a measure of the latter).</span>
<span id="L133" class="ln">   133&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L134" class="ln">   134&nbsp;&nbsp;</span>	<span class="comment">// HeapSys estimates the largest size the heap has had.</span>
<span id="L135" class="ln">   135&nbsp;&nbsp;</span>	HeapSys uint64
<span id="L136" class="ln">   136&nbsp;&nbsp;</span>
<span id="L137" class="ln">   137&nbsp;&nbsp;</span>	<span class="comment">// HeapIdle is bytes in idle (unused) spans.</span>
<span id="L138" class="ln">   138&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L139" class="ln">   139&nbsp;&nbsp;</span>	<span class="comment">// Idle spans have no objects in them. These spans could be</span>
<span id="L140" class="ln">   140&nbsp;&nbsp;</span>	<span class="comment">// (and may already have been) returned to the OS, or they can</span>
<span id="L141" class="ln">   141&nbsp;&nbsp;</span>	<span class="comment">// be reused for heap allocations, or they can be reused as</span>
<span id="L142" class="ln">   142&nbsp;&nbsp;</span>	<span class="comment">// stack memory.</span>
<span id="L143" class="ln">   143&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L144" class="ln">   144&nbsp;&nbsp;</span>	<span class="comment">// HeapIdle minus HeapReleased estimates the amount of memory</span>
<span id="L145" class="ln">   145&nbsp;&nbsp;</span>	<span class="comment">// that could be returned to the OS, but is being retained by</span>
<span id="L146" class="ln">   146&nbsp;&nbsp;</span>	<span class="comment">// the runtime so it can grow the heap without requesting more</span>
<span id="L147" class="ln">   147&nbsp;&nbsp;</span>	<span class="comment">// memory from the OS. If this difference is significantly</span>
<span id="L148" class="ln">   148&nbsp;&nbsp;</span>	<span class="comment">// larger than the heap size, it indicates there was a recent</span>
<span id="L149" class="ln">   149&nbsp;&nbsp;</span>	<span class="comment">// transient spike in live heap size.</span>
<span id="L150" class="ln">   150&nbsp;&nbsp;</span>	HeapIdle uint64
<span id="L151" class="ln">   151&nbsp;&nbsp;</span>
<span id="L152" class="ln">   152&nbsp;&nbsp;</span>	<span class="comment">// HeapInuse is bytes in in-use spans.</span>
<span id="L153" class="ln">   153&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L154" class="ln">   154&nbsp;&nbsp;</span>	<span class="comment">// In-use spans have at least one object in them. These spans</span>
<span id="L155" class="ln">   155&nbsp;&nbsp;</span>	<span class="comment">// can only be used for other objects of roughly the same</span>
<span id="L156" class="ln">   156&nbsp;&nbsp;</span>	<span class="comment">// size.</span>
<span id="L157" class="ln">   157&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L158" class="ln">   158&nbsp;&nbsp;</span>	<span class="comment">// HeapInuse minus HeapAlloc estimates the amount of memory</span>
<span id="L159" class="ln">   159&nbsp;&nbsp;</span>	<span class="comment">// that has been dedicated to particular size classes, but is</span>
<span id="L160" class="ln">   160&nbsp;&nbsp;</span>	<span class="comment">// not currently being used. This is an upper bound on</span>
<span id="L161" class="ln">   161&nbsp;&nbsp;</span>	<span class="comment">// fragmentation, but in general this memory can be reused</span>
<span id="L162" class="ln">   162&nbsp;&nbsp;</span>	<span class="comment">// efficiently.</span>
<span id="L163" class="ln">   163&nbsp;&nbsp;</span>	HeapInuse uint64
<span id="L164" class="ln">   164&nbsp;&nbsp;</span>
<span id="L165" class="ln">   165&nbsp;&nbsp;</span>	<span class="comment">// HeapReleased is bytes of physical memory returned to the OS.</span>
<span id="L166" class="ln">   166&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L167" class="ln">   167&nbsp;&nbsp;</span>	<span class="comment">// This counts heap memory from idle spans that was returned</span>
<span id="L168" class="ln">   168&nbsp;&nbsp;</span>	<span class="comment">// to the OS and has not yet been reacquired for the heap.</span>
<span id="L169" class="ln">   169&nbsp;&nbsp;</span>	HeapReleased uint64
<span id="L170" class="ln">   170&nbsp;&nbsp;</span>
<span id="L171" class="ln">   171&nbsp;&nbsp;</span>	<span class="comment">// HeapObjects is the number of allocated heap objects.</span>
<span id="L172" class="ln">   172&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L173" class="ln">   173&nbsp;&nbsp;</span>	<span class="comment">// Like HeapAlloc, this increases as objects are allocated and</span>
<span id="L174" class="ln">   174&nbsp;&nbsp;</span>	<span class="comment">// decreases as the heap is swept and unreachable objects are</span>
<span id="L175" class="ln">   175&nbsp;&nbsp;</span>	<span class="comment">// freed.</span>
<span id="L176" class="ln">   176&nbsp;&nbsp;</span>	HeapObjects uint64
<span id="L177" class="ln">   177&nbsp;&nbsp;</span>
<span id="L178" class="ln">   178&nbsp;&nbsp;</span>	<span class="comment">// Stack memory statistics.</span>
<span id="L179" class="ln">   179&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L180" class="ln">   180&nbsp;&nbsp;</span>	<span class="comment">// Stacks are not considered part of the heap, but the runtime</span>
<span id="L181" class="ln">   181&nbsp;&nbsp;</span>	<span class="comment">// can reuse a span of heap memory for stack memory, and</span>
<span id="L182" class="ln">   182&nbsp;&nbsp;</span>	<span class="comment">// vice-versa.</span>
<span id="L183" class="ln">   183&nbsp;&nbsp;</span>
<span id="L184" class="ln">   184&nbsp;&nbsp;</span>	<span class="comment">// StackInuse is bytes in stack spans.</span>
<span id="L185" class="ln">   185&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L186" class="ln">   186&nbsp;&nbsp;</span>	<span class="comment">// In-use stack spans have at least one stack in them. These</span>
<span id="L187" class="ln">   187&nbsp;&nbsp;</span>	<span class="comment">// spans can only be used for other stacks of the same size.</span>
<span id="L188" class="ln">   188&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L189" class="ln">   189&nbsp;&nbsp;</span>	<span class="comment">// There is no StackIdle because unused stack spans are</span>
<span id="L190" class="ln">   190&nbsp;&nbsp;</span>	<span class="comment">// returned to the heap (and hence counted toward HeapIdle).</span>
<span id="L191" class="ln">   191&nbsp;&nbsp;</span>	StackInuse uint64
<span id="L192" class="ln">   192&nbsp;&nbsp;</span>
<span id="L193" class="ln">   193&nbsp;&nbsp;</span>	<span class="comment">// StackSys is bytes of stack memory obtained from the OS.</span>
<span id="L194" class="ln">   194&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L195" class="ln">   195&nbsp;&nbsp;</span>	<span class="comment">// StackSys is StackInuse, plus any memory obtained directly</span>
<span id="L196" class="ln">   196&nbsp;&nbsp;</span>	<span class="comment">// from the OS for OS thread stacks.</span>
<span id="L197" class="ln">   197&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L198" class="ln">   198&nbsp;&nbsp;</span>	<span class="comment">// In non-cgo programs this metric is currently equal to StackInuse</span>
<span id="L199" class="ln">   199&nbsp;&nbsp;</span>	<span class="comment">// (but this should not be relied upon, and the value may change in</span>
<span id="L200" class="ln">   200&nbsp;&nbsp;</span>	<span class="comment">// the future).</span>
<span id="L201" class="ln">   201&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L202" class="ln">   202&nbsp;&nbsp;</span>	<span class="comment">// In cgo programs this metric includes OS thread stacks allocated</span>
<span id="L203" class="ln">   203&nbsp;&nbsp;</span>	<span class="comment">// directly from the OS. Currently, this only accounts for one stack in</span>
<span id="L204" class="ln">   204&nbsp;&nbsp;</span>	<span class="comment">// c-shared and c-archive build modes and other sources of stacks from</span>
<span id="L205" class="ln">   205&nbsp;&nbsp;</span>	<span class="comment">// the OS (notably, any allocated by C code) are not currently measured.</span>
<span id="L206" class="ln">   206&nbsp;&nbsp;</span>	<span class="comment">// Note this too may change in the future.</span>
<span id="L207" class="ln">   207&nbsp;&nbsp;</span>	StackSys uint64
<span id="L208" class="ln">   208&nbsp;&nbsp;</span>
<span id="L209" class="ln">   209&nbsp;&nbsp;</span>	<span class="comment">// Off-heap memory statistics.</span>
<span id="L210" class="ln">   210&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L211" class="ln">   211&nbsp;&nbsp;</span>	<span class="comment">// The following statistics measure runtime-internal</span>
<span id="L212" class="ln">   212&nbsp;&nbsp;</span>	<span class="comment">// structures that are not allocated from heap memory (usually</span>
<span id="L213" class="ln">   213&nbsp;&nbsp;</span>	<span class="comment">// because they are part of implementing the heap). Unlike</span>
<span id="L214" class="ln">   214&nbsp;&nbsp;</span>	<span class="comment">// heap or stack memory, any memory allocated to these</span>
<span id="L215" class="ln">   215&nbsp;&nbsp;</span>	<span class="comment">// structures is dedicated to these structures.</span>
<span id="L216" class="ln">   216&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L217" class="ln">   217&nbsp;&nbsp;</span>	<span class="comment">// These are primarily useful for debugging runtime memory</span>
<span id="L218" class="ln">   218&nbsp;&nbsp;</span>	<span class="comment">// overheads.</span>
<span id="L219" class="ln">   219&nbsp;&nbsp;</span>
<span id="L220" class="ln">   220&nbsp;&nbsp;</span>	<span class="comment">// MSpanInuse is bytes of allocated mspan structures.</span>
<span id="L221" class="ln">   221&nbsp;&nbsp;</span>	MSpanInuse uint64
<span id="L222" class="ln">   222&nbsp;&nbsp;</span>
<span id="L223" class="ln">   223&nbsp;&nbsp;</span>	<span class="comment">// MSpanSys is bytes of memory obtained from the OS for mspan</span>
<span id="L224" class="ln">   224&nbsp;&nbsp;</span>	<span class="comment">// structures.</span>
<span id="L225" class="ln">   225&nbsp;&nbsp;</span>	MSpanSys uint64
<span id="L226" class="ln">   226&nbsp;&nbsp;</span>
<span id="L227" class="ln">   227&nbsp;&nbsp;</span>	<span class="comment">// MCacheInuse is bytes of allocated mcache structures.</span>
<span id="L228" class="ln">   228&nbsp;&nbsp;</span>	MCacheInuse uint64
<span id="L229" class="ln">   229&nbsp;&nbsp;</span>
<span id="L230" class="ln">   230&nbsp;&nbsp;</span>	<span class="comment">// MCacheSys is bytes of memory obtained from the OS for</span>
<span id="L231" class="ln">   231&nbsp;&nbsp;</span>	<span class="comment">// mcache structures.</span>
<span id="L232" class="ln">   232&nbsp;&nbsp;</span>	MCacheSys uint64
<span id="L233" class="ln">   233&nbsp;&nbsp;</span>
<span id="L234" class="ln">   234&nbsp;&nbsp;</span>	<span class="comment">// BuckHashSys is bytes of memory in profiling bucket hash tables.</span>
<span id="L235" class="ln">   235&nbsp;&nbsp;</span>	BuckHashSys uint64
<span id="L236" class="ln">   236&nbsp;&nbsp;</span>
<span id="L237" class="ln">   237&nbsp;&nbsp;</span>	<span class="comment">// GCSys is bytes of memory in garbage collection metadata.</span>
<span id="L238" class="ln">   238&nbsp;&nbsp;</span>	GCSys uint64
<span id="L239" class="ln">   239&nbsp;&nbsp;</span>
<span id="L240" class="ln">   240&nbsp;&nbsp;</span>	<span class="comment">// OtherSys is bytes of memory in miscellaneous off-heap</span>
<span id="L241" class="ln">   241&nbsp;&nbsp;</span>	<span class="comment">// runtime allocations.</span>
<span id="L242" class="ln">   242&nbsp;&nbsp;</span>	OtherSys uint64
<span id="L243" class="ln">   243&nbsp;&nbsp;</span>
<span id="L244" class="ln">   244&nbsp;&nbsp;</span>	<span class="comment">// Garbage collector statistics.</span>
<span id="L245" class="ln">   245&nbsp;&nbsp;</span>
<span id="L246" class="ln">   246&nbsp;&nbsp;</span>	<span class="comment">// NextGC is the target heap size of the next GC cycle.</span>
<span id="L247" class="ln">   247&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L248" class="ln">   248&nbsp;&nbsp;</span>	<span class="comment">// The garbage collector&#39;s goal is to keep HeapAlloc ≤ NextGC.</span>
<span id="L249" class="ln">   249&nbsp;&nbsp;</span>	<span class="comment">// At the end of each GC cycle, the target for the next cycle</span>
<span id="L250" class="ln">   250&nbsp;&nbsp;</span>	<span class="comment">// is computed based on the amount of reachable data and the</span>
<span id="L251" class="ln">   251&nbsp;&nbsp;</span>	<span class="comment">// value of GOGC.</span>
<span id="L252" class="ln">   252&nbsp;&nbsp;</span>	NextGC uint64
<span id="L253" class="ln">   253&nbsp;&nbsp;</span>
<span id="L254" class="ln">   254&nbsp;&nbsp;</span>	<span class="comment">// LastGC is the time the last garbage collection finished, as</span>
<span id="L255" class="ln">   255&nbsp;&nbsp;</span>	<span class="comment">// nanoseconds since 1970 (the UNIX epoch).</span>
<span id="L256" class="ln">   256&nbsp;&nbsp;</span>	LastGC uint64
<span id="L257" class="ln">   257&nbsp;&nbsp;</span>
<span id="L258" class="ln">   258&nbsp;&nbsp;</span>	<span class="comment">// PauseTotalNs is the cumulative nanoseconds in GC</span>
<span id="L259" class="ln">   259&nbsp;&nbsp;</span>	<span class="comment">// stop-the-world pauses since the program started.</span>
<span id="L260" class="ln">   260&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L261" class="ln">   261&nbsp;&nbsp;</span>	<span class="comment">// During a stop-the-world pause, all goroutines are paused</span>
<span id="L262" class="ln">   262&nbsp;&nbsp;</span>	<span class="comment">// and only the garbage collector can run.</span>
<span id="L263" class="ln">   263&nbsp;&nbsp;</span>	PauseTotalNs uint64
<span id="L264" class="ln">   264&nbsp;&nbsp;</span>
<span id="L265" class="ln">   265&nbsp;&nbsp;</span>	<span class="comment">// PauseNs is a circular buffer of recent GC stop-the-world</span>
<span id="L266" class="ln">   266&nbsp;&nbsp;</span>	<span class="comment">// pause times in nanoseconds.</span>
<span id="L267" class="ln">   267&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L268" class="ln">   268&nbsp;&nbsp;</span>	<span class="comment">// The most recent pause is at PauseNs[(NumGC+255)%256]. In</span>
<span id="L269" class="ln">   269&nbsp;&nbsp;</span>	<span class="comment">// general, PauseNs[N%256] records the time paused in the most</span>
<span id="L270" class="ln">   270&nbsp;&nbsp;</span>	<span class="comment">// recent N%256th GC cycle. There may be multiple pauses per</span>
<span id="L271" class="ln">   271&nbsp;&nbsp;</span>	<span class="comment">// GC cycle; this is the sum of all pauses during a cycle.</span>
<span id="L272" class="ln">   272&nbsp;&nbsp;</span>	PauseNs [256]uint64
<span id="L273" class="ln">   273&nbsp;&nbsp;</span>
<span id="L274" class="ln">   274&nbsp;&nbsp;</span>	<span class="comment">// PauseEnd is a circular buffer of recent GC pause end times,</span>
<span id="L275" class="ln">   275&nbsp;&nbsp;</span>	<span class="comment">// as nanoseconds since 1970 (the UNIX epoch).</span>
<span id="L276" class="ln">   276&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L277" class="ln">   277&nbsp;&nbsp;</span>	<span class="comment">// This buffer is filled the same way as PauseNs. There may be</span>
<span id="L278" class="ln">   278&nbsp;&nbsp;</span>	<span class="comment">// multiple pauses per GC cycle; this records the end of the</span>
<span id="L279" class="ln">   279&nbsp;&nbsp;</span>	<span class="comment">// last pause in a cycle.</span>
<span id="L280" class="ln">   280&nbsp;&nbsp;</span>	PauseEnd [256]uint64
<span id="L281" class="ln">   281&nbsp;&nbsp;</span>
<span id="L282" class="ln">   282&nbsp;&nbsp;</span>	<span class="comment">// NumGC is the number of completed GC cycles.</span>
<span id="L283" class="ln">   283&nbsp;&nbsp;</span>	NumGC uint32
<span id="L284" class="ln">   284&nbsp;&nbsp;</span>
<span id="L285" class="ln">   285&nbsp;&nbsp;</span>	<span class="comment">// NumForcedGC is the number of GC cycles that were forced by</span>
<span id="L286" class="ln">   286&nbsp;&nbsp;</span>	<span class="comment">// the application calling the GC function.</span>
<span id="L287" class="ln">   287&nbsp;&nbsp;</span>	NumForcedGC uint32
<span id="L288" class="ln">   288&nbsp;&nbsp;</span>
<span id="L289" class="ln">   289&nbsp;&nbsp;</span>	<span class="comment">// GCCPUFraction is the fraction of this program&#39;s available</span>
<span id="L290" class="ln">   290&nbsp;&nbsp;</span>	<span class="comment">// CPU time used by the GC since the program started.</span>
<span id="L291" class="ln">   291&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L292" class="ln">   292&nbsp;&nbsp;</span>	<span class="comment">// GCCPUFraction is expressed as a number between 0 and 1,</span>
<span id="L293" class="ln">   293&nbsp;&nbsp;</span>	<span class="comment">// where 0 means GC has consumed none of this program&#39;s CPU. A</span>
<span id="L294" class="ln">   294&nbsp;&nbsp;</span>	<span class="comment">// program&#39;s available CPU time is defined as the integral of</span>
<span id="L295" class="ln">   295&nbsp;&nbsp;</span>	<span class="comment">// GOMAXPROCS since the program started. That is, if</span>
<span id="L296" class="ln">   296&nbsp;&nbsp;</span>	<span class="comment">// GOMAXPROCS is 2 and a program has been running for 10</span>
<span id="L297" class="ln">   297&nbsp;&nbsp;</span>	<span class="comment">// seconds, its &#34;available CPU&#34; is 20 seconds. GCCPUFraction</span>
<span id="L298" class="ln">   298&nbsp;&nbsp;</span>	<span class="comment">// does not include CPU time used for write barrier activity.</span>
<span id="L299" class="ln">   299&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L300" class="ln">   300&nbsp;&nbsp;</span>	<span class="comment">// This is the same as the fraction of CPU reported by</span>
<span id="L301" class="ln">   301&nbsp;&nbsp;</span>	<span class="comment">// GODEBUG=gctrace=1.</span>
<span id="L302" class="ln">   302&nbsp;&nbsp;</span>	GCCPUFraction float64
<span id="L303" class="ln">   303&nbsp;&nbsp;</span>
<span id="L304" class="ln">   304&nbsp;&nbsp;</span>	<span class="comment">// EnableGC indicates that GC is enabled. It is always true,</span>
<span id="L305" class="ln">   305&nbsp;&nbsp;</span>	<span class="comment">// even if GOGC=off.</span>
<span id="L306" class="ln">   306&nbsp;&nbsp;</span>	EnableGC bool
<span id="L307" class="ln">   307&nbsp;&nbsp;</span>
<span id="L308" class="ln">   308&nbsp;&nbsp;</span>	<span class="comment">// DebugGC is currently unused.</span>
<span id="L309" class="ln">   309&nbsp;&nbsp;</span>	DebugGC bool
<span id="L310" class="ln">   310&nbsp;&nbsp;</span>
<span id="L311" class="ln">   311&nbsp;&nbsp;</span>	<span class="comment">// BySize reports per-size class allocation statistics.</span>
<span id="L312" class="ln">   312&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L313" class="ln">   313&nbsp;&nbsp;</span>	<span class="comment">// BySize[N] gives statistics for allocations of size S where</span>
<span id="L314" class="ln">   314&nbsp;&nbsp;</span>	<span class="comment">// BySize[N-1].Size &lt; S ≤ BySize[N].Size.</span>
<span id="L315" class="ln">   315&nbsp;&nbsp;</span>	<span class="comment">//</span>
<span id="L316" class="ln">   316&nbsp;&nbsp;</span>	<span class="comment">// This does not report allocations larger than BySize[60].Size.</span>
<span id="L317" class="ln">   317&nbsp;&nbsp;</span>	BySize [61]struct {
<span id="L318" class="ln">   318&nbsp;&nbsp;</span>		<span class="comment">// Size is the maximum byte size of an object in this</span>
<span id="L319" class="ln">   319&nbsp;&nbsp;</span>		<span class="comment">// size class.</span>
<span id="L320" class="ln">   320&nbsp;&nbsp;</span>		Size uint32
<span id="L321" class="ln">   321&nbsp;&nbsp;</span>
<span id="L322" class="ln">   322&nbsp;&nbsp;</span>		<span class="comment">// Mallocs is the cumulative count of heap objects</span>
<span id="L323" class="ln">   323&nbsp;&nbsp;</span>		<span class="comment">// allocated in this size class. The cumulative bytes</span>
<span id="L324" class="ln">   324&nbsp;&nbsp;</span>		<span class="comment">// of allocation is Size*Mallocs. The number of live</span>
<span id="L325" class="ln">   325&nbsp;&nbsp;</span>		<span class="comment">// objects in this size class is Mallocs - Frees.</span>
<span id="L326" class="ln">   326&nbsp;&nbsp;</span>		Mallocs uint64
<span id="L327" class="ln">   327&nbsp;&nbsp;</span>
<span id="L328" class="ln">   328&nbsp;&nbsp;</span>		<span class="comment">// Frees is the cumulative count of heap objects freed</span>
<span id="L329" class="ln">   329&nbsp;&nbsp;</span>		<span class="comment">// in this size class.</span>
