...
<a href="annotation.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>func NewTask(pctx context.Context, taskType string) (ctx context.Context, task *Task) {
