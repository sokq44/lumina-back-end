...
<a href="sort.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L150" class="ln">   150&nbsp;&nbsp;</span>func BinarySearchFunc[S ~[]E, E, T any](x S, target T, cmp func(E, T) int) (int, bool) {
