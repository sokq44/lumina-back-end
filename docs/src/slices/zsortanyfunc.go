...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/slices/zsortanyfunc.go - Go Documentation Server</title>
...
<a href="zsortanyfunc.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/slices">slices</a>/<span class="text-muted">zsortanyfunc.go</span>
  </h1>
...
<span id="L9" class="ln">     9&nbsp;&nbsp;</span><span class="comment">// insertionSortCmpFunc sorts data[a:b] using insertion sort.</span>
<span id="L10" class="ln">    10&nbsp;&nbsp;</span>func insertionSortCmpFunc[E any](data []E, a, b int, cmp func(a, b E) int) {
<span id="L11" class="ln">    11&nbsp;&nbsp;</span>	for i := a + 1; i &lt; b; i++ {
<span id="L12" class="ln">    12&nbsp;&nbsp;</span>		for j := i; j &gt; a &amp;&amp; (cmp(data[j], data[j-1]) &lt; 0); j-- {
<span id="L13" class="ln">    13&nbsp;&nbsp;</span>			data[j], data[j-1] = data[j-1], data[j]
<span id="L14" class="ln">    14&nbsp;&nbsp;</span>		}
<span id="L15" class="ln">    15&nbsp;&nbsp;</span>	}
<span id="L16" class="ln">    16&nbsp;&nbsp;</span>}
<span id="L17" class="ln">    17&nbsp;&nbsp;</span>
<span id="L18" class="ln">    18&nbsp;&nbsp;</span><span class="comment">// siftDownCmpFunc implements the heap property on data[lo:hi].</span>
<span id="L19" class="ln">    19&nbsp;&nbsp;</span><span class="comment">// first is an offset into the array where the root of the heap lies.</span>
<span id="L20" class="ln">    20&nbsp;&nbsp;</span>func siftDownCmpFunc[E any](data []E, lo, hi, first int, cmp func(a, b E) int) {
...
<span id="L27" class="ln">    27&nbsp;&nbsp;</span>		if child+1 &lt; hi &amp;&amp; (cmp(data[first+child], data[first+child+1]) &lt; 0) {
<span id="L28" class="ln">    28&nbsp;&nbsp;</span>			child++
<span id="L29" class="ln">    29&nbsp;&nbsp;</span>		}
<span id="L30" class="ln">    30&nbsp;&nbsp;</span>		if !(cmp(data[first+root], data[first+child]) &lt; 0) {
<span id="L31" class="ln">    31&nbsp;&nbsp;</span>			return
<span id="L32" class="ln">    32&nbsp;&nbsp;</span>		}
<span id="L33" class="ln">    33&nbsp;&nbsp;</span>		data[first+root], data[first+child] = data[first+child], data[first+root]
<span id="L34" class="ln">    34&nbsp;&nbsp;</span>		root = child
<span id="L35" class="ln">    35&nbsp;&nbsp;</span>	}
<span id="L36" class="ln">    36&nbsp;&nbsp;</span>}
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>func heapSortCmpFunc[E any](data []E, a, b int, cmp func(a, b E) int) {
...
<span id="L45" class="ln">    45&nbsp;&nbsp;</span>		siftDownCmpFunc(data, i, hi, first, cmp)
...
<span id="L50" class="ln">    50&nbsp;&nbsp;</span>		data[first], data[first+i] = data[first+i], data[first]
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>		siftDownCmpFunc(data, lo, i, first, cmp)
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	}
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>}
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>
<span id="L55" class="ln">    55&nbsp;&nbsp;</span><span class="comment">// pdqsortCmpFunc sorts data[a:b].</span>
...
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>func pdqsortCmpFunc[E any](data []E, a, b, limit int, cmp func(a, b E) int) {
...
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>			insertionSortCmpFunc(data, a, b, cmp)
...
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>			heapSortCmpFunc(data, a, b, cmp)
...
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>			breakPatternsCmpFunc(data, a, b, cmp)
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>			limit--
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>		}
<span id="L88" class="ln">    88&nbsp;&nbsp;</span>
<span id="L89" class="ln">    89&nbsp;&nbsp;</span>		pivot, hint := choosePivotCmpFunc(data, a, b, cmp)
<span id="L90" class="ln">    90&nbsp;&nbsp;</span>		if hint == decreasingHint {
<span id="L91" class="ln">    91&nbsp;&nbsp;</span>			reverseRangeCmpFunc(data, a, b, cmp)
...
<span id="L101" class="ln">   101&nbsp;&nbsp;</span>			if partialInsertionSortCmpFunc(data, a, b, cmp) {
...
<span id="L108" class="ln">   108&nbsp;&nbsp;</span>		if a &gt; 0 &amp;&amp; !(cmp(data[a-1], data[pivot]) &lt; 0) {
<span id="L109" class="ln">   109&nbsp;&nbsp;</span>			mid := partitionEqualCmpFunc(data, a, b, pivot, cmp)
<span id="L110" class="ln">   110&nbsp;&nbsp;</span>			a = mid
<span id="L111" class="ln">   111&nbsp;&nbsp;</span>			continue
<span id="L112" class="ln">   112&nbsp;&nbsp;</span>		}
<span id="L113" class="ln">   113&nbsp;&nbsp;</span>
<span id="L114" class="ln">   114&nbsp;&nbsp;</span>		mid, alreadyPartitioned := partitionCmpFunc(data, a, b, pivot, cmp)
...
<span id="L121" class="ln">   121&nbsp;&nbsp;</span>			pdqsortCmpFunc(data, a, mid, limit, cmp)
...
<span id="L125" class="ln">   125&nbsp;&nbsp;</span>			pdqsortCmpFunc(data, mid+1, b, limit, cmp)
<span id="L126" class="ln">   126&nbsp;&nbsp;</span>			b = mid
<span id="L127" class="ln">   127&nbsp;&nbsp;</span>		}
<span id="L128" class="ln">   128&nbsp;&nbsp;</span>	}
<span id="L129" class="ln">   129&nbsp;&nbsp;</span>}
<span id="L130" class="ln">   130&nbsp;&nbsp;</span>
<span id="L131" class="ln">   131&nbsp;&nbsp;</span><span class="comment">// partitionCmpFunc does one quicksort partition.</span>
...
<span id="L135" class="ln">   135&nbsp;&nbsp;</span>func partitionCmpFunc[E any](data []E, a, b, pivot int, cmp func(a, b E) int) (newpivot int, alreadyPartitioned bool) {
<span id="L136" class="ln">   136&nbsp;&nbsp;</span>	data[a], data[pivot] = data[pivot], data[a]
...
<span id="L139" class="ln">   139&nbsp;&nbsp;</span>	for i &lt;= j &amp;&amp; (cmp(data[i], data[a]) &lt; 0) {
<span id="L140" class="ln">   140&nbsp;&nbsp;</span>		i++
<span id="L141" class="ln">   141&nbsp;&nbsp;</span>	}
<span id="L142" class="ln">   142&nbsp;&nbsp;</span>	for i &lt;= j &amp;&amp; !(cmp(data[j], data[a]) &lt; 0) {
<span id="L143" class="ln">   143&nbsp;&nbsp;</span>		j--
<span id="L144" class="ln">   144&nbsp;&nbsp;</span>	}
<span id="L145" class="ln">   145&nbsp;&nbsp;</span>	if i &gt; j {
<span id="L146" class="ln">   146&nbsp;&nbsp;</span>		data[j], data[a] = data[a], data[j]
<span id="L147" class="ln">   147&nbsp;&nbsp;</span>		return j, true
<span id="L148" class="ln">   148&nbsp;&nbsp;</span>	}
<span id="L149" class="ln">   149&nbsp;&nbsp;</span>	data[i], data[j] = data[j], data[i]
<span id="L150" class="ln">   150&nbsp;&nbsp;</span>	i++
<span id="L151" class="ln">   151&nbsp;&nbsp;</span>	j--
<span id="L152" class="ln">   152&nbsp;&nbsp;</span>
<span id="L153" class="ln">   153&nbsp;&nbsp;</span>	for {
<span id="L154" class="ln">   154&nbsp;&nbsp;</span>		for i &lt;= j &amp;&amp; (cmp(data[i], data[a]) &lt; 0) {
<span id="L155" class="ln">   155&nbsp;&nbsp;</span>			i++
<span id="L156" class="ln">   156&nbsp;&nbsp;</span>		}
<span id="L157" class="ln">   157&nbsp;&nbsp;</span>		for i &lt;= j &amp;&amp; !(cmp(data[j], data[a]) &lt; 0) {
<span id="L158" class="ln">   158&nbsp;&nbsp;</span>			j--
<span id="L159" class="ln">   159&nbsp;&nbsp;</span>		}
<span id="L160" class="ln">   160&nbsp;&nbsp;</span>		if i &gt; j {
<span id="L161" class="ln">   161&nbsp;&nbsp;</span>			break
<span id="L162" class="ln">   162&nbsp;&nbsp;</span>		}
<span id="L163" class="ln">   163&nbsp;&nbsp;</span>		data[i], data[j] = data[j], data[i]
<span id="L164" class="ln">   164&nbsp;&nbsp;</span>		i++
<span id="L165" class="ln">   165&nbsp;&nbsp;</span>		j--
<span id="L166" class="ln">   166&nbsp;&nbsp;</span>	}
<span id="L167" class="ln">   167&nbsp;&nbsp;</span>	data[j], data[a] = data[a], data[j]
<span id="L168" class="ln">   168&nbsp;&nbsp;</span>	return j, false
<span id="L169" class="ln">   169&nbsp;&nbsp;</span>}
<span id="L170" class="ln">   170&nbsp;&nbsp;</span>
<span id="L171" class="ln">   171&nbsp;&nbsp;</span><span class="comment">// partitionEqualCmpFunc partitions data[a:b] into elements equal to data[pivot] followed by elements greater than data[pivot].</span>
...
<span id="L173" class="ln">   173&nbsp;&nbsp;</span>func partitionEqualCmpFunc[E any](data []E, a, b, pivot int, cmp func(a, b E) int) (newpivot int) {
<span id="L174" class="ln">   174&nbsp;&nbsp;</span>	data[a], data[pivot] = data[pivot], data[a]
...
<span id="L178" class="ln">   178&nbsp;&nbsp;</span>		for i &lt;= j &amp;&amp; !(cmp(data[a], data[i]) &lt; 0) {
<span id="L179" class="ln">   179&nbsp;&nbsp;</span>			i++
<span id="L180" class="ln">   180&nbsp;&nbsp;</span>		}
<span id="L181" class="ln">   181&nbsp;&nbsp;</span>		for i &lt;= j &amp;&amp; (cmp(data[a], data[j]) &lt; 0) {
<span id="L182" class="ln">   182&nbsp;&nbsp;</span>			j--
<span id="L183" class="ln">   183&nbsp;&nbsp;</span>		}
<span id="L184" class="ln">   184&nbsp;&nbsp;</span>		if i &gt; j {
<span id="L185" class="ln">   185&nbsp;&nbsp;</span>			break
<span id="L186" class="ln">   186&nbsp;&nbsp;</span>		}
<span id="L187" class="ln">   187&nbsp;&nbsp;</span>		data[i], data[j] = data[j], data[i]
...
<span id="L194" class="ln">   194&nbsp;&nbsp;</span><span class="comment">// partialInsertionSortCmpFunc partially sorts a slice, returns true if the slice is sorted at the end.</span>
<span id="L195" class="ln">   195&nbsp;&nbsp;</span>func partialInsertionSortCmpFunc[E any](data []E, a, b int, cmp func(a, b E) int) bool {
...
<span id="L202" class="ln">   202&nbsp;&nbsp;</span>		for i &lt; b &amp;&amp; !(cmp(data[i], data[i-1]) &lt; 0) {
...
<span id="L214" class="ln">   214&nbsp;&nbsp;</span>		data[i], data[i-1] = data[i-1], data[i]
...
<span id="L219" class="ln">   219&nbsp;&nbsp;</span>				if !(cmp(data[j], data[j-1]) &lt; 0) {
<span id="L220" class="ln">   220&nbsp;&nbsp;</span>					break
<span id="L221" class="ln">   221&nbsp;&nbsp;</span>				}
<span id="L222" class="ln">   222&nbsp;&nbsp;</span>				data[j], data[j-1] = data[j-1], data[j]
...
<span id="L228" class="ln">   228&nbsp;&nbsp;</span>				if !(cmp(data[j], data[j-1]) &lt; 0) {
<span id="L229" class="ln">   229&nbsp;&nbsp;</span>					break
<span id="L230" class="ln">   230&nbsp;&nbsp;</span>				}
<span id="L231" class="ln">   231&nbsp;&nbsp;</span>				data[j], data[j-1] = data[j-1], data[j]
...
<span id="L238" class="ln">   238&nbsp;&nbsp;</span><span class="comment">// breakPatternsCmpFunc scatters some elements around in an attempt to break some patterns</span>
<span id="L239" class="ln">   239&nbsp;&nbsp;</span><span class="comment">// that might cause imbalanced partitions in quicksort.</span>
<span id="L240" class="ln">   240&nbsp;&nbsp;</span>func breakPatternsCmpFunc[E any](data []E, a, b int, cmp func(a, b E) int) {
...
<span id="L251" class="ln">   251&nbsp;&nbsp;</span>			data[idx], data[a+other] = data[a+other], data[idx]
<span id="L252" class="ln">   252&nbsp;&nbsp;</span>		}
<span id="L253" class="ln">   253&nbsp;&nbsp;</span>	}
<span id="L254" class="ln">   254&nbsp;&nbsp;</span>}
<span id="L255" class="ln">   255&nbsp;&nbsp;</span>
<span id="L256" class="ln">   256&nbsp;&nbsp;</span><span class="comment">// choosePivotCmpFunc chooses a pivot in data[a:b].</span>
...
<span id="L261" class="ln">   261&nbsp;&nbsp;</span>func choosePivotCmpFunc[E any](data []E, a, b int, cmp func(a, b E) int) (pivot int, hint sortedHint) {
...
<span id="L279" class="ln">   279&nbsp;&nbsp;</span>			i = medianAdjacentCmpFunc(data, i, &amp;swaps, cmp)
<span id="L280" class="ln">   280&nbsp;&nbsp;</span>			j = medianAdjacentCmpFunc(data, j, &amp;swaps, cmp)
<span id="L281" class="ln">   281&nbsp;&nbsp;</span>			k = medianAdjacentCmpFunc(data, k, &amp;swaps, cmp)
<span id="L282" class="ln">   282&nbsp;&nbsp;</span>		}
<span id="L283" class="ln">   283&nbsp;&nbsp;</span>		<span class="comment">// Find the median among i, j, k and stores it into j.</span>
<span id="L284" class="ln">   284&nbsp;&nbsp;</span>		j = medianCmpFunc(data, i, j, k, &amp;swaps, cmp)
...
<span id="L297" class="ln">   297&nbsp;&nbsp;</span><span class="comment">// order2CmpFunc returns x,y where data[x] &lt;= data[y], where x,y=a,b or x,y=b,a.</span>
<span id="L298" class="ln">   298&nbsp;&nbsp;</span>func order2CmpFunc[E any](data []E, a, b int, swaps *int, cmp func(a, b E) int) (int, int) {
<span id="L299" class="ln">   299&nbsp;&nbsp;</span>	if cmp(data[b], data[a]) &lt; 0 {
...
<span id="L306" class="ln">   306&nbsp;&nbsp;</span><span class="comment">// medianCmpFunc returns x where data[x] is the median of data[a],data[b],data[c], where x is a, b, or c.</span>
<span id="L307" class="ln">   307&nbsp;&nbsp;</span>func medianCmpFunc[E any](data []E, a, b, c int, swaps *int, cmp func(a, b E) int) int {
<span id="L308" class="ln">   308&nbsp;&nbsp;</span>	a, b = order2CmpFunc(data, a, b, swaps, cmp)
<span id="L309" class="ln">   309&nbsp;&nbsp;</span>	b, c = order2CmpFunc(data, b, c, swaps, cmp)
<span id="L310" class="ln">   310&nbsp;&nbsp;</span>	a, b = order2CmpFunc(data, a, b, swaps, cmp)
<span id="L311" class="ln">   311&nbsp;&nbsp;</span>	return b
<span id="L312" class="ln">   312&nbsp;&nbsp;</span>}
<span id="L313" class="ln">   313&nbsp;&nbsp;</span>
<span id="L314" class="ln">   314&nbsp;&nbsp;</span><span class="comment">// medianAdjacentCmpFunc finds the median of data[a - 1], data[a], data[a + 1] and stores the index into a.</span>
<span id="L315" class="ln">   315&nbsp;&nbsp;</span>func medianAdjacentCmpFunc[E any](data []E, a int, swaps *int, cmp func(a, b E) int) int {
<span id="L316" class="ln">   316&nbsp;&nbsp;</span>	return medianCmpFunc(data, a-1, a, a+1, swaps, cmp)
<span id="L317" class="ln">   317&nbsp;&nbsp;</span>}
<span id="L318" class="ln">   318&nbsp;&nbsp;</span>
<span id="L319" class="ln">   319&nbsp;&nbsp;</span>func reverseRangeCmpFunc[E any](data []E, a, b int, cmp func(a, b E) int) {
<span id="L320" class="ln">   320&nbsp;&nbsp;</span>	i := a
<span id="L321" class="ln">   321&nbsp;&nbsp;</span>	j := b - 1
<span id="L322" class="ln">   322&nbsp;&nbsp;</span>	for i &lt; j {
<span id="L323" class="ln">   323&nbsp;&nbsp;</span>		data[i], data[j] = data[j], data[i]
<span id="L324" class="ln">   324&nbsp;&nbsp;</span>		i++
<span id="L325" class="ln">   325&nbsp;&nbsp;</span>		j--
<span id="L326" class="ln">   326&nbsp;&nbsp;</span>	}
<span id="L327" class="ln">   327&nbsp;&nbsp;</span>}
<span id="L328" class="ln">   328&nbsp;&nbsp;</span>
<span id="L329" class="ln">   329&nbsp;&nbsp;</span>func swapRangeCmpFunc[E any](data []E, a, b, n int, cmp func(a, b E) int) {
<span id="L330" class="ln">   330&nbsp;&nbsp;</span>	for i := 0; i &lt; n; i++ {
<span id="L331" class="ln">   331&nbsp;&nbsp;</span>		data[a+i], data[b+i] = data[b+i], data[a+i]
<span id="L332" class="ln">   332&nbsp;&nbsp;</span>	}
<span id="L333" class="ln">   333&nbsp;&nbsp;</span>}
<span id="L334" class="ln">   334&nbsp;&nbsp;</span>
<span id="L335" class="ln">   335&nbsp;&nbsp;</span>func stableCmpFunc[E any](data []E, n int, cmp func(a, b E) int) {
...
<span id="L339" class="ln">   339&nbsp;&nbsp;</span>		insertionSortCmpFunc(data, a, b, cmp)
<span id="L340" class="ln">   340&nbsp;&nbsp;</span>		a = b
<span id="L341" class="ln">   341&nbsp;&nbsp;</span>		b += blockSize
<span id="L342" class="ln">   342&nbsp;&nbsp;</span>	}
<span id="L343" class="ln">   343&nbsp;&nbsp;</span>	insertionSortCmpFunc(data, a, n, cmp)
...
<span id="L348" class="ln">   348&nbsp;&nbsp;</span>			symMergeCmpFunc(data, a, a+blockSize, b, cmp)
...
<span id="L353" class="ln">   353&nbsp;&nbsp;</span>			symMergeCmpFunc(data, a, m, n, cmp)
<span id="L354" class="ln">   354&nbsp;&nbsp;</span>		}
<span id="L355" class="ln">   355&nbsp;&nbsp;</span>		blockSize *= 2
<span id="L356" class="ln">   356&nbsp;&nbsp;</span>	}
<span id="L357" class="ln">   357&nbsp;&nbsp;</span>}
<span id="L358" class="ln">   358&nbsp;&nbsp;</span>
<span id="L359" class="ln">   359&nbsp;&nbsp;</span><span class="comment">// symMergeCmpFunc merges the two sorted subsequences data[a:m] and data[m:b] using</span>
...
<span id="L378" class="ln">   378&nbsp;&nbsp;</span>func symMergeCmpFunc[E any](data []E, a, m, b int, cmp func(a, b E) int) {
...
<span id="L390" class="ln">   390&nbsp;&nbsp;</span>			if cmp(data[h], data[a]) &lt; 0 {
...
<span id="L398" class="ln">   398&nbsp;&nbsp;</span>			data[k], data[k+1] = data[k+1], data[k]
...
<span id="L414" class="ln">   414&nbsp;&nbsp;</span>			if !(cmp(data[m], data[h]) &lt; 0) {
...
<span id="L422" class="ln">   422&nbsp;&nbsp;</span>			data[k], data[k-1] = data[k-1], data[k]
...
<span id="L441" class="ln">   441&nbsp;&nbsp;</span>		if !(cmp(data[p-c], data[c]) &lt; 0) {
...
<span id="L450" class="ln">   450&nbsp;&nbsp;</span>		rotateCmpFunc(data, start, m, end, cmp)
<span id="L451" class="ln">   451&nbsp;&nbsp;</span>	}
<span id="L452" class="ln">   452&nbsp;&nbsp;</span>	if a &lt; start &amp;&amp; start &lt; mid {
<span id="L453" class="ln">   453&nbsp;&nbsp;</span>		symMergeCmpFunc(data, a, start, mid, cmp)
<span id="L454" class="ln">   454&nbsp;&nbsp;</span>	}
<span id="L455" class="ln">   455&nbsp;&nbsp;</span>	if mid &lt; end &amp;&amp; end &lt; b {
<span id="L456" class="ln">   456&nbsp;&nbsp;</span>		symMergeCmpFunc(data, mid, end, b, cmp)
<span id="L457" class="ln">   457&nbsp;&nbsp;</span>	}
<span id="L458" class="ln">   458&nbsp;&nbsp;</span>}
<span id="L459" class="ln">   459&nbsp;&nbsp;</span>
<span id="L460" class="ln">   460&nbsp;&nbsp;</span><span class="comment">// rotateCmpFunc rotates two consecutive blocks u = data[a:m] and v = data[m:b] in data:</span>
...
<span id="L464" class="ln">   464&nbsp;&nbsp;</span>func rotateCmpFunc[E any](data []E, a, m, b int, cmp func(a, b E) int) {
...
<span id="L470" class="ln">   470&nbsp;&nbsp;</span>			swapRangeCmpFunc(data, m-i, m, j, cmp)
<span id="L471" class="ln">   471&nbsp;&nbsp;</span>			i -= j
<span id="L472" class="ln">   472&nbsp;&nbsp;</span>		} else {
<span id="L473" class="ln">   473&nbsp;&nbsp;</span>			swapRangeCmpFunc(data, m-i, m+j-i, i, cmp)
<span id="L474" class="ln">   474&nbsp;&nbsp;</span>			j -= i
<span id="L475" class="ln">   475&nbsp;&nbsp;</span>		}
<span id="L476" class="ln">   476&nbsp;&nbsp;</span>	}
<span id="L477" class="ln">   477&nbsp;&nbsp;</span>	<span class="comment">// i == j</span>
<span id="L478" class="ln">   478&nbsp;&nbsp;</span>	swapRangeCmpFunc(data, m-i, m, i, cmp)
<span id="L479" class="ln">   479&nbsp;&nbsp;</span>}
<span id="L480" class="ln">   480&nbsp;&nbsp;</span>
</pre><p><a href="zsortanyfunc.go?m=text">View as plain text</a></p>
