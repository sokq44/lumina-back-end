...
<span id="L64" class="ln">    64&nbsp;&nbsp;</span>		<span class="comment">// i ≤ h &lt; j</span>
...
<span id="L106" class="ln">   106&nbsp;&nbsp;</span>		<span class="comment">// i ≤ h &lt; j</span>
...
<span id="L139" class="ln">   139&nbsp;&nbsp;</span>func SearchStrings(a []string, x string) int {
