...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/sort/zsortinterface.go - Go Documentation Server</title>
...
<a href="zsortinterface.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/sort">sort</a>/<span class="text-muted">zsortinterface.go</span>
  </h1>
...
<span id="L9" class="ln">     9&nbsp;&nbsp;</span><span class="comment">// insertionSort sorts data[a:b] using insertion sort.</span>
<span id="L10" class="ln">    10&nbsp;&nbsp;</span>func insertionSort(data Interface, a, b int) {
...
<span id="L18" class="ln">    18&nbsp;&nbsp;</span><span class="comment">// siftDown implements the heap property on data[lo:hi].</span>
<span id="L19" class="ln">    19&nbsp;&nbsp;</span><span class="comment">// first is an offset into the array where the root of the heap lies.</span>
<span id="L20" class="ln">    20&nbsp;&nbsp;</span>func siftDown(data Interface, lo, hi, first int) {
...
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>func heapSort(data Interface, a, b int) {
...
<span id="L45" class="ln">    45&nbsp;&nbsp;</span>		siftDown(data, i, hi, first)
...
<span id="L51" class="ln">    51&nbsp;&nbsp;</span>		siftDown(data, lo, i, first)
<span id="L52" class="ln">    52&nbsp;&nbsp;</span>	}
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>}
<span id="L54" class="ln">    54&nbsp;&nbsp;</span>
<span id="L55" class="ln">    55&nbsp;&nbsp;</span><span class="comment">// pdqsort sorts data[a:b].</span>
...
<span id="L61" class="ln">    61&nbsp;&nbsp;</span>func pdqsort(data Interface, a, b, limit int) {
...
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>			insertionSort(data, a, b)
...
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>			heapSort(data, a, b)
...
<span id="L85" class="ln">    85&nbsp;&nbsp;</span>			breakPatterns(data, a, b)
<span id="L86" class="ln">    86&nbsp;&nbsp;</span>			limit--
<span id="L87" class="ln">    87&nbsp;&nbsp;</span>		}
<span id="L88" class="ln">    88&nbsp;&nbsp;</span>
<span id="L89" class="ln">    89&nbsp;&nbsp;</span>		pivot, hint := choosePivot(data, a, b)
<span id="L90" class="ln">    90&nbsp;&nbsp;</span>		if hint == decreasingHint {
<span id="L91" class="ln">    91&nbsp;&nbsp;</span>			reverseRange(data, a, b)
...
<span id="L101" class="ln">   101&nbsp;&nbsp;</span>			if partialInsertionSort(data, a, b) {
...
<span id="L109" class="ln">   109&nbsp;&nbsp;</span>			mid := partitionEqual(data, a, b, pivot)
<span id="L110" class="ln">   110&nbsp;&nbsp;</span>			a = mid
<span id="L111" class="ln">   111&nbsp;&nbsp;</span>			continue
<span id="L112" class="ln">   112&nbsp;&nbsp;</span>		}
<span id="L113" class="ln">   113&nbsp;&nbsp;</span>
<span id="L114" class="ln">   114&nbsp;&nbsp;</span>		mid, alreadyPartitioned := partition(data, a, b, pivot)
...
<span id="L121" class="ln">   121&nbsp;&nbsp;</span>			pdqsort(data, a, mid, limit)
...
<span id="L125" class="ln">   125&nbsp;&nbsp;</span>			pdqsort(data, mid+1, b, limit)
<span id="L126" class="ln">   126&nbsp;&nbsp;</span>			b = mid
<span id="L127" class="ln">   127&nbsp;&nbsp;</span>		}
<span id="L128" class="ln">   128&nbsp;&nbsp;</span>	}
<span id="L129" class="ln">   129&nbsp;&nbsp;</span>}
<span id="L130" class="ln">   130&nbsp;&nbsp;</span>
<span id="L131" class="ln">   131&nbsp;&nbsp;</span><span class="comment">// partition does one quicksort partition.</span>
...
<span id="L135" class="ln">   135&nbsp;&nbsp;</span>func partition(data Interface, a, b, pivot int) (newpivot int, alreadyPartitioned bool) {
...
<span id="L171" class="ln">   171&nbsp;&nbsp;</span><span class="comment">// partitionEqual partitions data[a:b] into elements equal to data[pivot] followed by elements greater than data[pivot].</span>
...
<span id="L173" class="ln">   173&nbsp;&nbsp;</span>func partitionEqual(data Interface, a, b, pivot int) (newpivot int) {
...
<span id="L194" class="ln">   194&nbsp;&nbsp;</span><span class="comment">// partialInsertionSort partially sorts a slice, returns true if the slice is sorted at the end.</span>
<span id="L195" class="ln">   195&nbsp;&nbsp;</span>func partialInsertionSort(data Interface, a, b int) bool {
...
<span id="L238" class="ln">   238&nbsp;&nbsp;</span><span class="comment">// breakPatterns scatters some elements around in an attempt to break some patterns</span>
<span id="L239" class="ln">   239&nbsp;&nbsp;</span><span class="comment">// that might cause imbalanced partitions in quicksort.</span>
<span id="L240" class="ln">   240&nbsp;&nbsp;</span>func breakPatterns(data Interface, a, b int) {
...
<span id="L256" class="ln">   256&nbsp;&nbsp;</span><span class="comment">// choosePivot chooses a pivot in data[a:b].</span>
...
<span id="L261" class="ln">   261&nbsp;&nbsp;</span>func choosePivot(data Interface, a, b int) (pivot int, hint sortedHint) {
...
<span id="L279" class="ln">   279&nbsp;&nbsp;</span>			i = medianAdjacent(data, i, &amp;swaps)
<span id="L280" class="ln">   280&nbsp;&nbsp;</span>			j = medianAdjacent(data, j, &amp;swaps)
<span id="L281" class="ln">   281&nbsp;&nbsp;</span>			k = medianAdjacent(data, k, &amp;swaps)
<span id="L282" class="ln">   282&nbsp;&nbsp;</span>		}
<span id="L283" class="ln">   283&nbsp;&nbsp;</span>		<span class="comment">// Find the median among i, j, k and stores it into j.</span>
<span id="L284" class="ln">   284&nbsp;&nbsp;</span>		j = median(data, i, j, k, &amp;swaps)
...
<span id="L297" class="ln">   297&nbsp;&nbsp;</span><span class="comment">// order2 returns x,y where data[x] &lt;= data[y], where x,y=a,b or x,y=b,a.</span>
<span id="L298" class="ln">   298&nbsp;&nbsp;</span>func order2(data Interface, a, b int, swaps *int) (int, int) {
...
<span id="L306" class="ln">   306&nbsp;&nbsp;</span><span class="comment">// median returns x where data[x] is the median of data[a],data[b],data[c], where x is a, b, or c.</span>
<span id="L307" class="ln">   307&nbsp;&nbsp;</span>func median(data Interface, a, b, c int, swaps *int) int {
<span id="L308" class="ln">   308&nbsp;&nbsp;</span>	a, b = order2(data, a, b, swaps)
<span id="L309" class="ln">   309&nbsp;&nbsp;</span>	b, c = order2(data, b, c, swaps)
<span id="L310" class="ln">   310&nbsp;&nbsp;</span>	a, b = order2(data, a, b, swaps)
<span id="L311" class="ln">   311&nbsp;&nbsp;</span>	return b
<span id="L312" class="ln">   312&nbsp;&nbsp;</span>}
<span id="L313" class="ln">   313&nbsp;&nbsp;</span>
<span id="L314" class="ln">   314&nbsp;&nbsp;</span><span class="comment">// medianAdjacent finds the median of data[a - 1], data[a], data[a + 1] and stores the index into a.</span>
<span id="L315" class="ln">   315&nbsp;&nbsp;</span>func medianAdjacent(data Interface, a int, swaps *int) int {
<span id="L316" class="ln">   316&nbsp;&nbsp;</span>	return median(data, a-1, a, a+1, swaps)
<span id="L317" class="ln">   317&nbsp;&nbsp;</span>}
<span id="L318" class="ln">   318&nbsp;&nbsp;</span>
<span id="L319" class="ln">   319&nbsp;&nbsp;</span>func reverseRange(data Interface, a, b int) {
...
<span id="L329" class="ln">   329&nbsp;&nbsp;</span>func swapRange(data Interface, a, b, n int) {
<span id="L330" class="ln">   330&nbsp;&nbsp;</span>	for i := 0; i &lt; n; i++ {
<span id="L331" class="ln">   331&nbsp;&nbsp;</span>		data.Swap(a+i, b+i)
<span id="L332" class="ln">   332&nbsp;&nbsp;</span>	}
<span id="L333" class="ln">   333&nbsp;&nbsp;</span>}
<span id="L334" class="ln">   334&nbsp;&nbsp;</span>
<span id="L335" class="ln">   335&nbsp;&nbsp;</span>func stable(data Interface, n int) {
...
<span id="L339" class="ln">   339&nbsp;&nbsp;</span>		insertionSort(data, a, b)
<span id="L340" class="ln">   340&nbsp;&nbsp;</span>		a = b
<span id="L341" class="ln">   341&nbsp;&nbsp;</span>		b += blockSize
<span id="L342" class="ln">   342&nbsp;&nbsp;</span>	}
<span id="L343" class="ln">   343&nbsp;&nbsp;</span>	insertionSort(data, a, n)
...
<span id="L348" class="ln">   348&nbsp;&nbsp;</span>			symMerge(data, a, a+blockSize, b)
...
<span id="L353" class="ln">   353&nbsp;&nbsp;</span>			symMerge(data, a, m, n)
<span id="L354" class="ln">   354&nbsp;&nbsp;</span>		}
<span id="L355" class="ln">   355&nbsp;&nbsp;</span>		blockSize *= 2
<span id="L356" class="ln">   356&nbsp;&nbsp;</span>	}
<span id="L357" class="ln">   357&nbsp;&nbsp;</span>}
<span id="L358" class="ln">   358&nbsp;&nbsp;</span>
<span id="L359" class="ln">   359&nbsp;&nbsp;</span><span class="comment">// symMerge merges the two sorted subsequences data[a:m] and data[m:b] using</span>
...
<span id="L378" class="ln">   378&nbsp;&nbsp;</span>func symMerge(data Interface, a, m, b int) {
...
<span id="L450" class="ln">   450&nbsp;&nbsp;</span>		rotate(data, start, m, end)
<span id="L451" class="ln">   451&nbsp;&nbsp;</span>	}
<span id="L452" class="ln">   452&nbsp;&nbsp;</span>	if a &lt; start &amp;&amp; start &lt; mid {
<span id="L453" class="ln">   453&nbsp;&nbsp;</span>		symMerge(data, a, start, mid)
<span id="L454" class="ln">   454&nbsp;&nbsp;</span>	}
<span id="L455" class="ln">   455&nbsp;&nbsp;</span>	if mid &lt; end &amp;&amp; end &lt; b {
<span id="L456" class="ln">   456&nbsp;&nbsp;</span>		symMerge(data, mid, end, b)
<span id="L457" class="ln">   457&nbsp;&nbsp;</span>	}
<span id="L458" class="ln">   458&nbsp;&nbsp;</span>}
<span id="L459" class="ln">   459&nbsp;&nbsp;</span>
<span id="L460" class="ln">   460&nbsp;&nbsp;</span><span class="comment">// rotate rotates two consecutive blocks u = data[a:m] and v = data[m:b] in data:</span>
...
<span id="L464" class="ln">   464&nbsp;&nbsp;</span>func rotate(data Interface, a, m, b int) {
...
<span id="L470" class="ln">   470&nbsp;&nbsp;</span>			swapRange(data, m-i, m, j)
<span id="L471" class="ln">   471&nbsp;&nbsp;</span>			i -= j
<span id="L472" class="ln">   472&nbsp;&nbsp;</span>		} else {
<span id="L473" class="ln">   473&nbsp;&nbsp;</span>			swapRange(data, m-i, m+j-i, i)
<span id="L474" class="ln">   474&nbsp;&nbsp;</span>			j -= i
<span id="L475" class="ln">   475&nbsp;&nbsp;</span>		}
<span id="L476" class="ln">   476&nbsp;&nbsp;</span>	}
<span id="L477" class="ln">   477&nbsp;&nbsp;</span>	<span class="comment">// i == j</span>
<span id="L478" class="ln">   478&nbsp;&nbsp;</span>	swapRange(data, m-i, m, i)
<span id="L479" class="ln">   479&nbsp;&nbsp;</span>}
<span id="L480" class="ln">   480&nbsp;&nbsp;</span>
</pre><p><a href="zsortinterface.go?m=text">View as plain text</a></p>
