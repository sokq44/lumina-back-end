...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/strings/reader.go - Go Documentation Server</title>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/strings">strings</a>/<span class="text-muted">reader.go</span>
  </h1>
...
<span id="L13" class="ln">    13&nbsp;&nbsp;</span><span class="comment">// A Reader implements the [io.Reader], [io.ReaderAt], [io.ByteReader], [io.ByteScanner],</span>
<span id="L14" class="ln">    14&nbsp;&nbsp;</span><span class="comment">// [io.RuneReader], [io.RuneScanner], [io.Seeker], and [io.WriterTo] interfaces by reading</span>
<span id="L15" class="ln">    15&nbsp;&nbsp;</span><span class="comment">// from a string.</span>
<span id="L16" class="ln">    16&nbsp;&nbsp;</span><span class="comment">// The zero value for Reader operates like a Reader of an empty string.</span>
...
<span id="L24" class="ln">    24&nbsp;&nbsp;</span><span class="comment">// string.</span>
...
<span id="L32" class="ln">    32&nbsp;&nbsp;</span><span class="comment">// Size returns the original length of the underlying string.</span>
<span id="L33" class="ln">    33&nbsp;&nbsp;</span><span class="comment">// Size is the number of bytes available for reading via [Reader.ReadAt].</span>
...
<span id="L53" class="ln">    53&nbsp;&nbsp;</span>		return 0, errors.New(&#34;strings.Reader.ReadAt: negative offset&#34;)
...
<span id="L76" class="ln">    76&nbsp;&nbsp;</span><span class="comment">// UnreadByte implements the [io.ByteScanner] interface.</span>
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>func (r *Reader) UnreadByte() error {
<span id="L78" class="ln">    78&nbsp;&nbsp;</span>	if r.i &lt;= 0 {
<span id="L79" class="ln">    79&nbsp;&nbsp;</span>		return errors.New(&#34;strings.Reader.UnreadByte: at beginning of string&#34;)
...
<span id="L97" class="ln">    97&nbsp;&nbsp;</span>	ch, size = utf8.DecodeRuneInString(r.s[r.i:])
<span id="L98" class="ln">    98&nbsp;&nbsp;</span>	r.i += int64(size)
<span id="L99" class="ln">    99&nbsp;&nbsp;</span>	return
<span id="L100" class="ln">   100&nbsp;&nbsp;</span>}
<span id="L101" class="ln">   101&nbsp;&nbsp;</span>
<span id="L102" class="ln">   102&nbsp;&nbsp;</span><span class="comment">// UnreadRune implements the [io.RuneScanner] interface.</span>
<span id="L103" class="ln">   103&nbsp;&nbsp;</span>func (r *Reader) UnreadRune() error {
<span id="L104" class="ln">   104&nbsp;&nbsp;</span>	if r.i &lt;= 0 {
<span id="L105" class="ln">   105&nbsp;&nbsp;</span>		return errors.New(&#34;strings.Reader.UnreadRune: at beginning of string&#34;)
<span id="L106" class="ln">   106&nbsp;&nbsp;</span>	}
<span id="L107" class="ln">   107&nbsp;&nbsp;</span>	if r.prevRune &lt; 0 {
<span id="L108" class="ln">   108&nbsp;&nbsp;</span>		return errors.New(&#34;strings.Reader.UnreadRune: previous operation was not ReadRune&#34;)
...
<span id="L127" class="ln">   127&nbsp;&nbsp;</span>		return 0, errors.New(&#34;strings.Reader.Seek: invalid whence&#34;)
<span id="L128" class="ln">   128&nbsp;&nbsp;</span>	}
<span id="L129" class="ln">   129&nbsp;&nbsp;</span>	if abs &lt; 0 {
<span id="L130" class="ln">   130&nbsp;&nbsp;</span>		return 0, errors.New(&#34;strings.Reader.Seek: negative position&#34;)
...
<span id="L142" class="ln">   142&nbsp;&nbsp;</span>	s := r.s[r.i:]
<span id="L143" class="ln">   143&nbsp;&nbsp;</span>	m, err := io.WriteString(w, s)
<span id="L144" class="ln">   144&nbsp;&nbsp;</span>	if m &gt; len(s) {
<span id="L145" class="ln">   145&nbsp;&nbsp;</span>		panic(&#34;strings.Reader.WriteTo: invalid WriteString count&#34;)
<span id="L146" class="ln">   146&nbsp;&nbsp;</span>	}
<span id="L147" class="ln">   147&nbsp;&nbsp;</span>	r.i += int64(m)
<span id="L148" class="ln">   148&nbsp;&nbsp;</span>	n = int64(m)
<span id="L149" class="ln">   149&nbsp;&nbsp;</span>	if m != len(s) &amp;&amp; err == nil {
<span id="L150" class="ln">   150&nbsp;&nbsp;</span>		err = io.ErrShortWrite
<span id="L151" class="ln">   151&nbsp;&nbsp;</span>	}
<span id="L152" class="ln">   152&nbsp;&nbsp;</span>	return
<span id="L153" class="ln">   153&nbsp;&nbsp;</span>}
<span id="L154" class="ln">   154&nbsp;&nbsp;</span>
<span id="L155" class="ln">   155&nbsp;&nbsp;</span><span class="comment">// Reset resets the [Reader] to be reading from s.</span>
<span id="L156" class="ln">   156&nbsp;&nbsp;</span>func (r *Reader) Reset(s string) { *r = Reader{s, 0, -1} }
<span id="L157" class="ln">   157&nbsp;&nbsp;</span>
<span id="L158" class="ln">   158&nbsp;&nbsp;</span><span class="comment">// NewReader returns a new [Reader] reading from s.</span>
<span id="L159" class="ln">   159&nbsp;&nbsp;</span><span class="comment">// It is similar to [bytes.NewBufferString] but more efficient and non-writable.</span>
<span id="L160" class="ln">   160&nbsp;&nbsp;</span>func NewReader(s string) *Reader { return &amp;Reader{s, 0, -1} }
