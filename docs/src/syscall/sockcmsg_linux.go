...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/syscall/sockcmsg_linux.go - Go Documentation Server</title>
...
<a href="sockcmsg_linux.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/syscall">syscall</a>/<span class="text-muted">sockcmsg_linux.go</span>
  </h1>
...
<span id="L20" class="ln">    20&nbsp;&nbsp;</span>	*(*Ucred)(h.data(0)) = *ucred
...
<span id="L34" class="ln">    34&nbsp;&nbsp;</span>	if uintptr(len(m.Data)) &lt; unsafe.Sizeof(Ucred{}) {
<span id="L35" class="ln">    35&nbsp;&nbsp;</span>		return nil, EINVAL
<span id="L36" class="ln">    36&nbsp;&nbsp;</span>	}
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>	ucred := *(*Ucred)(unsafe.Pointer(&amp;m.Data[0]))
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>	return &amp;ucred, nil
<span id="L39" class="ln">    39&nbsp;&nbsp;</span>}
<span id="L40" class="ln">    40&nbsp;&nbsp;</span>
</pre><p><a href="sockcmsg_linux.go?m=text">View as plain text</a></p>
