...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/syscall/zsyscall_linux_amd64.go - Go Documentation Server</title>
...
<a href="zsyscall_linux_amd64.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/syscall">syscall</a>/<span class="text-muted">zsyscall_linux_amd64.go</span>
  </h1>
...
<span id="L1163" class="ln">  1163&nbsp;&nbsp;</span>func Getrlimit(resource int, rlim *Rlimit) (err error) {
<span id="L1164" class="ln">  1164&nbsp;&nbsp;</span>	_, _, e1 := RawSyscall(SYS_GETRLIMIT, uintptr(resource), uintptr(unsafe.Pointer(rlim)), 0)
<span id="L1165" class="ln">  1165&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1166" class="ln">  1166&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1167" class="ln">  1167&nbsp;&nbsp;</span>	}
<span id="L1168" class="ln">  1168&nbsp;&nbsp;</span>	return
<span id="L1169" class="ln">  1169&nbsp;&nbsp;</span>}
<span id="L1170" class="ln">  1170&nbsp;&nbsp;</span>
<span id="L1171" class="ln">  1171&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1172" class="ln">  1172&nbsp;&nbsp;</span>
<span id="L1173" class="ln">  1173&nbsp;&nbsp;</span>func Getuid() (uid int) {
<span id="L1174" class="ln">  1174&nbsp;&nbsp;</span>	r0, _ := rawSyscallNoError(SYS_GETUID, 0, 0, 0)
<span id="L1175" class="ln">  1175&nbsp;&nbsp;</span>	uid = int(r0)
<span id="L1176" class="ln">  1176&nbsp;&nbsp;</span>	return
<span id="L1177" class="ln">  1177&nbsp;&nbsp;</span>}
<span id="L1178" class="ln">  1178&nbsp;&nbsp;</span>
<span id="L1179" class="ln">  1179&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1180" class="ln">  1180&nbsp;&nbsp;</span>
<span id="L1181" class="ln">  1181&nbsp;&nbsp;</span>func InotifyInit() (fd int, err error) {
<span id="L1182" class="ln">  1182&nbsp;&nbsp;</span>	r0, _, e1 := RawSyscall(SYS_INOTIFY_INIT, 0, 0, 0)
<span id="L1183" class="ln">  1183&nbsp;&nbsp;</span>	fd = int(r0)
...
<span id="L1192" class="ln">  1192&nbsp;&nbsp;</span>func Ioperm(from int, num int, on int) (err error) {
<span id="L1193" class="ln">  1193&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_IOPERM, uintptr(from), uintptr(num), uintptr(on))
...
<span id="L1202" class="ln">  1202&nbsp;&nbsp;</span>func Iopl(level int) (err error) {
<span id="L1203" class="ln">  1203&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_IOPL, uintptr(level), 0, 0)
...
<span id="L1212" class="ln">  1212&nbsp;&nbsp;</span>func Listen(s int, n int) (err error) {
<span id="L1213" class="ln">  1213&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_LISTEN, uintptr(s), uintptr(n), 0)
...
<span id="L1222" class="ln">  1222&nbsp;&nbsp;</span>func Pause() (err error) {
<span id="L1223" class="ln">  1223&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_PAUSE, 0, 0, 0)
<span id="L1224" class="ln">  1224&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1225" class="ln">  1225&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1226" class="ln">  1226&nbsp;&nbsp;</span>	}
<span id="L1227" class="ln">  1227&nbsp;&nbsp;</span>	return
<span id="L1228" class="ln">  1228&nbsp;&nbsp;</span>}
<span id="L1229" class="ln">  1229&nbsp;&nbsp;</span>
<span id="L1230" class="ln">  1230&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1231" class="ln">  1231&nbsp;&nbsp;</span>
<span id="L1232" class="ln">  1232&nbsp;&nbsp;</span>func pread(fd int, p []byte, offset int64) (n int, err error) {
<span id="L1233" class="ln">  1233&nbsp;&nbsp;</span>	var _p0 unsafe.Pointer
<span id="L1234" class="ln">  1234&nbsp;&nbsp;</span>	if len(p) &gt; 0 {
<span id="L1235" class="ln">  1235&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;p[0])
<span id="L1236" class="ln">  1236&nbsp;&nbsp;</span>	} else {
<span id="L1237" class="ln">  1237&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;_zero)
<span id="L1238" class="ln">  1238&nbsp;&nbsp;</span>	}
<span id="L1239" class="ln">  1239&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_PREAD64, uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(offset), 0, 0)
<span id="L1240" class="ln">  1240&nbsp;&nbsp;</span>	n = int(r0)
<span id="L1241" class="ln">  1241&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1242" class="ln">  1242&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1243" class="ln">  1243&nbsp;&nbsp;</span>	}
<span id="L1244" class="ln">  1244&nbsp;&nbsp;</span>	return
<span id="L1245" class="ln">  1245&nbsp;&nbsp;</span>}
<span id="L1246" class="ln">  1246&nbsp;&nbsp;</span>
<span id="L1247" class="ln">  1247&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1248" class="ln">  1248&nbsp;&nbsp;</span>
<span id="L1249" class="ln">  1249&nbsp;&nbsp;</span>func pwrite(fd int, p []byte, offset int64) (n int, err error) {
<span id="L1250" class="ln">  1250&nbsp;&nbsp;</span>	var _p0 unsafe.Pointer
<span id="L1251" class="ln">  1251&nbsp;&nbsp;</span>	if len(p) &gt; 0 {
<span id="L1252" class="ln">  1252&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;p[0])
<span id="L1253" class="ln">  1253&nbsp;&nbsp;</span>	} else {
<span id="L1254" class="ln">  1254&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;_zero)
<span id="L1255" class="ln">  1255&nbsp;&nbsp;</span>	}
<span id="L1256" class="ln">  1256&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_PWRITE64, uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(offset), 0, 0)
<span id="L1257" class="ln">  1257&nbsp;&nbsp;</span>	n = int(r0)
<span id="L1258" class="ln">  1258&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1259" class="ln">  1259&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1264" class="ln">  1264&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1265" class="ln">  1265&nbsp;&nbsp;</span>
<span id="L1266" class="ln">  1266&nbsp;&nbsp;</span>func Renameat(olddirfd int, oldpath string, newdirfd int, newpath string) (err error) {
<span id="L1267" class="ln">  1267&nbsp;&nbsp;</span>	var _p0 *byte
<span id="L1268" class="ln">  1268&nbsp;&nbsp;</span>	_p0, err = BytePtrFromString(oldpath)
<span id="L1269" class="ln">  1269&nbsp;&nbsp;</span>	if err != nil {
<span id="L1270" class="ln">  1270&nbsp;&nbsp;</span>		return
<span id="L1271" class="ln">  1271&nbsp;&nbsp;</span>	}
<span id="L1272" class="ln">  1272&nbsp;&nbsp;</span>	var _p1 *byte
<span id="L1273" class="ln">  1273&nbsp;&nbsp;</span>	_p1, err = BytePtrFromString(newpath)
<span id="L1274" class="ln">  1274&nbsp;&nbsp;</span>	if err != nil {
<span id="L1275" class="ln">  1275&nbsp;&nbsp;</span>		return
<span id="L1276" class="ln">  1276&nbsp;&nbsp;</span>	}
<span id="L1277" class="ln">  1277&nbsp;&nbsp;</span>	_, _, e1 := Syscall6(SYS_RENAMEAT, uintptr(olddirfd), uintptr(unsafe.Pointer(_p0)), uintptr(newdirfd), uintptr(unsafe.Pointer(_p1)), 0, 0)
<span id="L1278" class="ln">  1278&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1279" class="ln">  1279&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1280" class="ln">  1280&nbsp;&nbsp;</span>	}
<span id="L1281" class="ln">  1281&nbsp;&nbsp;</span>	return
<span id="L1282" class="ln">  1282&nbsp;&nbsp;</span>}
<span id="L1283" class="ln">  1283&nbsp;&nbsp;</span>
<span id="L1284" class="ln">  1284&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1285" class="ln">  1285&nbsp;&nbsp;</span>
<span id="L1286" class="ln">  1286&nbsp;&nbsp;</span>func Seek(fd int, offset int64, whence int) (off int64, err error) {
<span id="L1287" class="ln">  1287&nbsp;&nbsp;</span>	r0, _, e1 := Syscall(SYS_LSEEK, uintptr(fd), uintptr(offset), uintptr(whence))
<span id="L1288" class="ln">  1288&nbsp;&nbsp;</span>	off = int64(r0)
<span id="L1289" class="ln">  1289&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1290" class="ln">  1290&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1291" class="ln">  1291&nbsp;&nbsp;</span>	}
<span id="L1292" class="ln">  1292&nbsp;&nbsp;</span>	return
<span id="L1293" class="ln">  1293&nbsp;&nbsp;</span>}
<span id="L1294" class="ln">  1294&nbsp;&nbsp;</span>
<span id="L1295" class="ln">  1295&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1296" class="ln">  1296&nbsp;&nbsp;</span>
<span id="L1297" class="ln">  1297&nbsp;&nbsp;</span>func Select(nfd int, r *FdSet, w *FdSet, e *FdSet, timeout *Timeval) (n int, err error) {
<span id="L1298" class="ln">  1298&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_SELECT, uintptr(nfd), uintptr(unsafe.Pointer(r)), uintptr(unsafe.Pointer(w)), uintptr(unsafe.Pointer(e)), uintptr(unsafe.Pointer(timeout)), 0)
<span id="L1299" class="ln">  1299&nbsp;&nbsp;</span>	n = int(r0)
<span id="L1300" class="ln">  1300&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1301" class="ln">  1301&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1306" class="ln">  1306&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1307" class="ln">  1307&nbsp;&nbsp;</span>
<span id="L1308" class="ln">  1308&nbsp;&nbsp;</span>func sendfile(outfd int, infd int, offset *int64, count int) (written int, err error) {
<span id="L1309" class="ln">  1309&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_SENDFILE, uintptr(outfd), uintptr(infd), uintptr(unsafe.Pointer(offset)), uintptr(count), 0, 0)
<span id="L1310" class="ln">  1310&nbsp;&nbsp;</span>	written = int(r0)
...
<span id="L1319" class="ln">  1319&nbsp;&nbsp;</span>func Setfsgid(gid int) (err error) {
<span id="L1320" class="ln">  1320&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_SETFSGID, uintptr(gid), 0, 0)
...
<span id="L1329" class="ln">  1329&nbsp;&nbsp;</span>func Setfsuid(uid int) (err error) {
<span id="L1330" class="ln">  1330&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_SETFSUID, uintptr(uid), 0, 0)
...
<span id="L1339" class="ln">  1339&nbsp;&nbsp;</span>func setrlimit(resource int, rlim *Rlimit) (err error) {
<span id="L1340" class="ln">  1340&nbsp;&nbsp;</span>	_, _, e1 := RawSyscall(SYS_SETRLIMIT, uintptr(resource), uintptr(unsafe.Pointer(rlim)), 0)
<span id="L1341" class="ln">  1341&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1342" class="ln">  1342&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1347" class="ln">  1347&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1348" class="ln">  1348&nbsp;&nbsp;</span>
<span id="L1349" class="ln">  1349&nbsp;&nbsp;</span>func Shutdown(fd int, how int) (err error) {
<span id="L1350" class="ln">  1350&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_SHUTDOWN, uintptr(fd), uintptr(how), 0)
<span id="L1351" class="ln">  1351&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1352" class="ln">  1352&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1357" class="ln">  1357&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1358" class="ln">  1358&nbsp;&nbsp;</span>
<span id="L1359" class="ln">  1359&nbsp;&nbsp;</span>func Splice(rfd int, roff *int64, wfd int, woff *int64, len int, flags int) (n int64, err error) {
<span id="L1360" class="ln">  1360&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_SPLICE, uintptr(rfd), uintptr(unsafe.Pointer(roff)), uintptr(wfd), uintptr(unsafe.Pointer(woff)), uintptr(len), uintptr(flags))
<span id="L1361" class="ln">  1361&nbsp;&nbsp;</span>	n = int64(r0)
<span id="L1362" class="ln">  1362&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1363" class="ln">  1363&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1368" class="ln">  1368&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1369" class="ln">  1369&nbsp;&nbsp;</span>
<span id="L1370" class="ln">  1370&nbsp;&nbsp;</span>func Statfs(path string, buf *Statfs_t) (err error) {
<span id="L1371" class="ln">  1371&nbsp;&nbsp;</span>	var _p0 *byte
<span id="L1372" class="ln">  1372&nbsp;&nbsp;</span>	_p0, err = BytePtrFromString(path)
<span id="L1373" class="ln">  1373&nbsp;&nbsp;</span>	if err != nil {
<span id="L1374" class="ln">  1374&nbsp;&nbsp;</span>		return
<span id="L1375" class="ln">  1375&nbsp;&nbsp;</span>	}
<span id="L1376" class="ln">  1376&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_STATFS, uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(buf)), 0)
<span id="L1377" class="ln">  1377&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1378" class="ln">  1378&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1379" class="ln">  1379&nbsp;&nbsp;</span>	}
<span id="L1380" class="ln">  1380&nbsp;&nbsp;</span>	return
<span id="L1381" class="ln">  1381&nbsp;&nbsp;</span>}
<span id="L1382" class="ln">  1382&nbsp;&nbsp;</span>
<span id="L1383" class="ln">  1383&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1384" class="ln">  1384&nbsp;&nbsp;</span>
<span id="L1385" class="ln">  1385&nbsp;&nbsp;</span>func SyncFileRange(fd int, off int64, n int64, flags int) (err error) {
<span id="L1386" class="ln">  1386&nbsp;&nbsp;</span>	_, _, e1 := Syscall6(SYS_SYNC_FILE_RANGE, uintptr(fd), uintptr(off), uintptr(n), uintptr(flags), 0, 0)
<span id="L1387" class="ln">  1387&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1388" class="ln">  1388&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1389" class="ln">  1389&nbsp;&nbsp;</span>	}
<span id="L1390" class="ln">  1390&nbsp;&nbsp;</span>	return
<span id="L1391" class="ln">  1391&nbsp;&nbsp;</span>}
<span id="L1392" class="ln">  1392&nbsp;&nbsp;</span>
<span id="L1393" class="ln">  1393&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1394" class="ln">  1394&nbsp;&nbsp;</span>
<span id="L1395" class="ln">  1395&nbsp;&nbsp;</span>func Truncate(path string, length int64) (err error) {
<span id="L1396" class="ln">  1396&nbsp;&nbsp;</span>	var _p0 *byte
<span id="L1397" class="ln">  1397&nbsp;&nbsp;</span>	_p0, err = BytePtrFromString(path)
<span id="L1398" class="ln">  1398&nbsp;&nbsp;</span>	if err != nil {
<span id="L1399" class="ln">  1399&nbsp;&nbsp;</span>		return
<span id="L1400" class="ln">  1400&nbsp;&nbsp;</span>	}
<span id="L1401" class="ln">  1401&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_TRUNCATE, uintptr(unsafe.Pointer(_p0)), uintptr(length), 0)
<span id="L1402" class="ln">  1402&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1403" class="ln">  1403&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1404" class="ln">  1404&nbsp;&nbsp;</span>	}
<span id="L1405" class="ln">  1405&nbsp;&nbsp;</span>	return
<span id="L1406" class="ln">  1406&nbsp;&nbsp;</span>}
<span id="L1407" class="ln">  1407&nbsp;&nbsp;</span>
<span id="L1408" class="ln">  1408&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1409" class="ln">  1409&nbsp;&nbsp;</span>
<span id="L1410" class="ln">  1410&nbsp;&nbsp;</span>func Ustat(dev int, ubuf *Ustat_t) (err error) {
<span id="L1411" class="ln">  1411&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_USTAT, uintptr(dev), uintptr(unsafe.Pointer(ubuf)), 0)
<span id="L1412" class="ln">  1412&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1413" class="ln">  1413&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1414" class="ln">  1414&nbsp;&nbsp;</span>	}
<span id="L1415" class="ln">  1415&nbsp;&nbsp;</span>	return
<span id="L1416" class="ln">  1416&nbsp;&nbsp;</span>}
<span id="L1417" class="ln">  1417&nbsp;&nbsp;</span>
<span id="L1418" class="ln">  1418&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1419" class="ln">  1419&nbsp;&nbsp;</span>
<span id="L1420" class="ln">  1420&nbsp;&nbsp;</span>func accept4(s int, rsa *RawSockaddrAny, addrlen *_Socklen, flags int) (fd int, err error) {
<span id="L1421" class="ln">  1421&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_ACCEPT4, uintptr(s), uintptr(unsafe.Pointer(rsa)), uintptr(unsafe.Pointer(addrlen)), uintptr(flags), 0, 0)
<span id="L1422" class="ln">  1422&nbsp;&nbsp;</span>	fd = int(r0)
...
<span id="L1431" class="ln">  1431&nbsp;&nbsp;</span>func bind(s int, addr unsafe.Pointer, addrlen _Socklen) (err error) {
<span id="L1432" class="ln">  1432&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_BIND, uintptr(s), uintptr(addr), uintptr(addrlen))
<span id="L1433" class="ln">  1433&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1434" class="ln">  1434&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1435" class="ln">  1435&nbsp;&nbsp;</span>	}
<span id="L1436" class="ln">  1436&nbsp;&nbsp;</span>	return
<span id="L1437" class="ln">  1437&nbsp;&nbsp;</span>}
<span id="L1438" class="ln">  1438&nbsp;&nbsp;</span>
<span id="L1439" class="ln">  1439&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1440" class="ln">  1440&nbsp;&nbsp;</span>
<span id="L1441" class="ln">  1441&nbsp;&nbsp;</span>func connect(s int, addr unsafe.Pointer, addrlen _Socklen) (err error) {
<span id="L1442" class="ln">  1442&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_CONNECT, uintptr(s), uintptr(addr), uintptr(addrlen))
<span id="L1443" class="ln">  1443&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1444" class="ln">  1444&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1449" class="ln">  1449&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1450" class="ln">  1450&nbsp;&nbsp;</span>
<span id="L1451" class="ln">  1451&nbsp;&nbsp;</span>func fstatat(fd int, path string, stat *Stat_t, flags int) (err error) {
<span id="L1452" class="ln">  1452&nbsp;&nbsp;</span>	var _p0 *byte
<span id="L1453" class="ln">  1453&nbsp;&nbsp;</span>	_p0, err = BytePtrFromString(path)
<span id="L1454" class="ln">  1454&nbsp;&nbsp;</span>	if err != nil {
<span id="L1455" class="ln">  1455&nbsp;&nbsp;</span>		return
<span id="L1456" class="ln">  1456&nbsp;&nbsp;</span>	}
<span id="L1457" class="ln">  1457&nbsp;&nbsp;</span>	_, _, e1 := Syscall6(SYS_NEWFSTATAT, uintptr(fd), uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(stat)), uintptr(flags), 0, 0)
<span id="L1458" class="ln">  1458&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1459" class="ln">  1459&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1460" class="ln">  1460&nbsp;&nbsp;</span>	}
<span id="L1461" class="ln">  1461&nbsp;&nbsp;</span>	return
<span id="L1462" class="ln">  1462&nbsp;&nbsp;</span>}
<span id="L1463" class="ln">  1463&nbsp;&nbsp;</span>
<span id="L1464" class="ln">  1464&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1465" class="ln">  1465&nbsp;&nbsp;</span>
<span id="L1466" class="ln">  1466&nbsp;&nbsp;</span>func getgroups(n int, list *_Gid_t) (nn int, err error) {
<span id="L1467" class="ln">  1467&nbsp;&nbsp;</span>	r0, _, e1 := RawSyscall(SYS_GETGROUPS, uintptr(n), uintptr(unsafe.Pointer(list)), 0)
<span id="L1468" class="ln">  1468&nbsp;&nbsp;</span>	nn = int(r0)
...
<span id="L1477" class="ln">  1477&nbsp;&nbsp;</span>func getsockopt(s int, level int, name int, val unsafe.Pointer, vallen *_Socklen) (err error) {
<span id="L1478" class="ln">  1478&nbsp;&nbsp;</span>	_, _, e1 := Syscall6(SYS_GETSOCKOPT, uintptr(s), uintptr(level), uintptr(name), uintptr(val), uintptr(unsafe.Pointer(vallen)), 0)
<span id="L1479" class="ln">  1479&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1480" class="ln">  1480&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1485" class="ln">  1485&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1486" class="ln">  1486&nbsp;&nbsp;</span>
<span id="L1487" class="ln">  1487&nbsp;&nbsp;</span>func setsockopt(s int, level int, name int, val unsafe.Pointer, vallen uintptr) (err error) {
<span id="L1488" class="ln">  1488&nbsp;&nbsp;</span>	_, _, e1 := Syscall6(SYS_SETSOCKOPT, uintptr(s), uintptr(level), uintptr(name), uintptr(val), uintptr(vallen), 0)
<span id="L1489" class="ln">  1489&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1490" class="ln">  1490&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1491" class="ln">  1491&nbsp;&nbsp;</span>	}
<span id="L1492" class="ln">  1492&nbsp;&nbsp;</span>	return
<span id="L1493" class="ln">  1493&nbsp;&nbsp;</span>}
<span id="L1494" class="ln">  1494&nbsp;&nbsp;</span>
<span id="L1495" class="ln">  1495&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1496" class="ln">  1496&nbsp;&nbsp;</span>
<span id="L1497" class="ln">  1497&nbsp;&nbsp;</span>func socket(domain int, typ int, proto int) (fd int, err error) {
<span id="L1498" class="ln">  1498&nbsp;&nbsp;</span>	r0, _, e1 := RawSyscall(SYS_SOCKET, uintptr(domain), uintptr(typ), uintptr(proto))
<span id="L1499" class="ln">  1499&nbsp;&nbsp;</span>	fd = int(r0)
...
<span id="L1508" class="ln">  1508&nbsp;&nbsp;</span>func socketpair(domain int, typ int, proto int, fd *[2]int32) (err error) {
<span id="L1509" class="ln">  1509&nbsp;&nbsp;</span>	_, _, e1 := RawSyscall6(SYS_SOCKETPAIR, uintptr(domain), uintptr(typ), uintptr(proto), uintptr(unsafe.Pointer(fd)), 0, 0)
...
<span id="L1518" class="ln">  1518&nbsp;&nbsp;</span>func getpeername(fd int, rsa *RawSockaddrAny, addrlen *_Socklen) (err error) {
<span id="L1519" class="ln">  1519&nbsp;&nbsp;</span>	_, _, e1 := RawSyscall(SYS_GETPEERNAME, uintptr(fd), uintptr(unsafe.Pointer(rsa)), uintptr(unsafe.Pointer(addrlen)))
<span id="L1520" class="ln">  1520&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1521" class="ln">  1521&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1522" class="ln">  1522&nbsp;&nbsp;</span>	}
<span id="L1523" class="ln">  1523&nbsp;&nbsp;</span>	return
<span id="L1524" class="ln">  1524&nbsp;&nbsp;</span>}
<span id="L1525" class="ln">  1525&nbsp;&nbsp;</span>
<span id="L1526" class="ln">  1526&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1527" class="ln">  1527&nbsp;&nbsp;</span>
<span id="L1528" class="ln">  1528&nbsp;&nbsp;</span>func getsockname(fd int, rsa *RawSockaddrAny, addrlen *_Socklen) (err error) {
<span id="L1529" class="ln">  1529&nbsp;&nbsp;</span>	_, _, e1 := RawSyscall(SYS_GETSOCKNAME, uintptr(fd), uintptr(unsafe.Pointer(rsa)), uintptr(unsafe.Pointer(addrlen)))
<span id="L1530" class="ln">  1530&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1531" class="ln">  1531&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1536" class="ln">  1536&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1537" class="ln">  1537&nbsp;&nbsp;</span>
<span id="L1538" class="ln">  1538&nbsp;&nbsp;</span>func recvfrom(fd int, p []byte, flags int, from *RawSockaddrAny, fromlen *_Socklen) (n int, err error) {
<span id="L1539" class="ln">  1539&nbsp;&nbsp;</span>	var _p0 unsafe.Pointer
<span id="L1540" class="ln">  1540&nbsp;&nbsp;</span>	if len(p) &gt; 0 {
<span id="L1541" class="ln">  1541&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;p[0])
<span id="L1542" class="ln">  1542&nbsp;&nbsp;</span>	} else {
<span id="L1543" class="ln">  1543&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;_zero)
<span id="L1544" class="ln">  1544&nbsp;&nbsp;</span>	}
<span id="L1545" class="ln">  1545&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_RECVFROM, uintptr(fd), uintptr(_p0), uintptr(len(p)), uintptr(flags), uintptr(unsafe.Pointer(from)), uintptr(unsafe.Pointer(fromlen)))
<span id="L1546" class="ln">  1546&nbsp;&nbsp;</span>	n = int(r0)
<span id="L1547" class="ln">  1547&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1548" class="ln">  1548&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1549" class="ln">  1549&nbsp;&nbsp;</span>	}
<span id="L1550" class="ln">  1550&nbsp;&nbsp;</span>	return
<span id="L1551" class="ln">  1551&nbsp;&nbsp;</span>}
<span id="L1552" class="ln">  1552&nbsp;&nbsp;</span>
<span id="L1553" class="ln">  1553&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1554" class="ln">  1554&nbsp;&nbsp;</span>
<span id="L1555" class="ln">  1555&nbsp;&nbsp;</span>func sendto(s int, buf []byte, flags int, to unsafe.Pointer, addrlen _Socklen) (err error) {
<span id="L1556" class="ln">  1556&nbsp;&nbsp;</span>	var _p0 unsafe.Pointer
<span id="L1557" class="ln">  1557&nbsp;&nbsp;</span>	if len(buf) &gt; 0 {
<span id="L1558" class="ln">  1558&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;buf[0])
<span id="L1559" class="ln">  1559&nbsp;&nbsp;</span>	} else {
<span id="L1560" class="ln">  1560&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;_zero)
<span id="L1561" class="ln">  1561&nbsp;&nbsp;</span>	}
<span id="L1562" class="ln">  1562&nbsp;&nbsp;</span>	_, _, e1 := Syscall6(SYS_SENDTO, uintptr(s), uintptr(_p0), uintptr(len(buf)), uintptr(flags), uintptr(to), uintptr(addrlen))
<span id="L1563" class="ln">  1563&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1564" class="ln">  1564&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1565" class="ln">  1565&nbsp;&nbsp;</span>	}
<span id="L1566" class="ln">  1566&nbsp;&nbsp;</span>	return
<span id="L1567" class="ln">  1567&nbsp;&nbsp;</span>}
<span id="L1568" class="ln">  1568&nbsp;&nbsp;</span>
<span id="L1569" class="ln">  1569&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1570" class="ln">  1570&nbsp;&nbsp;</span>
<span id="L1571" class="ln">  1571&nbsp;&nbsp;</span>func recvmsg(s int, msg *Msghdr, flags int) (n int, err error) {
<span id="L1572" class="ln">  1572&nbsp;&nbsp;</span>	r0, _, e1 := Syscall(SYS_RECVMSG, uintptr(s), uintptr(unsafe.Pointer(msg)), uintptr(flags))
<span id="L1573" class="ln">  1573&nbsp;&nbsp;</span>	n = int(r0)
<span id="L1574" class="ln">  1574&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1575" class="ln">  1575&nbsp;&nbsp;</span>		err = errnoErr(e1)
...
<span id="L1580" class="ln">  1580&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1581" class="ln">  1581&nbsp;&nbsp;</span>
<span id="L1582" class="ln">  1582&nbsp;&nbsp;</span>func sendmsg(s int, msg *Msghdr, flags int) (n int, err error) {
<span id="L1583" class="ln">  1583&nbsp;&nbsp;</span>	r0, _, e1 := Syscall(SYS_SENDMSG, uintptr(s), uintptr(unsafe.Pointer(msg)), uintptr(flags))
<span id="L1584" class="ln">  1584&nbsp;&nbsp;</span>	n = int(r0)
<span id="L1585" class="ln">  1585&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1586" class="ln">  1586&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1587" class="ln">  1587&nbsp;&nbsp;</span>	}
<span id="L1588" class="ln">  1588&nbsp;&nbsp;</span>	return
<span id="L1589" class="ln">  1589&nbsp;&nbsp;</span>}
<span id="L1590" class="ln">  1590&nbsp;&nbsp;</span>
<span id="L1591" class="ln">  1591&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1592" class="ln">  1592&nbsp;&nbsp;</span>
<span id="L1593" class="ln">  1593&nbsp;&nbsp;</span>func mmap(addr uintptr, length uintptr, prot int, flags int, fd int, offset int64) (xaddr uintptr, err error) {
<span id="L1594" class="ln">  1594&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_MMAP, uintptr(addr), uintptr(length), uintptr(prot), uintptr(flags), uintptr(fd), uintptr(offset))
<span id="L1595" class="ln">  1595&nbsp;&nbsp;</span>	xaddr = uintptr(r0)
<span id="L1596" class="ln">  1596&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1597" class="ln">  1597&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1598" class="ln">  1598&nbsp;&nbsp;</span>	}
<span id="L1599" class="ln">  1599&nbsp;&nbsp;</span>	return
<span id="L1600" class="ln">  1600&nbsp;&nbsp;</span>}
<span id="L1601" class="ln">  1601&nbsp;&nbsp;</span>
<span id="L1602" class="ln">  1602&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1603" class="ln">  1603&nbsp;&nbsp;</span>
<span id="L1604" class="ln">  1604&nbsp;&nbsp;</span>func EpollWait(epfd int, events []EpollEvent, msec int) (n int, err error) {
<span id="L1605" class="ln">  1605&nbsp;&nbsp;</span>	var _p0 unsafe.Pointer
<span id="L1606" class="ln">  1606&nbsp;&nbsp;</span>	if len(events) &gt; 0 {
<span id="L1607" class="ln">  1607&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;events[0])
<span id="L1608" class="ln">  1608&nbsp;&nbsp;</span>	} else {
<span id="L1609" class="ln">  1609&nbsp;&nbsp;</span>		_p0 = unsafe.Pointer(&amp;_zero)
<span id="L1610" class="ln">  1610&nbsp;&nbsp;</span>	}
<span id="L1611" class="ln">  1611&nbsp;&nbsp;</span>	r0, _, e1 := Syscall6(SYS_EPOLL_WAIT, uintptr(epfd), uintptr(_p0), uintptr(len(events)), uintptr(msec), 0, 0)
<span id="L1612" class="ln">  1612&nbsp;&nbsp;</span>	n = int(r0)
<span id="L1613" class="ln">  1613&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1614" class="ln">  1614&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1615" class="ln">  1615&nbsp;&nbsp;</span>	}
<span id="L1616" class="ln">  1616&nbsp;&nbsp;</span>	return
<span id="L1617" class="ln">  1617&nbsp;&nbsp;</span>}
<span id="L1618" class="ln">  1618&nbsp;&nbsp;</span>
<span id="L1619" class="ln">  1619&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1620" class="ln">  1620&nbsp;&nbsp;</span>
<span id="L1621" class="ln">  1621&nbsp;&nbsp;</span>func futimesat(dirfd int, path string, times *[2]Timeval) (err error) {
<span id="L1622" class="ln">  1622&nbsp;&nbsp;</span>	var _p0 *byte
<span id="L1623" class="ln">  1623&nbsp;&nbsp;</span>	_p0, err = BytePtrFromString(path)
<span id="L1624" class="ln">  1624&nbsp;&nbsp;</span>	if err != nil {
<span id="L1625" class="ln">  1625&nbsp;&nbsp;</span>		return
<span id="L1626" class="ln">  1626&nbsp;&nbsp;</span>	}
<span id="L1627" class="ln">  1627&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_FUTIMESAT, uintptr(dirfd), uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(times)))
<span id="L1628" class="ln">  1628&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1629" class="ln">  1629&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1630" class="ln">  1630&nbsp;&nbsp;</span>	}
<span id="L1631" class="ln">  1631&nbsp;&nbsp;</span>	return
<span id="L1632" class="ln">  1632&nbsp;&nbsp;</span>}
<span id="L1633" class="ln">  1633&nbsp;&nbsp;</span>
<span id="L1634" class="ln">  1634&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1635" class="ln">  1635&nbsp;&nbsp;</span>
<span id="L1636" class="ln">  1636&nbsp;&nbsp;</span>func Utime(path string, buf *Utimbuf) (err error) {
<span id="L1637" class="ln">  1637&nbsp;&nbsp;</span>	var _p0 *byte
<span id="L1638" class="ln">  1638&nbsp;&nbsp;</span>	_p0, err = BytePtrFromString(path)
<span id="L1639" class="ln">  1639&nbsp;&nbsp;</span>	if err != nil {
<span id="L1640" class="ln">  1640&nbsp;&nbsp;</span>		return
<span id="L1641" class="ln">  1641&nbsp;&nbsp;</span>	}
<span id="L1642" class="ln">  1642&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_UTIME, uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(buf)), 0)
<span id="L1643" class="ln">  1643&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1644" class="ln">  1644&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1645" class="ln">  1645&nbsp;&nbsp;</span>	}
<span id="L1646" class="ln">  1646&nbsp;&nbsp;</span>	return
<span id="L1647" class="ln">  1647&nbsp;&nbsp;</span>}
<span id="L1648" class="ln">  1648&nbsp;&nbsp;</span>
<span id="L1649" class="ln">  1649&nbsp;&nbsp;</span><span class="comment">// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT</span>
<span id="L1650" class="ln">  1650&nbsp;&nbsp;</span>
<span id="L1651" class="ln">  1651&nbsp;&nbsp;</span>func utimes(path string, times *[2]Timeval) (err error) {
<span id="L1652" class="ln">  1652&nbsp;&nbsp;</span>	var _p0 *byte
<span id="L1653" class="ln">  1653&nbsp;&nbsp;</span>	_p0, err = BytePtrFromString(path)
<span id="L1654" class="ln">  1654&nbsp;&nbsp;</span>	if err != nil {
<span id="L1655" class="ln">  1655&nbsp;&nbsp;</span>		return
<span id="L1656" class="ln">  1656&nbsp;&nbsp;</span>	}
<span id="L1657" class="ln">  1657&nbsp;&nbsp;</span>	_, _, e1 := Syscall(SYS_UTIMES, uintptr(unsafe.Pointer(_p0)), uintptr(unsafe.Pointer(times)), 0)
<span id="L1658" class="ln">  1658&nbsp;&nbsp;</span>	if e1 != 0 {
<span id="L1659" class="ln">  1659&nbsp;&nbsp;</span>		err = errnoErr(e1)
<span id="L1660" class="ln">  1660&nbsp;&nbsp;</span>	}
<span id="L1661" class="ln">  1661&nbsp;&nbsp;</span>	return
<span id="L1662" class="ln">  1662&nbsp;&nbsp;</span>}
<span id="L1663" class="ln">  1663&nbsp;&nbsp;</span>
</pre><p><a href="zsyscall_linux_amd64.go?m=text">View as plain text</a></p>
