...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/testing/allocs.go - Go Documentation Server</title>
...
<a href="allocs.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/testing">testing</a>/<span class="text-muted">allocs.go</span>
  </h1>
...
</pre><p><a href="allocs.go?m=text">View as plain text</a></p>
