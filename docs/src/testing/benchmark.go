...
<a href="benchmark.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L353" class="ln">   353&nbsp;&nbsp;</span>type BenchmarkResult struct {
<span id="L354" class="ln">   354&nbsp;&nbsp;</span>	N         int           <span class="comment">// The number of iterations.</span>
<span id="L355" class="ln">   355&nbsp;&nbsp;</span>	T         time.Duration <span class="comment">// The total time taken.</span>
<span id="L356" class="ln">   356&nbsp;&nbsp;</span>	Bytes     int64         <span class="comment">// Bytes processed in one iteration.</span>
<span id="L357" class="ln">   357&nbsp;&nbsp;</span>	MemAllocs uint64        <span class="comment">// The total number of memory allocations.</span>
<span id="L358" class="ln">   358&nbsp;&nbsp;</span>	MemBytes  uint64        <span class="comment">// The total number of bytes allocated.</span>
<span id="L359" class="ln">   359&nbsp;&nbsp;</span>
<span id="L360" class="ln">   360&nbsp;&nbsp;</span>	<span class="comment">// Extra records additional metrics reported by ReportMetric.</span>
