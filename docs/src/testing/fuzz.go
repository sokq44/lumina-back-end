...
<a href="fuzz.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L68" class="ln">    68&nbsp;&nbsp;</span>type F struct {
...
<span id="L73" class="ln">    73&nbsp;&nbsp;</span>	<span class="comment">// inFuzzFn is true when the fuzz function is running. Most F methods cannot</span>
<span id="L74" class="ln">    74&nbsp;&nbsp;</span>	<span class="comment">// be called when inFuzzFn is true.</span>
<span id="L75" class="ln">    75&nbsp;&nbsp;</span>	inFuzzFn bool
<span id="L76" class="ln">    76&nbsp;&nbsp;</span>
<span id="L77" class="ln">    77&nbsp;&nbsp;</span>	<span class="comment">// corpus is a set of seed corpus entries, added with F.Add and loaded</span>
<span id="L78" class="ln">    78&nbsp;&nbsp;</span>	<span class="comment">// from testdata.</span>
