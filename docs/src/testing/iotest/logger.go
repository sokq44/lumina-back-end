...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/testing/iotest/logger.go - Go Documentation Server</title>
...
<a href="logger.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/testing">testing</a>/<a href="http://localhost:8080/src/testing/iotest">iotest</a>/<span class="text-muted">logger.go</span>
  </h1>
...
<span id="L50" class="ln">    50&nbsp;&nbsp;</span><span class="comment">// that it logs (using [log.Printf]) each read to standard error,</span>
<span id="L51" class="ln">    51&nbsp;&nbsp;</span><span class="comment">// printing the prefix and the hexadecimal data read.</span>
...
</pre><p><a href="logger.go?m=text">View as plain text</a></p>
