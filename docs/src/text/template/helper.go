...
<a href="helper.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L117" class="ln">   117&nbsp;&nbsp;</span>func (t *Template) ParseGlob(pattern string) (*Template, error) {
