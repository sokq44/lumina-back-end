...
<a href="zoneinfo.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<span id="L23" class="ln">    23&nbsp;&nbsp;</span>type Location struct {
...
<span id="L28" class="ln">    28&nbsp;&nbsp;</span>	<span class="comment">// The tzdata information can be followed by a string that describes</span>
<span id="L29" class="ln">    29&nbsp;&nbsp;</span>	<span class="comment">// how to handle DST transitions not recorded in zoneTrans.</span>
<span id="L30" class="ln">    30&nbsp;&nbsp;</span>	<span class="comment">// The format is the TZ environment variable without a colon; see</span>
<span id="L31" class="ln">    31&nbsp;&nbsp;</span>	<span class="comment">// https://pubs.opengroup.org/onlinepubs/9699919799/basedefs/V1_chap08.html.</span>
<span id="L32" class="ln">    32&nbsp;&nbsp;</span>	<span class="comment">// Example string, for America/Los_Angeles: PST8PDT,M3.2.0,M11.1.0</span>
<span id="L33" class="ln">    33&nbsp;&nbsp;</span>	extend string
<span id="L34" class="ln">    34&nbsp;&nbsp;</span>
<span id="L35" class="ln">    35&nbsp;&nbsp;</span>	<span class="comment">// Most lookups will be for the current time.</span>
<span id="L36" class="ln">    36&nbsp;&nbsp;</span>	<span class="comment">// To avoid the binary search through tx, keep a</span>
<span id="L37" class="ln">    37&nbsp;&nbsp;</span>	<span class="comment">// static one-element cache that gives the correct</span>
<span id="L38" class="ln">    38&nbsp;&nbsp;</span>	<span class="comment">// zone for the time when the Location was created.</span>
<span id="L39" class="ln">    39&nbsp;&nbsp;</span>	<span class="comment">// if cacheStart &lt;= t &lt; cacheEnd,</span>
<span id="L40" class="ln">    40&nbsp;&nbsp;</span>	<span class="comment">// lookup can return cacheZone.</span>
<span id="L41" class="ln">    41&nbsp;&nbsp;</span>	<span class="comment">// The units for cacheStart and cacheEnd are seconds</span>
<span id="L42" class="ln">    42&nbsp;&nbsp;</span>	<span class="comment">// since January 1, 1970 UTC, to match the argument</span>
<span id="L43" class="ln">    43&nbsp;&nbsp;</span>	<span class="comment">// to lookup.</span>
