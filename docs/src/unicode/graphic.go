...
<meta name="theme-color" content="#375EAB">
  ...
  <title>src/unicode/graphic.go - Go Documentation Server</title>
...
<a href="graphic.go#" id="menu-button"><span id="menu-button-arrow">&#9661;</span></a>
...
<div class="container">
  ...
  <h1>
    Source file
    <a href="http://localhost:8080/src">src</a>/<a href="http://localhost:8080/src/unicode">unicode</a>/<span class="text-muted">graphic.go</span>
  </h1>
...
<span id="L59" class="ln">    59&nbsp;&nbsp;</span>func IsOneOf(ranges []*RangeTable, r rune) bool {
...
<span id="L124" class="ln">   124&nbsp;&nbsp;</span><span class="comment">//	&#39;\t&#39;, &#39;\n&#39;, &#39;\v&#39;, &#39;\f&#39;, &#39;\r&#39;, &#39; &#39;, U+0085 (NEL), U+00A0 (NBSP).</span>
<span id="L125" class="ln">   125&nbsp;&nbsp;</span><span class="comment">//</span>
<span id="L126" class="ln">   126&nbsp;&nbsp;</span><span class="comment">// Other definitions of spacing characters are set by category</span>
<span id="L127" class="ln">   127&nbsp;&nbsp;</span><span class="comment">// Z and property [Pattern_White_Space].</span>
<span id="L128" class="ln">   128&nbsp;&nbsp;</span>func IsSpace(r rune) bool {
<span id="L129" class="ln">   129&nbsp;&nbsp;</span>	<span class="comment">// This property isn&#39;t the same as Z; special-case it.</span>
<span id="L130" class="ln">   130&nbsp;&nbsp;</span>	if uint32(r) &lt;= MaxLatin1 {
<span id="L131" class="ln">   131&nbsp;&nbsp;</span>		switch r {
<span id="L132" class="ln">   132&nbsp;&nbsp;</span>		case &#39;\t&#39;, &#39;\n&#39;, &#39;\v&#39;, &#39;\f&#39;, &#39;\r&#39;, &#39; &#39;, 0x85, 0xA0:
<span id="L133" class="ln">   133&nbsp;&nbsp;</span>			return true
<span id="L134" class="ln">   134&nbsp;&nbsp;</span>		}
<span id="L135" class="ln">   135&nbsp;&nbsp;</span>		return false
<span id="L136" class="ln">   136&nbsp;&nbsp;</span>	}
<span id="L137" class="ln">   137&nbsp;&nbsp;</span>	return isExcludingLatin(White_Space, r)
<span id="L138" class="ln">   138&nbsp;&nbsp;</span>}
<span id="L139" class="ln">   139&nbsp;&nbsp;</span>
<span id="L140" class="ln">   140&nbsp;&nbsp;</span><span class="comment">// IsSymbol reports whether the rune is a symbolic character.</span>
<span id="L141" class="ln">   141&nbsp;&nbsp;</span>func IsSymbol(r rune) bool {
<span id="L142" class="ln">   142&nbsp;&nbsp;</span>	if uint32(r) &lt;= MaxLatin1 {
<span id="L143" class="ln">   143&nbsp;&nbsp;</span>		return properties[uint8(r)]&amp;pS != 0
<span id="L144" class="ln">   144&nbsp;&nbsp;</span>	}
<span id="L145" class="ln">   145&nbsp;&nbsp;</span>	return isExcludingLatin(Symbol, r)
<span id="L146" class="ln">   146&nbsp;&nbsp;</span>}
<span id="L147" class="ln">   147&nbsp;&nbsp;</span>
</pre><p><a href="graphic.go?m=text">View as plain text</a></p>
